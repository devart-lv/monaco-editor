...
(function () {
	...
	(function (AMDLoader) {
		...
		class LoaderEventRecorder {
			constructor(loaderAvailableTimestamp) {
				this._events = [
					new LoaderEvent(1 /* LoaderEventType.LoaderAvailable */, '', loaderAvailableTimestamp)
				];
			}
			record(type, detail) {
				this._events.push(
					new LoaderEvent(type, detail, AMDLoader.Utilities.getHighPerformanceTimestamp())
				);
			}
			getEvents() {
				return this._events;
		...
		class Configuration {
			...
			cloneAndMerge(options) {
				return new Configuration(
					this._env,
					ConfigurationOptionsUtil.mergeConfigurationOptions(options, this.options)
				);
			}
			/**
	...
	(function (AMDLoader) {
		...
		class NodeScriptLoader {
					...
					this._readSourceAndCachedData(
						...
						(err, data, cachedData, hashData) => {
							...
							if (data.charCodeAt(0) === NodeScriptLoader._BOM) {
								scriptSource =
									NodeScriptLoader._PREFIX + data.substring(1) + NodeScriptLoader._SUFFIX;
							} else {
			...
			_getElectronRendererScriptPathOrUri(path) {
				...
				if (driveLetterMatch) {
					// windows
					return `file:///${(driveLetterMatch[1].toUpperCase() + ':' + driveLetterMatch[2]).replace(
						/\\/g,
						'/'
					)}`;
				} else {
			...
			_handleCachedData(script, scriptSource, cachedDataPath, createCachedData, moduleManager) {
				if (script.cachedDataRejected) {
					...
					this._fs.unlink(cachedDataPath, (err) => {
						moduleManager
							.getRecorder()
							.record(62 /* LoaderEventType.CachedDataRejected */, cachedDataPath);
				...
				const createLoop = () => {
					setTimeout(() => {
						...
						this._fs.writeFile(cachedDataPath, Buffer.concat([hashData, cachedData]), (err) => {
							...
							moduleManager
								.getRecorder()
								.record(63 /* LoaderEventType.CachedDataCreated */, cachedDataPath);
							createLoop();
						});
		...
		class ModuleManager {
			...
			defineModule(
				...
				if (this._config.isBuild()) {
					...
					this._buildInfoDependencies[moduleId] = (m.dependencies || []).map((dep) =>
						this._moduleIdProvider.getStrModuleId(dep.id)
					);
				}
			...
			_normalizeDependency(dependency, moduleIdResolver) {
				...
				return new RegularDependency(
					this._moduleIdProvider.getModuleId(moduleIdResolver.resolveModule(dependency))
				);
			}
			...
			_createLoadError(moduleId, _err) {
				...
				let neededBy = (this._inverseDependencies2[moduleId] || []).map((intModuleId) =>
			...
			_loadModule(moduleId) {
				...
				if (
					this._env.isNode &&
					(strModuleId.indexOf('/') === -1 || scopedPackageRegex.test(strModuleId))
				) {
				...
				if (dependencies) {
					for (let i = 0, len = dependencies.length; i < len; i++) {
						...
						if (this._hasDependencyPath(dependency.id, module.id)) {
							...
							console.warn(
								cyclePath.map((id) => this._moduleIdProvider.getStrModuleId(id)).join(' => \n')
							);
							// Break the cycle
							module.unresolvedDependenciesCount--;
							continue;
			...
			_onModuleComplete(module) {
				...
				const inversedependenciesProvider = (moduleId) => {
					return (this._inverseDependencies2[moduleId] || []).map((intModuleId) =>
						this._moduleIdProvider.getStrModuleId(intModuleId)
					);
				};
	...
	define(__m[25 /*vs/nls*/], __M([0 /*require*/, 1 /*exports*/]), function (require, exports) {
		...
		exports.load =
			exports.create =
			exports.setPseudoTranslation =
			exports.getConfiguredDefaultLocale =
			exports.localize =
				void 0;
		let isPseudo =
		...
		function create(key, data) {
			...
			return {
				...
				getConfiguredDefaultLocale:
					(_a = data.getConfiguredDefaultLocale) !== null && _a !== void 0 ? _a : (_) => undefined
			};
		}
		...
		function load(name, req, load, config) {
			...
			if (!name || name.length === 0) {
				return load({
					...
					getConfiguredDefaultLocale: () => {
						var _a;
						return (_a = pluginConfig.availableLanguages) === null || _a === void 0
							? void 0
							: _a['*'];
					}
				});
			...
			if (typeof pluginConfig.loadBundle === 'function') {
				...
				(() =>
					__awaiter(this, void 0, void 0, function* () {
						var _b;
						try {
							const messages = yield getMessagesFromTranslationsService(
							...
							try {
								...
								(_b = pluginConfig.availableLanguages) !== null && _b !== void 0
									? _b
	...
	(function () {
		...
		const trustedTypesPolicy =
			typeof ((_a = self.trustedTypes) === null || _a === void 0 ? void 0 : _a.createPolicy) ===
			'function'
				? (_b = self.trustedTypes) === null || _b === void 0
					? void 0
					: _b.createPolicy('amdLoader', {
		...
		function loadAMDLoader() {
			return new Promise((resolve, reject) => {
				...
				const isCrossOrigin =
					...
					loaderSrc.substring(0, globalThis.origin.length) !== globalThis.origin;
	...
	define(
		__m[26 /*vs/base/common/arrays*/],
		__M([0 /*require*/, 1 /*exports*/]),
		function (require, exports) {
			'use strict';
			Object.defineProperty(exports, '__esModule', { value: true });
			exports.CallbackIterable =
				exports.ArrayQueue =
				exports.findMinBy =
				exports.findLastMaxBy =
				exports.findMaxBy =
				exports.numberComparator =
				exports.compareBy =
				exports.CompareResult =
				exports.splice =
				exports.insertInto =
				exports.mapFind =
				exports.asArray =
				...
				exports.isFalsyOrEmpty =
				exports.coalesceInPlace =
				exports.coalesce =
				exports.groupBy =
				exports.quickSelect =
				exports.findFirstInSorted =
				exports.binarySearch2 =
				exports.binarySearch =
				exports.removeFastWithoutKeepingOrder =
				exports.equals =
				exports.tail2 =
				exports.tail =
					void 0;
			...
			class ArrayQueue {
				...
				takeWhile(predicate) {
					...
					const result =
						startIdx === this.firstIdx ? null : this.items.slice(this.firstIdx, startIdx);
				...
				takeFromEndWhile(predicate) {
					...
					const result =
						endIdx === this.lastIdx ? null : this.items.slice(endIdx + 1, this.lastIdx + 1);
					this.lastIdx = endIdx;
					return result;
				}
				peek() {
				...
				(function (Format) {
					...
					(function (CSS) {
						...
						function formatHexA(color, compact = false) {
							...
							return `#${_toTwoDigitHex(color.rgba.r)}${_toTwoDigitHex(
								color.rgba.g
							)}${_toTwoDigitHex(color.rgba.b)}${_toTwoDigitHex(Math.round(color.rgba.a * 255))}`;
						}
	 ...
	 *--------------------------------------------------------------------------------------------*/
	define(
		__m[29 /*vs/base/common/diff/diffChange*/],
		__M([0 /*require*/, 1 /*exports*/]),
		function (require, exports) {
			'use strict';
			Object.defineProperty(exports, '__esModule', { value: true });
	 ...
	 *--------------------------------------------------------------------------------------------*/
	define(
		__m[4 /*vs/base/common/errors*/],
		__M([0 /*require*/, 1 /*exports*/]),
		function (require, exports) {
			'use strict';
			Object.defineProperty(exports, '__esModule', { value: true });
			exports.BugIndicatingError =
				exports.ErrorNoTelemetry =
				exports.NotSupportedError =
				exports.illegalState =
				exports.illegalArgument =
				exports.canceled =
				exports.CancellationError =
				exports.isCancellationError =
				exports.transformErrorForSerialization =
				exports.onUnexpectedExternalError =
				exports.onUnexpectedError =
	 ...
	 *--------------------------------------------------------------------------------------------*/
	define(
		__m[10 /*vs/base/common/assert*/],
		__M([0 /*require*/, 1 /*exports*/, 4 /*vs/base/common/errors*/]),
	 ...
	 *--------------------------------------------------------------------------------------------*/
	define(
		__m[14 /*vs/base/common/functional*/],
		__M([0 /*require*/, 1 /*exports*/]),
		function (require, exports) {
			'use strict';
			Object.defineProperty(exports, '__esModule', { value: true });
	 ...
	 *--------------------------------------------------------------------------------------------*/
	define(
		__m[15 /*vs/base/common/iterator*/],
		__M([0 /*require*/, 1 /*exports*/]),
		function (require, exports) {
			'use strict';
			Object.defineProperty(exports, '__esModule', { value: true });
	 ...
	 *--------------------------------------------------------------------------------------------*/
	define(
		__m[30 /*vs/base/common/keyCodes*/],
		__M([0 /*require*/, 1 /*exports*/]),
		function (require, exports) {
			'use strict';
			Object.defineProperty(exports, '__esModule', { value: true });
	 ...
	 *--------------------------------------------------------------------------------------------*/
	define(
		__m[11 /*vs/base/common/lifecycle*/],
		__M([
			0 /*require*/, 1 /*exports*/, 14 /*vs/base/common/functional*/, 15 /*vs/base/common/iterator*/
		]),
		function (require, exports, functional_1, iterator_1) {
			'use strict';
			Object.defineProperty(exports, '__esModule', { value: true });
			exports.DisposableMap =
				exports.ImmortalReference =
				exports.SafeDisposable =
				exports.RefCountedDisposable =
				exports.MutableDisposable =
				exports.Disposable =
	 ...
	 *--------------------------------------------------------------------------------------------*/
	define(
		__m[16 /*vs/base/common/linkedList*/],
		__M([0 /*require*/, 1 /*exports*/]),
		function (require, exports) {
			'use strict';
			Object.defineProperty(exports, '__esModule', { value: true });
	 ...
	 *--------------------------------------------------------------------------------------------*/
	define(
		__m[5 /*vs/base/common/strings*/],
		__M([0 /*require*/, 1 /*exports*/, 27 /*vs/base/common/cache*/, 31 /*vs/base/common/lazy*/]),
		function (require, exports, cache_1, lazy_1) {
			'use strict';
			var _a;
			Object.defineProperty(exports, '__esModule', { value: true });
			exports.InvisibleCharacters =
				...
				exports.getLeftDeleteOffset =
				exports.singleLetterHash =
				exports.containsUppercaseCharacter =
				exports.startsWithUTF8BOM =
				exports.UTF8_BOM_CHARACTER =
				exports.isEmojiImprecise =
				exports.isFullWidthCharacter =
				exports.containsUnusualLineTerminators =
				exports.UNUSUAL_LINE_TERMINATORS =
				exports.isBasicASCII =
				exports.containsRTL =
				exports.getCharContainingOffset =
				exports.prevCharLength =
				exports.nextCharLength =
				exports.GraphemeIterator =
				exports.CodePointIterator =
				exports.getNextCodePoint =
				exports.computeCodePoint =
				exports.isLowSurrogate =
				exports.isHighSurrogate =
				exports.commonSuffixLength =
				exports.commonPrefixLength =
				exports.startsWithIgnoreCase =
				exports.equalsIgnoreCase =
				exports.isUpperAsciiLetter =
				exports.isLowerAsciiLetter =
				exports.isAsciiDigit =
				exports.compareSubstringIgnoreCase =
				exports.compareIgnoreCase =
				exports.compareSubstring =
				exports.compare =
				exports.lastNonWhitespaceIndex =
				exports.getLeadingWhitespace =
				exports.firstNonWhitespaceIndex =
				exports.splitLines =
				exports.regExpFlags =
				exports.regExpLeadsToEndlessLoop =
				exports.createRegExp =
				exports.stripWildcards =
				exports.convertSimple2RegExpPattern =
				exports.rtrim =
				exports.ltrim =
				exports.trim =
			...
			class CodePointIterator {
				...
				prevCodePoint() {
					...
					this._offset -=
						codePoint >= 65536 /* Constants.UNICODE_SUPPLEMENTARY_PLANE_BEGIN */ ? 2 : 1;
					return codePoint;
				}
				nextCodePoint() {
			...
			function breakBetweenGraphemeBreakType(breakTypeA, breakTypeB) {
				...
				if (breakTypeA === 0 /* GraphemeBreakType.Other */) {
					...
					return (
						breakTypeB !== 5 /* GraphemeBreakType.Extend */ &&
						breakTypeB !== 7 /* GraphemeBreakType.SpacingMark */
					);
				}
				...
				if (
					breakTypeA === 4 /* GraphemeBreakType.Control */ ||
					breakTypeA === 2 /* GraphemeBreakType.CR */ ||
					breakTypeA === 3 /* GraphemeBreakType.LF */
				) {
					return true; // GB4
				}
				if (
					breakTypeB === 4 /* GraphemeBreakType.Control */ ||
					breakTypeB === 2 /* GraphemeBreakType.CR */ ||
					breakTypeB === 3 /* GraphemeBreakType.LF */
				) {
					return true; // GB5
				}
				...
				if (breakTypeA === 8 /* GraphemeBreakType.L */) {
					if (
						breakTypeB === 8 /* GraphemeBreakType.L */ ||
						breakTypeB === 9 /* GraphemeBreakType.V */ ||
						breakTypeB === 11 /* GraphemeBreakType.LV */ ||
						breakTypeB === 12 /* GraphemeBreakType.LVT */
					) {
						return false; // GB6
					}
				}
				if (
					breakTypeA === 11 /* GraphemeBreakType.LV */ ||
					breakTypeA === 9 /* GraphemeBreakType.V */
				) {
					if (
						breakTypeB === 9 /* GraphemeBreakType.V */ ||
						breakTypeB === 10 /* GraphemeBreakType.T */
					) {
						return false; // GB7
					}
				}
				if (
					breakTypeA === 12 /* GraphemeBreakType.LVT */ ||
					breakTypeA === 10 /* GraphemeBreakType.T */
				) {
				...
				if (
					breakTypeB === 5 /* GraphemeBreakType.Extend */ ||
					breakTypeB === 13 /* GraphemeBreakType.ZWJ */
				) {
					return false; // GB9
				}
				...
				if (
					breakTypeA === 13 /* GraphemeBreakType.ZWJ */ &&
					breakTypeB === 14 /* GraphemeBreakType.Extended_Pictographic */
				) {
				...
				// GB13                        [^RI] (RI RI)* RI × RI
				if (
					breakTypeA === 6 /* GraphemeBreakType.Regional_Indicator */ &&
					breakTypeB === 6 /* GraphemeBreakType.Regional_Indicator */
				) {
					// Note: we are not implementing the rule entirely here to avoid introducing states
			...
			function getOffsetBeforeLastEmojiComponent(initialOffset, str) {
				...
				while (
					...
					codePoint === 65039 /* CodePoint.emojiVariantSelector */ ||
					codePoint === 8419 /* CodePoint.enclosingKeyCap */
				) {
			...
			AmbiguousCharacters._locales = new lazy_1.Lazy(() =>
	 ...
	 *--------------------------------------------------------------------------------------------*/
	define(
		__m[32 /*vs/base/common/hash*/],
		__M([0 /*require*/, 1 /*exports*/, 5 /*vs/base/common/strings*/]),
		function (require, exports, strings) {
			'use strict';
			Object.defineProperty(exports, '__esModule', { value: true });
			exports.StringSHA1 =
				exports.toHexString =
	 ...
	 *--------------------------------------------------------------------------------------------*/
	define(
		__m[17 /*vs/base/common/diff/diff*/],
		__M([
			0 /*require*/, 1 /*exports*/, 29 /*vs/base/common/diff/diffChange*/,
			32 /*vs/base/common/hash*/
		]),
		function (require, exports, diffChange_1, hash_1) {
			...
			class LcsDiff {
				...
				ElementsAreEqual(originalIndex, newIndex) {
					if (
						this._originalElementsOrHash[originalIndex] !== this._modifiedElementsOrHash[newIndex]
					) {
						return false;
					}
				...
				ComputeRecursionPoint(
					...
					for (let numDifferences = 1; numDifferences <= maxDifferences / 2 + 1; numDifferences++) {
						...
						for (
							...
							modifiedIndex =
								originalIndex - (diagonal - diagonalForwardBase) - diagonalForwardOffset;
				...
				PrettifyChanges(changes) {
					...
					if (this._hasStrings) {
						for (let i = 1, len = changes.length; i < len; i++) {
							...
							const matchedLength =
								bChange.originalStart - aChange.originalStart - aChange.originalLength;
				...
				_boundaryScore(originalStart, originalLength, modifiedStart, modifiedLength) {
					const originalScore = this._OriginalRegionIsBoundary(originalStart, originalLength)
						? 1
						: 0;
					const modifiedScore = this._ModifiedRegionIsBoundary(modifiedStart, modifiedLength)
						? 1
						: 0;
	 ...
	 *--------------------------------------------------------------------------------------------*/
	define(
		__m[18 /*vs/base/common/types*/],
		__M([0 /*require*/, 1 /*exports*/]),
		function (require, exports) {
			'use strict';
			Object.defineProperty(exports, '__esModule', { value: true });
			exports.withUndefinedAsNull =
				exports.withNullAsUndefined =
				exports.validateConstraint =
				exports.validateConstraints =
				exports.isFunction =
	...
	define(
		__m[33 /*vs/base/common/codicons*/],
		__M([0 /*require*/, 1 /*exports*/, 18 /*vs/base/common/types*/]),
		function (require, exports, types_1) {
			'use strict';
			Object.defineProperty(exports, '__esModule', { value: true });
	 ...
	 *--------------------------------------------------------------------------------------------*/
	define(
		__m[12 /*vs/base/common/objects*/],
		__M([0 /*require*/, 1 /*exports*/, 18 /*vs/base/common/types*/]),
		function (require, exports, types_1) {
			'use strict';
			Object.defineProperty(exports, '__esModule', { value: true });
			exports.createProxyObject =
				exports.getAllMethodNames =
				exports.getAllPropertyNames =
				exports.equals =
				exports.mixin =
				exports.cloneAndChange =
				exports.deepFreeze =
				exports.deepClone =
					void 0;
	 ...
	 *--------------------------------------------------------------------------------------------*/
	define(
		__m[20 /*vs/editor/common/core/characterClassifier*/],
		__M([0 /*require*/, 1 /*exports*/, 19 /*vs/base/common/uint*/]),
	 ...
	 *--------------------------------------------------------------------------------------------*/
	define(
		__m[21 /*vs/editor/common/core/lineRange*/],
		__M([0 /*require*/, 1 /*exports*/, 4 /*vs/base/common/errors*/]),
		function (require, exports, errors_1) {
			'use strict';
			Object.defineProperty(exports, '__esModule', { value: true });
	 ...
	 *--------------------------------------------------------------------------------------------*/
	define(
		__m[6 /*vs/editor/common/core/offsetRange*/],
		__M([0 /*require*/, 1 /*exports*/, 4 /*vs/base/common/errors*/]),
		function (require, exports, errors_1) {
			'use strict';
			Object.defineProperty(exports, '__esModule', { value: true });
	 ...
	 *--------------------------------------------------------------------------------------------*/
	define(
		__m[3 /*vs/editor/common/core/position*/],
		__M([0 /*require*/, 1 /*exports*/]),
		function (require, exports) {
			'use strict';
			Object.defineProperty(exports, '__esModule', { value: true });
	 ...
	 *--------------------------------------------------------------------------------------------*/
	define(
		__m[2 /*vs/editor/common/core/range*/],
		__M([0 /*require*/, 1 /*exports*/, 3 /*vs/editor/common/core/position*/]),
	 ...
	 *--------------------------------------------------------------------------------------------*/
	define(
		__m[34 /*vs/editor/common/core/selection*/],
		__M([
			0 /*require*/, 1 /*exports*/, 3 /*vs/editor/common/core/position*/,
			2 /*vs/editor/common/core/range*/
		]),
	 ...
	 *--------------------------------------------------------------------------------------------*/
	define(
		__m[35 /*vs/editor/common/core/wordCharacterClassifier*/],
		__M([0 /*require*/, 1 /*exports*/, 20 /*vs/editor/common/core/characterClassifier*/]),
	 ...
	 *--------------------------------------------------------------------------------------------*/
	define(
		__m[22 /*vs/editor/common/core/wordHelper*/],
		__M([
			0 /*require*/, 1 /*exports*/, 15 /*vs/base/common/iterator*/, 16 /*vs/base/common/linkedList*/
		]),
		function (require, exports, iterator_1, linkedList_1) {
			'use strict';
			Object.defineProperty(exports, '__esModule', { value: true });
			exports.getWordAtText =
				exports.ensureValidWordDefinition =
				exports.DEFAULT_WORD_REGEXP =
	 ...
	 *--------------------------------------------------------------------------------------------*/
	define(
		__m[7 /*vs/editor/common/diff/algorithms/diffAlgorithm*/],
		__M([
			0 /*require*/, 1 /*exports*/, 4 /*vs/base/common/errors*/,
			6 /*vs/editor/common/core/offsetRange*/
		]),
		function (require, exports, errors_1, offsetRange_1) {
			'use strict';
			Object.defineProperty(exports, '__esModule', { value: true });
			exports.DateTimeout =
				exports.InfiniteTimeout =
				exports.SequenceDiff =
				exports.DiffAlgorithmResult =
					void 0;
			class DiffAlgorithmResult {
				static trivial(seq1, seq2) {
					return new DiffAlgorithmResult(
						[
							new SequenceDiff(
								new offsetRange_1.OffsetRange(0, seq1.length),
								new offsetRange_1.OffsetRange(0, seq2.length)
							)
						],
						false
					);
	 ...
	 *--------------------------------------------------------------------------------------------*/
	define(
		__m[36 /*vs/editor/common/diff/algorithms/joinSequenceDiffs*/],
		__M([
			0 /*require*/, 1 /*exports*/, 6 /*vs/editor/common/core/offsetRange*/,
			7 /*vs/editor/common/diff/algorithms/diffAlgorithm*/
		]),
		function (require, exports, offsetRange_1, diffAlgorithm_1) {
			'use strict';
			Object.defineProperty(exports, '__esModule', { value: true });
			exports.shiftSequenceDiffs =
				exports.joinSequenceDiffs =
				exports.smoothenSequenceDiffs =
				exports.optimizeSequenceDiffs =
					void 0;
			...
			function smoothenSequenceDiffs(sequence1, sequence2, sequenceDiffs) {
				...
				for (const s of sequenceDiffs) {
					...
					if (
						...
						result[result.length - 1] = new diffAlgorithm_1.SequenceDiff(
				...
				for (let i = 1; i < sequenceDiffs.length; i++) {
					...
					if (cur.seq1Range.isEmpty) {
						...
						for (let i = 1; i <= length; i++) {
							if (
								sequence2.getElement(cur.seq2Range.start - i) !==
								sequence2.getElement(cur.seq2Range.endExclusive - i)
							) {
								all = false;
								break;
							}
						...
						if (all) {
							...
							result[result.length - 1] = new diffAlgorithm_1.SequenceDiff(
								lastResult.seq1Range,
								new offsetRange_1.OffsetRange(
			...
			function shiftSequenceDiffs(sequence1, sequence2, sequenceDiffs) {
				...
				for (let i = 0; i < sequenceDiffs.length; i++) {
					...
					if (diff.seq1Range.isEmpty) {
						...
						const seq2NextStart =
							i + 1 < sequenceDiffs.length
								? sequenceDiffs[i + 1].seq2Range.start
								: sequence2.length;
			...
			function shiftDiffToBetterPosition(
				...
				let deltaBefore = 1;
				while (
					diff.seq2Range.start - deltaBefore > seq2PrevEndExclusive &&
				...
				let deltaAfter = 0;
				while (
					diff.seq2Range.start + deltaAfter < seq2NextStart &&
				...
				if (bestDelta !== 0) {
					return new diffAlgorithm_1.SequenceDiff(
						diff.seq1Range.delta(bestDelta),
						diff.seq2Range.delta(bestDelta)
					);
				}
				return diff;
			}
	 ...
	 *--------------------------------------------------------------------------------------------*/
	define(
		__m[37 /*vs/editor/common/diff/algorithms/myersDiffAlgorithm*/],
		__M([
			0 /*require*/, 1 /*exports*/, 6 /*vs/editor/common/core/offsetRange*/,
			7 /*vs/editor/common/diff/algorithms/diffAlgorithm*/
		]),
				...
				compute(seq1, seq2, timeout = diffAlgorithm_1.InfiniteTimeout.instance) {
					...
					function getXAfterSnake(x, y) {
						while (
							x < seq1.length &&
							y < seq2.length &&
							seq1.getElement(x) === seq2.getElement(y)
						) {
							x++;
							y++;
						}
					...
					while (true) {
						...
						if (endX !== lastAligningPosS1 || endY !== lastAligningPosS2) {
							result.push(
								new diffAlgorithm_1.SequenceDiff(
									new offsetRange_1.OffsetRange(endX, lastAligningPosS1),
									new offsetRange_1.OffsetRange(endY, lastAligningPosS2)
								)
							);
						}
						if (!path) {
	 ...
	 *--------------------------------------------------------------------------------------------*/
	define(
		__m[38 /*vs/editor/common/diff/algorithms/utils*/],
		__M([0 /*require*/, 1 /*exports*/]),
		function (require, exports) {
			'use strict';
			Object.defineProperty(exports, '__esModule', { value: true });
	 ...
	 *--------------------------------------------------------------------------------------------*/
	define(
		__m[39 /*vs/editor/common/diff/algorithms/dynamicProgrammingDiffing*/],
		__M([
			0 /*require*/, 1 /*exports*/, 6 /*vs/editor/common/core/offsetRange*/,
			7 /*vs/editor/common/diff/algorithms/diffAlgorithm*/,
			38 /*vs/editor/common/diff/algorithms/utils*/
		]),
		function (require, exports, offsetRange_1, diffAlgorithm_1, utils_1) {
			'use strict';
			Object.defineProperty(exports, '__esModule', { value: true });
			...
			class DynamicProgrammingDiffing {
				compute(
					sequence1,
					sequence2,
					timeout = diffAlgorithm_1.InfiniteTimeout.instance,
					equalityScore
				) {
					...
					function reportDecreasingAligningPositions(s1, s2) {
						if (s1 + 1 !== lastAligningPosS1 || s2 + 1 !== lastAligningPosS2) {
							result.push(
								new diffAlgorithm_1.SequenceDiff(
									new offsetRange_1.OffsetRange(s1 + 1, lastAligningPosS1),
									new offsetRange_1.OffsetRange(s2 + 1, lastAligningPosS2)
								)
							);
						}
	 ...
	 *--------------------------------------------------------------------------------------------*/
	define(
		__m[23 /*vs/editor/common/diff/linesDiffComputer*/],
		__M([0 /*require*/, 1 /*exports*/]),
		function (require, exports) {
			'use strict';
			Object.defineProperty(exports, '__esModule', { value: true });
	 ...
	 *--------------------------------------------------------------------------------------------*/
	define(
		__m[40 /*vs/editor/common/diff/smartLinesDiffComputer*/],
		__M([
			0 /*require*/, 1 /*exports*/, 17 /*vs/base/common/diff/diff*/,
			23 /*vs/editor/common/diff/linesDiffComputer*/, 5 /*vs/base/common/strings*/,
			2 /*vs/editor/common/core/range*/, 10 /*vs/base/common/assert*/,
			21 /*vs/editor/common/core/lineRange*/
		]),
		function (
			require,
			exports,
				...
				computeDiff(originalLines, modifiedLines, options) {
					...
					for (const c of result.changes) {
						...
						if (c.originalEndLineNumber === 0) {
							// Insertion
							originalRange = new lineRange_1.LineRange(
						...
						if (c.modifiedEndLineNumber === 0) {
							// Deletion
							modifiedRange = new lineRange_1.LineRange(
						...
						let change = new linesDiffComputer_1.LineRangeMapping(
							originalRange,
							modifiedRange,
							(_a = c.charChanges) === null || _a === void 0
								...
								: _a.map(
										(c) =>
											new linesDiffComputer_1.RangeMapping(
												new range_1.Range(
													c.originalStartLineNumber,
						...
						if (lastChange) {
							if (
								lastChange.modifiedRange.endLineNumberExclusive ===
									change.modifiedRange.startLineNumber ||
								lastChange.originalRange.endLineNumberExclusive ===
									change.originalRange.startLineNumber
							) {
								// join touching diffs. Probably moving diffs up/down in the algorithm causes touching diffs.
								change = new linesDiffComputer_1.LineRangeMapping(
					...
					(0, assert_1.assertFn)(() => {
						return (0, assert_1.checkAdjacentItems)(
							changes,
							(m1, m2) =>
								m2.originalRange.startLineNumber - m1.originalRange.endLineNumberExclusive ===
									m2.modifiedRange.startLineNumber - m1.modifiedRange.endLineNumberExclusive &&
			...
			function computeDiff(
				...
				const diffAlgo = new diff_1.LcsDiff(
					originalSequence,
					modifiedSequence,
					continueProcessingPredicate
				);
	 ...
	 *--------------------------------------------------------------------------------------------*/
	define(
		__m[41 /*vs/editor/common/diff/standardLinesDiffComputer*/],
		__M([
			0 /*require*/, 1 /*exports*/, 10 /*vs/base/common/assert*/,
			21 /*vs/editor/common/core/lineRange*/, 6 /*vs/editor/common/core/offsetRange*/,
			3 /*vs/editor/common/core/position*/, 2 /*vs/editor/common/core/range*/,
			7 /*vs/editor/common/diff/algorithms/diffAlgorithm*/,
			39 /*vs/editor/common/diff/algorithms/dynamicProgrammingDiffing*/,
			36 /*vs/editor/common/diff/algorithms/joinSequenceDiffs*/,
			37 /*vs/editor/common/diff/algorithms/myersDiffAlgorithm*/,
			23 /*vs/editor/common/diff/linesDiffComputer*/
		]),
		function (
			require,
			exports,
			...
			joinSequenceDiffs_1,
			myersDiffAlgorithm_1,
			linesDiffComputer_1
		) {
			'use strict';
			Object.defineProperty(exports, '__esModule', { value: true });
			exports.LineSequence =
				exports.getLineRangeMapping =
				exports.lineRangeMappingFromRangeMappings =
				exports.StandardLinesDiffComputer =
					void 0;
			class StandardLinesDiffComputer {
				constructor() {
					this.dynamicProgrammingDiffing =
						new dynamicProgrammingDiffing_1.DynamicProgrammingDiffing();
					this.myersDiffingAlgorithm = new myersDiffAlgorithm_1.MyersDiffAlgorithm();
				}
				computeDiff(originalLines, modifiedLines, options) {
					const timeout =
						options.maxComputationTimeMs === 0
							? diffAlgorithm_1.InfiniteTimeout.instance
							: new diffAlgorithm_1.DateTimeout(options.maxComputationTimeMs);
					...
					lineAlignments = (0, joinSequenceDiffs_1.optimizeSequenceDiffs)(
						sequence1,
						sequence2,
						lineAlignments
					);
						...
						for (let i = 0; i < equalLinesCount; i++) {
							...
							if (originalLines[seq1Offset] !== modifiedLines[seq2Offset]) {
								...
								const characterDiffs = this.refineDiff(
									...
									modifiedLines,
									new diffAlgorithm_1.SequenceDiff(
										new offsetRange_1.OffsetRange(seq1Offset, seq1Offset + 1),
										new offsetRange_1.OffsetRange(seq2Offset, seq2Offset + 1)
									),
									timeout,
				...
				refineDiff(originalLines, modifiedLines, diff, timeout, considerWhitespaceChanges) {
					...
					const diffResult =
						sourceSlice.length + targetSlice.length < 500
			...
			function coverFullWords(sequence1, sequence2, sequenceDiffs) {
				...
				function maybePushWordToAdditional() {
					...
					if (
						Math.max(lastModifiedWord.deleted, lastModifiedWord.added) +
							(lastModifiedWord.count - 1) >
						originalLength1
					) {
						additional.push(
							new diffAlgorithm_1.SequenceDiff(lastModifiedWord.s1Range, lastModifiedWord.s2Range)
						);
					}
				...
				for (const s of sequenceDiffs) {
					function processWord(s1Range, s2Range) {
						...
						if (
							!lastModifiedWord ||
							!lastModifiedWord.s1Range.containsRange(s1Range) ||
							!lastModifiedWord.s2Range.containsRange(s2Range)
						) {
							if (
								lastModifiedWord &&
								!(
									lastModifiedWord.s1Range.endExclusive < s1Range.start &&
									lastModifiedWord.s2Range.endExclusive < s2Range.start
								)
							) {
								const s1Added = offsetRange_1.OffsetRange.tryCreate(
									lastModifiedWord.s1Range.endExclusive,
									s1Range.start
								);
								const s2Added = offsetRange_1.OffsetRange.tryCreate(
									lastModifiedWord.s2Range.endExclusive,
									s2Range.start
								);
								lastModifiedWord.deleted +=
									(_a = s1Added === null || s1Added === void 0 ? void 0 : s1Added.length) !==
										null && _a !== void 0
										? _a
										: 0;
								lastModifiedWord.added +=
									(_b = s2Added === null || s2Added === void 0 ? void 0 : s2Added.length) !==
										null && _b !== void 0
										? _b
										: 0;
						...
						lastModifiedWord.deleted +=
							(_c = changedS1 === null || changedS1 === void 0 ? void 0 : changedS1.length) !==
								null && _c !== void 0
								? _c
								: 0;
						lastModifiedWord.added +=
							(_d = changedS2 === null || changedS2 === void 0 ? void 0 : changedS2.length) !==
								null && _d !== void 0
								? _d
								: 0;
					}
					...
					if (
						...
						w2Before &&
						w2After &&
						w1Before.equals(w1After) &&
						w2Before.equals(w2After)
					) {
			...
			function lineRangeMappingFromRangeMappings(alignments, originalLines, modifiedLines) {
				...
				for (const g of group(
					...
					changes.push(
						new linesDiffComputer_1.LineRangeMapping(
			...
			function getLineRangeMapping(rangeMapping, originalLines, modifiedLines) {
				...
				const originalLineRange = new lineRange_1.LineRange(
					rangeMapping.originalRange.startLineNumber + lineStartDelta,
					rangeMapping.originalRange.endLineNumber + 1 + lineEndDelta
				);
				const modifiedLineRange = new lineRange_1.LineRange(
					rangeMapping.modifiedRange.startLineNumber + lineStartDelta,
					rangeMapping.modifiedRange.endLineNumber + 1 + lineEndDelta
				);
				return new linesDiffComputer_1.LineRangeMapping(originalLineRange, modifiedLineRange, [
					rangeMapping
				]);
			}
			...
			class Slice {
				...
				getBoundaryScore(length) {
					...
					if (
						prevCategory === 6 /* CharBoundaryCategory.LineBreakCR */ &&
						nextCategory === 7 /* CharBoundaryCategory.LineBreakLF */
					) {
				...
				translateOffset(offset) {
					...
					return new position_1.Position(
						...
						offset - offsetOfPrevLineBreak + 1 + this.offsetByLine[i]
					);
				}
				translateRange(range) {
					return range_1.Range.fromPositions(
	 ...
	 *--------------------------------------------------------------------------------------------*/
	define(
		__m[42 /*vs/editor/common/diff/linesDiffComputers*/],
		__M([
			0 /*require*/, 1 /*exports*/, 40 /*vs/editor/common/diff/smartLinesDiffComputer*/,
			41 /*vs/editor/common/diff/standardLinesDiffComputer*/
		]),
		function (require, exports, smartLinesDiffComputer_1, standardLinesDiffComputer_1) {
			'use strict';
			Object.defineProperty(exports, '__esModule', { value: true });
	...
	define(
		__m[43 /*vs/editor/common/languages/defaultDocumentColorsComputer*/],
		__M([0 /*require*/, 1 /*exports*/, 28 /*vs/base/common/color*/]),
		function (require, exports, color_1) {
			'use strict';
			Object.defineProperty(exports, '__esModule', { value: true });
			...
			function _findHSLColorInformation(range, matches, isAlpha) {
				...
				const captureGroups = match.values();
				const parsedRegex = _parseCaptureGroups(captureGroups);
				const colorEquivalent = new color_1.Color(
					new color_1.HSLA(
						parsedRegex[0],
						parsedRegex[1] / 100,
						parsedRegex[2] / 100,
	 ...
	 *--------------------------------------------------------------------------------------------*/
	define(
		__m[44 /*vs/editor/common/languages/linkComputer*/],
		__M([0 /*require*/, 1 /*exports*/, 20 /*vs/editor/common/core/characterClassifier*/]),
		function (require, exports, characterClassifier_1) {
			'use strict';
			Object.defineProperty(exports, '__esModule', { value: true });
	 ...
	 *--------------------------------------------------------------------------------------------*/
	define(
		__m[45 /*vs/editor/common/languages/supports/inplaceReplaceSupport*/],
		__M([0 /*require*/, 1 /*exports*/]),
		function (require, exports) {
			'use strict';
			Object.defineProperty(exports, '__esModule', { value: true });
	 ...
	 *--------------------------------------------------------------------------------------------*/
	define(
		__m[46 /*vs/editor/common/model*/],
		__M([0 /*require*/, 1 /*exports*/, 12 /*vs/base/common/objects*/]),
		function (require, exports, objects_1) {
			'use strict';
			Object.defineProperty(exports, '__esModule', { value: true });
			exports.shouldSynchronizeModel =
				exports.ApplyEditsResult =
				exports.SearchData =
				exports.ValidAnnotatedEditOperation =
				exports.isITextSnapshot =
				exports.FindMatch =
				exports.TextModelResolvedOptions =
				exports.InjectedTextCursorStops =
				exports.MinimapPosition =
				exports.GlyphMarginLane =
	 ...
	 *--------------------------------------------------------------------------------------------*/
	define(
		__m[47 /*vs/editor/common/model/prefixSumComputer*/],
		__M([0 /*require*/, 1 /*exports*/, 26 /*vs/base/common/arrays*/, 19 /*vs/base/common/uint*/]),
		function (require, exports, arrays_1, uint_1) {
			'use strict';
			Object.defineProperty(exports, '__esModule', { value: true });
			exports.PrefixSumIndexOfResult =
				exports.ConstantTimePrefixSumComputer =
				exports.PrefixSumComputer =
					void 0;
	 ...
	 *--------------------------------------------------------------------------------------------*/
	define(
		__m[48 /*vs/editor/common/model/mirrorTextModel*/],
		__M([
			0 /*require*/, 1 /*exports*/, 5 /*vs/base/common/strings*/,
			3 /*vs/editor/common/core/position*/, 47 /*vs/editor/common/model/prefixSumComputer*/
		]),
		function (require, exports, strings_1, position_1, prefixSumComputer_1) {
			'use strict';
			Object.defineProperty(exports, '__esModule', { value: true });
	 ...
	 *--------------------------------------------------------------------------------------------*/
	define(
		__m[49 /*vs/editor/common/model/textModelSearch*/],
		__M([
			0 /*require*/, 1 /*exports*/, 5 /*vs/base/common/strings*/,
			35 /*vs/editor/common/core/wordCharacterClassifier*/, 3 /*vs/editor/common/core/position*/,
			2 /*vs/editor/common/core/range*/, 46 /*vs/editor/common/model*/
		]),
		function (require, exports, strings, wordCharacterClassifier_1, position_1, range_1, model_1) {
			'use strict';
			Object.defineProperty(exports, '__esModule', { value: true });
			exports.Searcher =
				exports.isValidMatch =
				exports.TextModelSearch =
				exports.createFindMatch =
				exports.isMultilineRegexSource =
			...
			class SearchParams {
				...
				parseSearchRequest() {
					...
					return new model_1.SearchData(
						regex,
						this.wordSeparators
							? (0, wordCharacterClassifier_1.getMapForWordSeparators)(this.wordSeparators)
							: null,
			...
			function isMultilineRegexSource(searchString) {
				...
				for (let i = 0, len = searchString.length; i < len; i++) {
					...
					if (chCode === 92 /* CharCode.Backslash */) {
						...
						if (
							nextChCode === 110 /* CharCode.n */ ||
							nextChCode === 114 /* CharCode.r */ ||
							nextChCode === 87 /* CharCode.W */
						) {
							return true;
						}
					}
			...
			class TextModelSearch {
					...
					if (!captureMatches && searchData.simpleSearch) {
						...
						while (
							...
							if (
								...
								result[resultLen++] = new model_1.FindMatch(
									new range_1.Range(
										lineNumber,
				...
				static _findFirstMatchInLine(searcher, text, lineNumber, fromColumn, captureMatches) {
					...
					if (m) {
						return createFindMatch(
							new range_1.Range(lineNumber, m.index + 1, lineNumber, m.index + 1 + m[0].length),
							m,
							captureMatches
						);
					}
				...
				static _doFindPreviousMatchMultiline(model, searchStart, searcher, captureMatches) {
					const matches = this._doFindMatchesMultiline(
						model,
						new range_1.Range(1, 1, searchStart.lineNumber, searchStart.column),
						searcher,
						captureMatches,
						10 * LIMIT_FIND_COUNT
					);
					...
					if (
						...
						return this._doFindPreviousMatchMultiline(
							model,
							new position_1.Position(lineCount, model.getLineMaxColumn(lineCount)),
							searcher,
							captureMatches
						);
					}
					...
					do {
						...
						if (
							...
							if (matchLength === 0) {
								...
								if (
									strings.getNextCodePoint(text, textLength, this._searchRegex.lastIndex) > 0xffff
								) {
	 ...
	 *--------------------------------------------------------------------------------------------*/
	define(
		__m[50 /*vs/editor/common/services/unicodeTextModelHighlighter*/],
		__M([
			0 /*require*/, 1 /*exports*/, 2 /*vs/editor/common/core/range*/,
			49 /*vs/editor/common/model/textModelSearch*/, 5 /*vs/base/common/strings*/,
			10 /*vs/base/common/assert*/, 22 /*vs/editor/common/core/wordHelper*/
		]),
		function (require, exports, range_1, textModelSearch_1, strings, assert_1, wordHelper_1) {
			'use strict';
			Object.defineProperty(exports, '__esModule', { value: true });
					...
					forLoop: for (
						...
						do {
							...
							if (m) {
								...
								let word = (0, wordHelper_1.getWordAtText)(
									startIndex + 1,
									wordHelper_1.DEFAULT_WORD_REGEXP,
									lineContent,
									0
								);
								...
								if (highlightReason !== 0 /* SimpleHighlightReason.None */) {
									...
									ranges.push(
										new range_1.Range(lineNumber, startIndex + 1, lineNumber, endIndex + 1)
									);
								}
							}
						} while (m);
					...
					switch (reason) {
						...
						case 3 /* SimpleHighlightReason.Ambiguous */: {
							...
							const primaryConfusable =
								codePointHighlighter.ambiguousCharacters.getPrimaryConfusable(codePoint);
	 ...
	 *--------------------------------------------------------------------------------------------*/
	define(
		__m[51 /*vs/editor/common/standalone/standaloneEnums*/],
		__M([0 /*require*/, 1 /*exports*/]),
		function (require, exports) {
			'use strict';
			Object.defineProperty(exports, '__esModule', { value: true });
			exports.WrappingIndent =
				exports.TrackedRangeStickiness =
				exports.TextEditorCursorStyle =
				exports.TextEditorCursorBlinkingStyle =
				exports.SymbolTag =
				exports.SymbolKind =
				exports.SignatureHelpTriggerKind =
				exports.SelectionDirection =
				exports.ScrollbarVisibility =
				exports.ScrollType =
				exports.RenderMinimap =
				exports.RenderLineNumbersType =
				exports.PositionAffinity =
				exports.OverviewRulerLane =
				exports.OverlayWidgetPositionPreference =
				exports.MouseTargetType =
				exports.MinimapPosition =
				exports.MarkerTag =
				exports.MarkerSeverity =
				exports.KeyCode =
				exports.InlineCompletionTriggerKind =
				exports.InlayHintKind =
				exports.InjectedTextCursorStops =
				exports.IndentAction =
				exports.GlyphMarginLane =
				exports.EndOfLineSequence =
				exports.EndOfLinePreference =
				exports.EditorOption =
				exports.EditorAutoIndentStrategy =
				exports.DocumentHighlightKind =
				exports.DefaultEndOfLine =
				exports.CursorChangeReason =
				exports.ContentWidgetPositionPreference =
				exports.CompletionTriggerKind =
				exports.CompletionItemTag =
				exports.CompletionItemKind =
				exports.CompletionItemInsertTextRule =
				exports.CodeActionTriggerType =
				exports.AccessibilitySupport =
					void 0;
			...
			(function (EditorOption) {
				...
				EditorOption[(EditorOption['screenReaderAnnounceInlineSuggestion'] = 6)] =
				...
				EditorOption[(EditorOption['copyWithSyntaxHighlighting'] = 23)] =
					'copyWithSyntaxHighlighting';
				EditorOption[(EditorOption['cursorBlinking'] = 24)] = 'cursorBlinking';
				EditorOption[(EditorOption['cursorSmoothCaretAnimation'] = 25)] =
				...
				EditorOption[(EditorOption['cursorSurroundingLinesStyle'] = 28)] =
				...
				EditorOption[(EditorOption['disableMonospaceOptimizations'] = 31)] =
				...
				EditorOption[(EditorOption['experimentalWhitespaceRendering'] = 36)] =
				...
				EditorOption[(EditorOption['unfoldOnClickAfterEndOfLine'] = 46)] =
				...
				EditorOption[(EditorOption['hideCursorInOverviewRuler'] = 57)] =
				...
				EditorOption[(EditorOption['mouseWheelScrollSensitivity'] = 72)] =
					'mouseWheelScrollSensitivity';
				EditorOption[(EditorOption['mouseWheelZoom'] = 73)] = 'mouseWheelZoom';
				EditorOption[(EditorOption['multiCursorMergeOverlapping'] = 74)] =
				...
				EditorOption[(EditorOption['definitionLinkOpensInPeek'] = 84)] =
				...
				EditorOption[(EditorOption['renderLineHighlightOnlyWhenFocus'] = 92)] =
					'renderLineHighlightOnlyWhenFocus';
				EditorOption[(EditorOption['renderValidationDecorations'] = 93)] =
					'renderValidationDecorations';
				EditorOption[(EditorOption['renderWhitespace'] = 94)] = 'renderWhitespace';
				EditorOption[(EditorOption['revealHorizontalRightPadding'] = 95)] =
				...
				EditorOption[(EditorOption['suggestOnTriggerCharacters'] = 116)] =
				...
				EditorOption[(EditorOption['wordWrapBreakAfterCharacters'] = 127)] =
					'wordWrapBreakAfterCharacters';
				EditorOption[(EditorOption['wordWrapBreakBeforeCharacters'] = 128)] =
	...
	define(
		__m[52 /*vs/nls!vs/base/common/platform*/],
		__M([25 /*vs/nls*/, 59 /*vs/nls!vs/base/common/worker/simpleWorker*/]),
		function (nls, data) {
			return nls.create('vs/base/common/platform', data);
		}
	);
	define(
		__m[8 /*vs/base/common/platform*/],
		__M([0 /*require*/, 1 /*exports*/, 52 /*vs/nls!vs/base/common/platform*/]),
		function (require, exports, nls) {
			'use strict';
			var _a;
			Object.defineProperty(exports, '__esModule', { value: true });
			exports.isAndroid =
			...
			if (
				typeof exports.globals.vscode !== 'undefined' &&
				typeof exports.globals.vscode.process !== 'undefined'
			) {
			...
			const isElectronProcess =
				typeof ((_a =
					nodeProcess === null || nodeProcess === void 0 ? void 0 : nodeProcess.versions) ===
					null || _a === void 0
					? void 0
					: _a.electron) === 'string';
			const isElectronRenderer =
				isElectronProcess &&
				(nodeProcess === null || nodeProcess === void 0 ? void 0 : nodeProcess.type) === 'renderer';
			// Web environment
			...
			exports.setTimeout0IsFaster =
				typeof exports.globals.postMessage === 'function' && !exports.globals.importScripts;
			/**
			...
			exports.isSafari = !!(
				!exports.isChrome &&
				exports.userAgent &&
				exports.userAgent.indexOf('Safari') >= 0
			);
	 ...
	 *--------------------------------------------------------------------------------------------*/
	define(
		__m[53 /*vs/base/common/process*/],
		__M([0 /*require*/, 1 /*exports*/, 8 /*vs/base/common/platform*/]),
		function (require, exports, platform_1) {
			...
			if (
				typeof platform_1.globals.vscode !== 'undefined' &&
				typeof platform_1.globals.vscode.process !== 'undefined'
			) {
	 ...
	 *--------------------------------------------------------------------------------------------*/
	define(
		__m[54 /*vs/base/common/path*/],
		__M([0 /*require*/, 1 /*exports*/, 53 /*vs/base/common/process*/]),
	 ...
	 *--------------------------------------------------------------------------------------------*/
	define(
		__m[24 /*vs/base/common/stopwatch*/],
		__M([0 /*require*/, 1 /*exports*/, 8 /*vs/base/common/platform*/]),
		function (require, exports, platform_1) {
			'use strict';
			Object.defineProperty(exports, '__esModule', { value: true });
			...
			const hasPerformanceNow =
				platform_1.globals.performance && typeof platform_1.globals.performance.now === 'function';
			class StopWatch {
	...
	define(
		__m[9 /*vs/base/common/event*/],
		__M([
			0 /*require*/, 1 /*exports*/, 4 /*vs/base/common/errors*/, 14 /*vs/base/common/functional*/,
			11 /*vs/base/common/lifecycle*/, 16 /*vs/base/common/linkedList*/,
			24 /*vs/base/common/stopwatch*/
		]),
		function (require, exports, errors_1, functional_1, lifecycle_1, linkedList_1, stopwatch_1) {
			'use strict';
			Object.defineProperty(exports, '__esModule', { value: true });
			exports.Relay =
				exports.EventBufferer =
				exports.EventMultiplexer =
				exports.MicrotaskEmitter =
				exports.DebounceEmitter =
				exports.PauseableEmitter =
				exports.EventDeliveryQueue =
				exports.Emitter =
				exports.EventProfiling =
				exports.Event =
					void 0;
			// -----------------------------------------------------------------------------------------------------------------------
			...
			(function (Event) {
				...
				function any(...events) {
					return (listener, thisArgs = null, disposables) =>
						(0, lifecycle_1.combinedDisposable)(
			...
			class Emitter {
				constructor(options) {
					...
					this._leakageMon =
						...
						((_a = this._options) === null || _a === void 0 ? void 0 : _a.leakWarningThreshold)
							? new LeakageMonitor(
									(_c =
										(_b = this._options) === null || _b === void 0
											? void 0
											: _b.leakWarningThreshold) !== null && _c !== void 0
										? _c
										: _globalLeakWarningThreshold
							  )
							: undefined;
					this._perfMon = ((_d = this._options) === null || _d === void 0 ? void 0 : _d._profName)
						? new EventProfiling(this._options._profName)
						: undefined;
					this._deliveryQueue =
						(_e = this._options) === null || _e === void 0 ? void 0 : _e.deliveryQueue;
				}
				dispose() {
					var _a, _b, _c, _d;
					if (!this._disposed) {
						...
						(_c =
							(_b = this._options) === null || _b === void 0
								? void 0
								: _b.onDidRemoveLastListener) === null || _c === void 0
							? void 0
							: _c.call(_b);
				...
				get event() {
					if (!this._event) {
						this._event = (callback, thisArgs, disposables) => {
							...
							if (
								firstListener &&
								((_b = this._options) === null || _b === void 0 ? void 0 : _b.onDidAddFirstListener)
							) {
							...
							const result = listener.subscription.set(() => {
								...
								if (!this._disposed) {
									(_b =
										(_a = this._options) === null || _a === void 0
											? void 0
											: _a.onWillRemoveListener) === null || _b === void 0
										? void 0
										: _b.call(_a, this);
									removeListener();
					...
					if (this._listeners) {
						...
						if (!this._deliveryQueue) {
							this._deliveryQueue = new PrivateEventDeliveryQueue(
								(_a = this._options) === null || _a === void 0 ? void 0 : _a.onListenerError
							);
						}
						...
						(_b = this._perfMon) === null || _b === void 0
							? void 0
							: _b.start(this._deliveryQueue.size);
	 ...
	 *--------------------------------------------------------------------------------------------*/
	define(
		__m[55 /*vs/base/common/cancellation*/],
		__M([0 /*require*/, 1 /*exports*/, 9 /*vs/base/common/event*/]),
	 ...
	 *--------------------------------------------------------------------------------------------*/
	define(
		__m[13 /*vs/base/common/uri*/],
		__M([0 /*require*/, 1 /*exports*/, 54 /*vs/base/common/path*/, 8 /*vs/base/common/platform*/]),
		function (require, exports, paths, platform_1) {
			'use strict';
			Object.defineProperty(exports, '__esModule', { value: true });
	 ...
	 *--------------------------------------------------------------------------------------------*/
	define(
		__m[60 /*vs/base/common/worker/simpleWorker*/],
		__M([
			0 /*require*/, 1 /*exports*/, 4 /*vs/base/common/errors*/, 9 /*vs/base/common/event*/,
			11 /*vs/base/common/lifecycle*/, 12 /*vs/base/common/objects*/, 8 /*vs/base/common/platform*/,
			5 /*vs/base/common/strings*/
		]),
		function (require, exports, errors_1, event_1, lifecycle_1, objects_1, platform_1, strings) {
			'use strict';
			Object.defineProperty(exports, '__esModule', { value: true });
			exports.create =
				exports.SimpleWorkerServer =
				exports.SimpleWorkerClient =
				exports.logOnceWebWorkerWarning =
					void 0;
						...
						(e) => {
							...
							this._send(
								new ReplyMessage(
									...
									req,
									undefined,
									(0, errors_1.transformErrorForSerialization)(e)
								)
							);
						}
					);
					...
					this._worker = this._register(
						workerFactory.create(
							...
							(err) => {
								...
								lazyProxyReject === null || lazyProxyReject === void 0
									? void 0
									: lazyProxyReject(err);
							}
						)
	...
	define(
		__m[56 /*vs/editor/common/tokenizationRegistry*/],
		__M([
			0 /*require*/, 1 /*exports*/, 9 /*vs/base/common/event*/, 11 /*vs/base/common/lifecycle*/
		]),
		function (require, exports, event_1, lifecycle_1) {
			'use strict';
			Object.defineProperty(exports, '__esModule', { value: true });
	...
	define(
		__m[57 /*vs/editor/common/languages*/],
		__M([
			0 /*require*/, 1 /*exports*/, 33 /*vs/base/common/codicons*/, 13 /*vs/base/common/uri*/,
			2 /*vs/editor/common/core/range*/, 56 /*vs/editor/common/tokenizationRegistry*/
		]),
		function (require, exports, codicons_1, uri_1, range_1, tokenizationRegistry_1) {
			'use strict';
			Object.defineProperty(exports, '__esModule', { value: true });
			exports.TokenizationRegistry =
				exports.LazyTokenizationSupport =
				exports.InlayHintKind =
				exports.Command =
				exports.FoldingRangeKind =
				exports.SymbolKinds =
				exports.isLocationLink =
				exports.DocumentHighlightKind =
				exports.SignatureHelpTriggerKind =
				exports.SelectedSuggestionInfo =
				exports.InlineCompletionTriggerKind =
				exports.CompletionItemKinds =
				exports.EncodedTokenizationResult =
				exports.TokenizationResult =
				exports.Token =
					void 0;
			class Token {
			...
			(function (CompletionItemKinds) {
				...
				byKind.set(
					...
					codicons_1.Codicon.symbolTypeParameter
				);
			...
			class SelectedSuggestionInfo {
				...
				equals(other) {
					return (
						range_1.Range.lift(this.range).equalsRange(other.range) &&
			...
			function isLocationLink(thing) {
				return (
					...
					(range_1.Range.isIRange(thing.originSelectionRange) ||
						range_1.Range.isIRange(thing.targetSelectionRange))
				);
			}
	 ...
	 *--------------------------------------------------------------------------------------------*/
	define(
		__m[58 /*vs/editor/common/services/editorBaseApi*/],
		__M([
			0 /*require*/, 1 /*exports*/, 55 /*vs/base/common/cancellation*/, 9 /*vs/base/common/event*/,
			30 /*vs/base/common/keyCodes*/, 13 /*vs/base/common/uri*/,
			3 /*vs/editor/common/core/position*/, 2 /*vs/editor/common/core/range*/,
			34 /*vs/editor/common/core/selection*/, 57 /*vs/editor/common/languages*/,
			51 /*vs/editor/common/standalone/standaloneEnums*/
		]),
		function (
			require,
			exports,
	...
	define(
		__m[61 /*vs/editor/common/services/editorSimpleWorker*/],
		__M([
			0 /*require*/, 1 /*exports*/, 17 /*vs/base/common/diff/diff*/, 13 /*vs/base/common/uri*/,
			3 /*vs/editor/common/core/position*/, 2 /*vs/editor/common/core/range*/,
			48 /*vs/editor/common/model/mirrorTextModel*/, 22 /*vs/editor/common/core/wordHelper*/,
			44 /*vs/editor/common/languages/linkComputer*/,
			45 /*vs/editor/common/languages/supports/inplaceReplaceSupport*/,
			58 /*vs/editor/common/services/editorBaseApi*/, 24 /*vs/base/common/stopwatch*/,
			50 /*vs/editor/common/services/unicodeTextModelHighlighter*/,
			42 /*vs/editor/common/diff/linesDiffComputers*/, 12 /*vs/base/common/objects*/,
			43 /*vs/editor/common/languages/defaultDocumentColorsComputer*/
		]),
		function (
			require,
			exports,
			...
			editorBaseApi_1,
			stopwatch_1,
			unicodeTextModelHighlighter_1,
			linesDiffComputers_1,
			objects_1,
			...
			class MirrorModel extends mirrorTextModel_1.MirrorTextModel {
				...
				getWordAtPosition(position, wordDefinition) {
					const wordAtText = (0, wordHelper_1.getWordAtText)(
						position.column,
						(0, wordHelper_1.ensureValidWordDefinition)(wordDefinition),
			...
			class EditorSimpleWorker {
				...
				computeUnicodeHighlights(url, options, range) {
					return __awaiter(this, void 0, void 0, function* () {
						...
						return unicodeTextModelHighlighter_1.UnicodeTextModelHighlighter.computeUnicodeHighlights(
							model,
							options,
							range
						);
				...
				static computeDiff(originalTextModel, modifiedTextModel, options, algorithm) {
					const diffAlgorithm =
						algorithm === 'advanced'
							? linesDiffComputers_1.linesDiffComputers.advanced
							: linesDiffComputers_1.linesDiffComputers.legacy;
				...
				navigateValueSet(modelUrl, range, up, wordDef, wordDefFlags) {
					return __awaiter(this, void 0, void 0, function* () {
						...
						const result = inplaceReplaceSupport_1.BasicInplaceReplace.INSTANCE.navigateValueSet(
							range,
							selectionText,
							wordRange,
							word,
				...
				loadForeignModule(moduleId, createData, foreignHostMethods) {
					...
					const foreignHost = (0, objects_1.createProxyObject)(
						foreignHostMethods,
						proxyMethodRequest
					);
					const ctx = {
