...
define('vs/language/html/htmlWorker', ['require'], (require) => {
	var moduleExports = (() => {
			...
			function is(value) {
				...
				return (
					...
					(Is.undefined(candidate.codeDescription) ||
						Is.string(
							(_a2 = candidate.codeDescription) === null || _a2 === void 0 ? void 0 : _a2.href
						)) &&
				...
				switch (state) {
					...
					case ScannerState.AfterOpeningEndTag:
						...
						if (offset < stream.pos()) {
							return finishToken(
								offset,
								TokenType.Unknown,
								localize2('error.endTagNameExpected', 'End tag name expected.')
							);
						}
						return internalScan();
					case ScannerState.WithinEndTag:
						...
						if (emitPseudoCloseTags && stream.peekChar() === _LAN) {
							...
							return finishToken(
								...
								localize2('error.closingBracketMissing', 'Closing bracket missing.')
							);
						}
					...
					case ScannerState.AfterOpeningStartTag:
						...
						if (offset < stream.pos()) {
							return finishToken(
								offset,
								TokenType.Unknown,
								localize2('error.startTagNameExpected', 'Start tag name expected.')
							);
						}
						return internalScan();
					case ScannerState.WithinTag:
						...
						return finishToken(
							offset,
							TokenType.Unknown,
							localize2('error.unexpectedCharacterInTag', 'Unexpected character in tag.')
						);
		...
		function isVoidElement(e) {
			return (
				!!e &&
				binarySearch(VOID_ELEMENTS, e.toLowerCase(), function (s1, s2) {
		...
		var PathCompletionParticipant = (function () {
			...
			PathCompletionParticipant2.prototype.computeCompletions = function (
				document,
				documentContext
			) {
					...
					return __generator(this, function (_c) {
						switch (_c.label) {
							...
							case 1:
								...
								return [3, 4];
							case 2:
								replaceRange = pathToReplaceRange(
			...
			PathCompletionParticipant2.prototype.providePathSuggestions = function (
				valueBeforeCursor,
				replaceRange,
				document,
				documentContext
				...
				return __awaiter(this, void 0, void 0, function () {
					...
					return __generator(this, function (_b) {
						switch (_b.label) {
							case 0:
								valueBeforeLastSlash = valueBeforeCursor.substring(
									0,
									valueBeforeCursor.lastIndexOf('/') + 1
								);
								parentDir = documentContext.resolveReference(
							...
							case 2:
								...
								for (_i = 0, infos_1 = infos; _i < infos_1.length; _i++) {
									...
									if (name.charCodeAt(0) !== CharCode_dot) {
										result.push(
											createCompletionItem(name, type === FileType.Directory, replaceRange)
										);
									}
								}
								return [2, result];
		...
		var HTMLCompletion = (function () {
			...
			HTMLCompletion2.prototype.setCompletionParticipants = function (
				registeredCompletionParticipants
			) {
				this.completionParticipants = registeredCompletionParticipants || [];
			};
			HTMLCompletion2.prototype.doComplete2 = function (
				document,
				position,
				htmlDocument,
				documentContext,
					...
					return __generator2(this, function (_a2) {
						switch (_a2.label) {
							case 0:
								...
								participant = new PathCompletionParticipant(
									this.lsOptions.fileSystemProvider.readDirectory
								);
			...
			HTMLCompletion2.prototype._doComplete = function (
				document,
				position,
				htmlDocument,
				settings
				...
				var dataProviders = this.dataManager.getDataProviders().filter(function (p) {
					return (
						p.isApplicable(document.languageId) && (!settings || settings[p.getId()] !== false)
					);
				});
						...
						if (tag && (!curr.closed || (curr.endTagStart && curr.endTagStart > offset))) {
							...
							if (startIndent !== null && endIndent !== null && startIndent !== endIndent) {
								...
								item.textEdit = TextEdit.replace(
									getReplaceRange(afterOpenBracket2 - 1 - endIndent.length),
									insertText
								);
						...
						var defaultValue =
							(_a2 =
								settings === null || settings === void 0
									? void 0
									: settings.attributeDefaultValue) !== null && _a2 !== void 0
								? _a2
								: 'doublequotes';
						...
						for (var entity in entities) {
							if (endsWith(entity, ';')) {
								...
								result.items.push({
									...
									documentation: localize3(
										'entity.propose',
										"Character entity representing '".concat(entities[entity], "'")
									),
			...
			HTMLCompletion2.prototype.doQuoteComplete = function (
				document,
				position,
				htmlDocument,
				settings
				...
				var defaultValue =
					(_a2 =
						settings === null || settings === void 0 ? void 0 : settings.attributeDefaultValue) !==
						null && _a2 !== void 0
						? _a2
						: 'doublequotes';
				if (defaultValue === 'empty') {
			...
			HTMLCompletion2.prototype.doesSupportMarkdown = function () {
				...
				if (!isDefined(this.supportsMarkdown)) {
					...
					var documentationFormat =
						(_c =
							(_b =
								(_a2 = this.lsOptions.clientCapabilities.textDocument) === null || _a2 === void 0
									? void 0
									: _a2.completion) === null || _b === void 0
								? void 0
				...
				function getEntityHover(text2, range) {
					...
					for (var entity in entities) {
						...
						if (currEntity === label) {
							...
							hex += code;
							var contentsDoc = localize4(
								'entity.propose',
								"Character entity representing '"
									.concat(entities[entity], "', unicode equivalent '")
									.concat(hex, "'")
							);
							if (contentsDoc) {
								hover = { contents: contentsDoc, range };
			...
			HTMLHover2.prototype.doesSupportMarkdown = function () {
				...
				if (!isDefined(this.supportsMarkdown)) {
					...
					var contentFormat =
						(_c =
							(_b =
								(_a2 = this.lsOptions.clientCapabilities) === null || _a2 === void 0
									? void 0
									: _a2.textDocument) === null || _b === void 0
								? void 0
								: _b.hover) === null || _c === void 0
							? void 0
							: _c.contentFormat;
					this.supportsMarkdown =
						Array.isArray(contentFormat) && contentFormat.indexOf(MarkupKind.Markdown) !== -1;
				}
				return this.supportsMarkdown;
			};
			return HTMLHover2;
		...
		(function () {
			...
			var __webpack_modules__ = [
				...
				function (module, __unused_webpack_exports, __webpack_require__2) {
					var Beautifier = __webpack_require__2(16).Beautifier,
						Options = __webpack_require__2(17).Options;
		...
		(function () {
			...
			var __webpack_modules__ = [
				...
				,
				function (module, __unused_webpack_exports, __webpack_require__2) {
					var Beautifier = __webpack_require__2(19).Beautifier,
						Options = __webpack_require__2(20).Options;
				...
				function (module, __unused_webpack_exports, __webpack_require__2) {
					...
					var TagOpenParserToken = function (parent, raw_token) {
						...
						if (!raw_token) {
							...
							this.is_end_tag =
								!this.is_start_tag || (raw_token.closed && raw_token.closed.text === '/>');
							this.is_end_tag =
								this.is_end_tag ||
								(this.tag_start_char === '{' &&
					...
					Beautifier.prototype._do_optional_end_element = function (parser_token) {
						...
						if (parser_token.tag_name === 'body') {
							...
							result =
								result || this._tag_stack.try_pop('option', ['select', 'datalist', 'optgroup']);
							...
							result = result || this._tag_stack.try_pop('colgroup', ['table']);
							result =
								result || this._tag_stack.try_pop('tr', ['table', 'thead', 'tbody', 'tfoot']);
						} else if (parser_token.tag_name === 'th' || parser_token.tag_name === 'td') {
							result =
								result || this._tag_stack.try_pop('td', ['table', 'thead', 'tbody', 'tfoot', 'tr']);
							result =
								result || this._tag_stack.try_pop('th', ['table', 'thead', 'tbody', 'tfoot', 'tr']);
						}
						...
						var n = {
							resolve: function () {
								for (var t3, n2 = '', o = false, i = arguments.length - 1; i >= -1 && !o; i--) {
									var a;
									i >= 0 ? (a = arguments[i]) : (void 0 === t3 && (t3 = process.cwd()), (a = t3)),
										e2(a),
										0 !== a.length && ((n2 = a + '/' + n2), (o = 47 === a.charCodeAt(0)));
								}
								return (
							...
							relative: function (t3, r3) {
								...
								for (var s = r3.length - h, c = a < s ? a : s, f = -1, u = 0; u <= c; ++u) {
									if (u === c) {
										...
										} else a > c && (47 === t3.charCodeAt(o + u) ? (f = u) : 0 === u && (f = 0));
										break;
									}
								...
								return p.length > 0
									? p + r3.slice(h + f)
									: ((h += f), 47 === r3.charCodeAt(h) && ++h, r3.slice(h));
							},
							...
							dirname: function (t3) {
								if ((e2(t3), 0 === t3.length)) return '.';
								for (
									var r3 = t3.charCodeAt(0), n2 = 47 === r3, o = -1, i = true, a = t3.length - 1;
									a >= 1;
									--a
								)
							...
							parse: function (t3) {
								...
								for (var a = -1, h = 0, s = -1, c = true, f = t3.length - 1, u = 0; f >= n2; --f)
									if (47 !== (o = t3.charCodeAt(f)))
										-1 === s && ((c = false), (s = f + 1)),
											46 === o ? (-1 === a ? (a = f) : 1 !== u && (u = 1)) : -1 !== a && (u = -1);
									else if (!c) {
										h = f + 1;
										break;
									}
								return (
									-1 === a || -1 === s || 0 === u || (1 === u && a === s - 1 && a === h + 1)
										? -1 !== s &&
										  (r3.base = r3.name = 0 === h && i ? t3.slice(1, s) : t3.slice(h, s))
										: (0 === h && i
												? ((r3.name = t3.slice(1, a)), (r3.base = t3.slice(1, s)))
												: ((r3.name = t3.slice(h, a)), (r3.base = t3.slice(h, s))),
										  (r3.ext = t3.slice(a, s))),
						...
						function w(t3, e3) {
							...
							if (
								...
								if (-1 !== c2) {
									...
									(i2 = i2.substr(c2 + 1)),
										-1 === (c2 = f2.indexOf(':'))
											? (n2 += r3(f2, false))
											: ((n2 += r3(f2.substr(0, c2), false)),
											  (n2 += ':'),
											  (n2 += r3(f2.substr(c2 + 1), false))),
										(n2 += '@');
								}
							...
							if (a2) {
								if (a2.length >= 3 && 47 === a2.charCodeAt(0) && 58 === a2.charCodeAt(2))
									(u2 = a2.charCodeAt(1)) >= 65 &&
										u2 <= 90 &&
										(a2 = '/'.concat(String.fromCharCode(u2 + 32), ':').concat(a2.substr(3)));
								else if (a2.length >= 2 && 58 === a2.charCodeAt(1)) {
									var u2;
									(u2 = a2.charCodeAt(0)) >= 65 &&
										u2 <= 90 &&
										(a2 = ''.concat(String.fromCharCode(u2 + 32), ':').concat(a2.substr(2)));
								}
								n2 += r3(a2, true);
							}
							return (
			...
			for (var _i = 0, newLinks_1 = newLinks; _i < newLinks_1.length; _i++) {
				...
				if (link.target && startsWith(link.target, localWithHash)) {
					...
					if (offset !== void 0) {
						...
						link.target = ''
							.concat(localWithHash)
							.concat(pos.line + 1, ',')
							.concat(pos.character + 1);
					}
				}
			}
			return newLinks;
		...
		function isWithinTagRange(node, offset, nodeTag) {
			...
			return (
				node.start + '<'.length <= offset && offset <= node.start + '<'.length + nodeTag.length
			);
		}
		...
		function findLinkedEditingRanges(document, position, htmlDocument) {
			...
			if (
				...
				(node.endTagStart + '</'.length <= offset &&
					offset <= node.endTagStart + '</'.length + tagLength)
			) {
				return [
					Range.create(
		...
		function getAttributeLevelRanges(document, currNode, currOffset) {
			var currNodeRange = Range.create(
