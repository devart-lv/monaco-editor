...
define('vs/editor/editor.main.nls.zh-tw', {
	...
	'vs/editor/contrib/codeAction/browser/codeAction': ['套用程式碼動作時發生未知的錯誤'],
	...
	'vs/editor/contrib/codeAction/browser/codeActionUi': ['隱藏已停用項目', '顯示已停用項目'],
	...
	'vs/editor/contrib/copyPaste/browser/copyPasteController': ['正在執行貼上處理常式。按一下以取消'],
	...
	'vs/editor/contrib/message/browser/messageController': ['編輯器目前是否正在顯示內嵌訊息'],
	...
	'vs/platform/quickinput/browser/quickInputUtils': ['按一下以執行命令 ‘{0}’'],
