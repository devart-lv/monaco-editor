...
define('vs/editor/editor.main.nls.zh-cn', {
	...
	'vs/base/browser/ui/findinput/findInputToggles': ['区分大小写', '全字匹配', '使用正则表达式'],
	...
	'vs/editor/contrib/codeAction/browser/codeAction': ['应用代码操作时发生未知错误'],
	...
	'vs/editor/contrib/codeAction/browser/codeActionUi': ['隐藏已禁用项', '显示已禁用项'],
	...
	'vs/editor/contrib/copyPaste/browser/copyPasteContribution': ['启用/禁用粘贴时从扩展运行编辑。'],
	'vs/editor/contrib/copyPaste/browser/copyPasteController': ['正在运行粘贴处理程序。单击以取消'],
	...
	'vs/editor/contrib/message/browser/messageController': ['编辑器当前是否正在显示内联消息'],
