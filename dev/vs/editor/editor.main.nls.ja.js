...
define('vs/editor/editor.main.nls.ja', {
	...
	'vs/base/browser/ui/selectBox/selectBoxCustom': ['ボックスを選択'],
	'vs/base/browser/ui/toolbar/toolbar': ['その他の操作...'],
	...
	'vs/editor/common/viewLayout/viewLineRenderer': ['表示数を増やす ({0})', '{0} 文字'],
	...
	'vs/editor/contrib/codeAction/browser/codeActionUi': ['無効なものを非表示', '無効を表示'],
	...
	'vs/editor/contrib/inlineCompletions/browser/hoverParticipant': ['おすすめ:'],
	...
	'vs/editor/contrib/lineSelection/browser/lineSelection': ['行全体を選択する'],
	...
	'vs/platform/actions/browser/toolbar': ['非表示', 'メニューのリセット'],
	'vs/platform/actions/common/menuService': ["'{0}' の非表示"],
	...
	'vs/platform/history/browser/contextScopedHistoryWidget': ['候補を表示するかどうか'],
	...
	'vs/platform/quickinput/browser/quickInputList': ['クイック入力'],
	'vs/platform/quickinput/browser/quickInputUtils': ["クリックして '{0}' コマンドを実行"],
	...
	'vs/platform/workspace/common/workspace': ['コード ワークスペース']
});
