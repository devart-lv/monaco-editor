...
define('vs/editor/editor.main.nls.ru', {
	...
	'vs/base/browser/ui/iconLabel/iconLabelHover': ['Загрузка…'],
	...
	'vs/base/browser/ui/selectBox/selectBoxCustom': ['Поле выбора'],
	'vs/base/browser/ui/toolbar/toolbar': ['Дополнительные действия...'],
	...
	'vs/editor/common/languages/modesRegistry': ['Простой текст'],
	...
	'vs/editor/common/viewLayout/viewLineRenderer': ['Показать больше ({0})', 'Символы: {0}'],
	...
	'vs/editor/contrib/caretOperations/browser/transpose': ['Транспортировать буквы'],
	...
	'vs/editor/contrib/inlineCompletions/browser/hoverParticipant': ['Предложение:'],
	...
	'vs/editor/contrib/lineSelection/browser/lineSelection': ['Развернуть выделение строки'],
	...
	'vs/editor/contrib/suggest/browser/suggestWidgetDetails': ['Закрыть', 'Загрузка...'],
	...
	'vs/editor/contrib/wordOperations/browser/wordOperations': ['Удалить слово'],
	...
	'vs/platform/actions/browser/toolbar': ['Скрыть', 'Сбросить меню'],
	'vs/platform/actions/common/menuService': ['Скрыть "{0}"'],
	...
	'vs/platform/history/browser/contextScopedHistoryWidget': ['Отображаются ли предложения'],
	...
	'vs/platform/quickinput/browser/quickInputList': ['Быстрый ввод'],
	'vs/platform/quickinput/browser/quickInputUtils': ['Щелкните, чтобы выполнить команду "{0}"'],
	...
	'vs/platform/workspace/common/workspace': ['Рабочая область кода']
});
