...
export class CursorConfiguration {
	static shouldRecreate(e) {
		return (
			e.hasChanged(139 /* EditorOption.layoutInfo */) ||
	...
	get electricChars() {
		...
		if (!this._electricChars) {
			this._electricChars = {};
			const electricChars =
				(_a = this.languageConfigurationService.getLanguageConfiguration(
					this._languageId
				).electricCharacter) === null || _a === void 0
					? void 0
					: _a.getElectricCharacters();
			if (electricChars) {
