...
function applyUpdate(value, update) {
	...
	if (Array.isArray(value) || Array.isArray(update)) {
		const arrayEquals =
			Array.isArray(value) && Array.isArray(update) && arrays.equals(value, update);
...
class EditorAccessibilitySupport extends BaseEditorOption {
	constructor() {
		super(
			2 /* EditorOption.accessibilitySupport */,
			'accessibilitySupport',
			0 /* AccessibilitySupport.Unknown */,
			{
				type: 'string',
				enum: ['auto', 'on', 'off'],
				enumDescriptions: [
...
class EditorEmptySelectionClipboard extends EditorBooleanOption {
	constructor() {
		super(35 /* EditorOption.emptySelectionClipboard */, 'emptySelectionClipboard', true, {
			description: nls.localize(
			...
			autoFindInSelection:
				typeof _input.autoFindInSelection === 'boolean'
					? _input.autoFindInSelection
						? 'always'
						: 'never'
					: stringSet(input.autoFindInSelection, this.defaultValue.autoFindInSelection, [
							'never',
							'always',
							'multiline'
					  ]),
...
EditorFontWeight.SUGGESTION_VALUES = [
	'normal',
	'bold',
	'100',
	'200',
		...
		return {
			...
			multipleDefinitions:
				(_a = input.multipleDefinitions) !== null && _a !== void 0
					? _a
					: stringSet(input.multipleDefinitions, 'peek', ['peek', 'gotoAndPeek', 'goto']),
			multipleTypeDefinitions:
				(_b = input.multipleTypeDefinitions) !== null && _b !== void 0
					? _b
					: stringSet(input.multipleTypeDefinitions, 'peek', ['peek', 'gotoAndPeek', 'goto']),
			multipleDeclarations:
				(_c = input.multipleDeclarations) !== null && _c !== void 0
					? _c
					: stringSet(input.multipleDeclarations, 'peek', ['peek', 'gotoAndPeek', 'goto']),
			multipleImplementations:
				(_d = input.multipleImplementations) !== null && _d !== void 0
					? _d
					: stringSet(input.multipleImplementations, 'peek', ['peek', 'gotoAndPeek', 'goto']),
			multipleReferences:
				(_e = input.multipleReferences) !== null && _e !== void 0
					? _e
					: stringSet(input.multipleReferences, 'peek', ['peek', 'gotoAndPeek', 'goto']),
...
export class EditorLayoutInfoComputer extends ComputedEditorOption {
	...
	static computeContainedMinimapLineCount(input) {
		...
		const desiredRatio =
			(extraLinesBeforeFirstLine + input.viewLineCount + extraLinesBeyondLastLine) /
	...
	static _computeMinimapLayout(input, memory) {
		...
		const renderMinimap = minimapRenderCharacters
			? 1 /* RenderMinimap.Text */
			: 2 /* RenderMinimap.Blocks */;
		const minimapLeft =
			minimapSide === 'left' ? 0 : outerWidth - minimapWidth - verticalScrollbarWidth;
		return {
			renderMinimap,
			minimapLeft,
			minimapWidth,
	...
	static computeLayout(options, env) {
		...
		const wordWrapOverride1 =
			wordWrapOverride2 === 'inherit'
				? options.get(130 /* EditorOption.wordWrapOverride1 */)
				: wordWrapOverride2;
		const wordWrap =
			wordWrapOverride1 === 'inherit'
				? options.get(126 /* EditorOption.wordWrap */)
				: wordWrapOverride1;
		...
		const showLineNumbers =
			options.get(65 /* EditorOption.lineNumbers */).renderType !==
			0 /* RenderLineNumbersType.Off */;
		...
		const showFoldingDecoration =
			options.get(105 /* EditorOption.showFoldingControls */) !== 'never';
		...
		if (
			minimapLayout.renderMinimap !== 0 /* RenderMinimap.None */ &&
...
class EditorRenderLineNumbersOption extends BaseEditorOption {
	constructor() {
		super(
			65 /* EditorOption.lineNumbers */,
			'lineNumbers',
			{ renderType: 1 /* RenderLineNumbersType.On */, renderFn: null },
			{
				type: 'string',
...
export function filterValidationDecorations(options) {
	const renderValidationDecorations = options.get(
		93 /* EditorOption.renderValidationDecorations */
	);
...
export const EditorOptions = {
	acceptSuggestionOnCommitCharacter: register(
		new EditorBooleanOption(
			0 /* EditorOption.acceptSuggestionOnCommitCharacter */,
	...
	acceptSuggestionOnEnter: register(
		new EditorStringEnumOption(
			1 /* EditorOption.acceptSuggestionOnEnter */,
	...
	accessibilityPageSize: register(
		new EditorIntOption(
			3 /* EditorOption.accessibilityPageSize */,
	...
	screenReaderAnnounceInlineSuggestion: register(
		new EditorBooleanOption(
			6 /* EditorOption.screenReaderAnnounceInlineSuggestion */,
	...
	autoClosingBrackets: register(
		new EditorStringEnumOption(
			5 /* EditorOption.autoClosingBrackets */,
			'autoClosingBrackets',
			'languageDefined',
	...
	autoClosingDelete: register(
		new EditorStringEnumOption(
			7 /* EditorOption.autoClosingDelete */,
			'autoClosingDelete',
			'auto',
			['always', 'auto', 'never'],
			{
	...
	autoClosingOvertype: register(
		new EditorStringEnumOption(
			8 /* EditorOption.autoClosingOvertype */,
			'autoClosingOvertype',
			'auto',
			['always', 'auto', 'never'],
			{
	...
	autoClosingQuotes: register(
		new EditorStringEnumOption(
			9 /* EditorOption.autoClosingQuotes */,
			'autoClosingQuotes',
			'languageDefined',
			['always', 'languageDefined', 'beforeWhitespace', 'never'],
			{
	...
	autoIndent: register(
		new EditorEnumOption(
			10 /* EditorOption.autoIndent */,
			'autoIndent',
			4 /* EditorAutoIndentStrategy.Full */,
			'full',
	...
	automaticLayout: register(
		new EditorBooleanOption(11 /* EditorOption.automaticLayout */, 'automaticLayout', false)
	),
	autoSurround: register(
		new EditorStringEnumOption(
			12 /* EditorOption.autoSurround */,
			'autoSurround',
			'languageDefined',
	...
	stickyTabStops: register(
		new EditorBooleanOption(111 /* EditorOption.stickyTabStops */, 'stickyTabStops', false, {
			description: nls.localize(
				'stickyTabStops',
	...
	codeLens: register(
		new EditorBooleanOption(15 /* EditorOption.codeLens */, 'codeLens', true, {
			description: nls.localize('codeLens', 'Controls whether the editor shows CodeLens.')
		})
	),
	codeLensFontFamily: register(
		new EditorStringOption(16 /* EditorOption.codeLensFontFamily */, 'codeLensFontFamily', '', {
			description: nls.localize('codeLensFontFamily', 'Controls the font family for CodeLens.')
		})
	),
	codeLensFontSize: register(
		new EditorIntOption(17 /* EditorOption.codeLensFontSize */, 'codeLensFontSize', 0, 0, 100, {
			type: 'number',
			default: 0,
			minimum: 0,
			maximum: 100,
	...
	colorDecorators: register(
		new EditorBooleanOption(18 /* EditorOption.colorDecorators */, 'colorDecorators', true, {
			description: nls.localize(
				'colorDecorators',
	...
	colorDecoratorsLimit: register(
		new EditorIntOption(
			19 /* EditorOption.colorDecoratorsLimit */,
	...
	columnSelection: register(
		new EditorBooleanOption(20 /* EditorOption.columnSelection */, 'columnSelection', false, {
			description: nls.localize(
				'columnSelection',
	...
	contextmenu: register(
		new EditorBooleanOption(22 /* EditorOption.contextmenu */, 'contextmenu', true)
	),
	copyWithSyntaxHighlighting: register(
		new EditorBooleanOption(
			23 /* EditorOption.copyWithSyntaxHighlighting */,
	...
	cursorBlinking: register(
		new EditorEnumOption(
			24 /* EditorOption.cursorBlinking */,
			'cursorBlinking',
			1 /* TextEditorCursorBlinkingStyle.Blink */,
			'blink',
	...
	cursorSmoothCaretAnimation: register(
		new EditorStringEnumOption(
			25 /* EditorOption.cursorSmoothCaretAnimation */,
	...
	cursorSurroundingLines: register(
		new EditorIntOption(
			27 /* EditorOption.cursorSurroundingLines */,
	...
	cursorSurroundingLinesStyle: register(
		new EditorStringEnumOption(
			28 /* EditorOption.cursorSurroundingLinesStyle */,
	...
	disableLayerHinting: register(
		new EditorBooleanOption(30 /* EditorOption.disableLayerHinting */, 'disableLayerHinting', false)
	),
	disableMonospaceOptimizations: register(
		new EditorBooleanOption(
			31 /* EditorOption.disableMonospaceOptimizations */,
			'disableMonospaceOptimizations',
			false
		)
	),
	domReadOnly: register(
		new EditorBooleanOption(32 /* EditorOption.domReadOnly */, 'domReadOnly', false)
	),
	dragAndDrop: register(
		new EditorBooleanOption(33 /* EditorOption.dragAndDrop */, 'dragAndDrop', true, {
			description: nls.localize(
				'dragAndDrop',
	...
	experimentalWhitespaceRendering: register(
		new EditorStringEnumOption(
			36 /* EditorOption.experimentalWhitespaceRendering */,
	...
	extraEditorClassName: register(
		new EditorStringOption(37 /* EditorOption.extraEditorClassName */, 'extraEditorClassName', '')
	),
	fastScrollSensitivity: register(
		new EditorFloatOption(
			38 /* EditorOption.fastScrollSensitivity */,
	...
	fixedOverflowWidgets: register(
		new EditorBooleanOption(
			40 /* EditorOption.fixedOverflowWidgets */,
			'fixedOverflowWidgets',
			false
		)
	),
	folding: register(
		new EditorBooleanOption(41 /* EditorOption.folding */, 'folding', true, {
			description: nls.localize('folding', 'Controls whether the editor has code folding enabled.')
		})
	),
	foldingStrategy: register(
		new EditorStringEnumOption(
			42 /* EditorOption.foldingStrategy */,
			'foldingStrategy',
			'auto',
			['auto', 'indentation'],
			{
	...
	foldingHighlight: register(
		new EditorBooleanOption(43 /* EditorOption.foldingHighlight */, 'foldingHighlight', true, {
			description: nls.localize(
				'foldingHighlight',
	...
	foldingImportsByDefault: register(
		new EditorBooleanOption(
			44 /* EditorOption.foldingImportsByDefault */,
	...
	foldingMaximumRegions: register(
		new EditorIntOption(
			45 /* EditorOption.foldingMaximumRegions */,
	...
	unfoldOnClickAfterEndOfLine: register(
		new EditorBooleanOption(
			46 /* EditorOption.unfoldOnClickAfterEndOfLine */,
	...
	formatOnPaste: register(
		new EditorBooleanOption(53 /* EditorOption.formatOnPaste */, 'formatOnPaste', false, {
			description: nls.localize(
				'formatOnPaste',
	...
	formatOnType: register(
		new EditorBooleanOption(54 /* EditorOption.formatOnType */, 'formatOnType', false, {
			description: nls.localize(
				'formatOnType',
	...
	glyphMargin: register(
		new EditorBooleanOption(55 /* EditorOption.glyphMargin */, 'glyphMargin', true, {
			description: nls.localize(
				'glyphMargin',
	...
	hideCursorInOverviewRuler: register(
		new EditorBooleanOption(
			57 /* EditorOption.hideCursorInOverviewRuler */,
	...
	inDiffEditor: register(
		new EditorBooleanOption(59 /* EditorOption.inDiffEditor */, 'inDiffEditor', false)
	),
	letterSpacing: register(
		new EditorFloatOption(
			61 /* EditorOption.letterSpacing */,
			'letterSpacing',
	...
	lineNumbersMinChars: register(
		new EditorIntOption(66 /* EditorOption.lineNumbersMinChars */, 'lineNumbersMinChars', 5, 1, 300)
	),
	linkedEditing: register(
		new EditorBooleanOption(67 /* EditorOption.linkedEditing */, 'linkedEditing', false, {
			description: nls.localize(
				'linkedEditing',
	...
	links: register(
		new EditorBooleanOption(68 /* EditorOption.links */, 'links', true, {
			description: nls.localize(
				'links',
	...
	mouseStyle: register(
		new EditorStringEnumOption(71 /* EditorOption.mouseStyle */, 'mouseStyle', 'text', [
			'text',
			'default',
			'copy'
		])
	...
	mouseWheelScrollSensitivity: register(
		new EditorFloatOption(
			72 /* EditorOption.mouseWheelScrollSensitivity */,
	...
	mouseWheelZoom: register(
		new EditorBooleanOption(73 /* EditorOption.mouseWheelZoom */, 'mouseWheelZoom', false, {
			markdownDescription: nls.localize(
				'mouseWheelZoom',
	...
	multiCursorMergeOverlapping: register(
		new EditorBooleanOption(
			74 /* EditorOption.multiCursorMergeOverlapping */,
	...
	multiCursorModifier: register(
		new EditorEnumOption(
			75 /* EditorOption.multiCursorModifier */,
			'multiCursorModifier',
			'altKey',
			'alt',
			['ctrlCmd', 'alt'],
	...
	multiCursorPaste: register(
		new EditorStringEnumOption(
			76 /* EditorOption.multiCursorPaste */,
			'multiCursorPaste',
			'spread',
			['spread', 'full'],
			{
	...
	multiCursorLimit: register(
		new EditorIntOption(
			77 /* EditorOption.multiCursorLimit */,
			'multiCursorLimit',
			10000,
			1,
			100000,
	...
	occurrencesHighlight: register(
		new EditorBooleanOption(
			78 /* EditorOption.occurrencesHighlight */,
	...
	overviewRulerBorder: register(
		new EditorBooleanOption(
			79 /* EditorOption.overviewRulerBorder */,
			'overviewRulerBorder',
			true,
			{
				description: nls.localize(
	...
	overviewRulerLanes: register(
		new EditorIntOption(80 /* EditorOption.overviewRulerLanes */, 'overviewRulerLanes', 3, 0, 3)
	),
	padding: register(new EditorPadding()),
	parameterHints: register(new EditorParameterHints()),
	peekWidgetDefaultFocus: register(
		new EditorStringEnumOption(
			83 /* EditorOption.peekWidgetDefaultFocus */,
	...
	definitionLinkOpensInPeek: register(
		new EditorBooleanOption(
			84 /* EditorOption.definitionLinkOpensInPeek */,
	...
	quickSuggestionsDelay: register(
		new EditorIntOption(
			86 /* EditorOption.quickSuggestionsDelay */,
	...
	renameOnType: register(
		new EditorBooleanOption(88 /* EditorOption.renameOnType */, 'renameOnType', false, {
			description: nls.localize(
				'renameOnType',
	...
	renderControlCharacters: register(
		new EditorBooleanOption(
			89 /* EditorOption.renderControlCharacters */,
	...
	renderFinalNewline: register(
		new EditorStringEnumOption(
			90 /* EditorOption.renderFinalNewline */,
			'renderFinalNewline',
	...
	renderLineHighlight: register(
		new EditorStringEnumOption(
			91 /* EditorOption.renderLineHighlight */,
			'renderLineHighlight',
			'line',
	...
	renderLineHighlightOnlyWhenFocus: register(
		new EditorBooleanOption(
			92 /* EditorOption.renderLineHighlightOnlyWhenFocus */,
	...
	renderWhitespace: register(
		new EditorStringEnumOption(
			94 /* EditorOption.renderWhitespace */,
			'renderWhitespace',
			'selection',
	...
	revealHorizontalRightPadding: register(
		new EditorIntOption(
			95 /* EditorOption.revealHorizontalRightPadding */,
	...
	roundedSelection: register(
		new EditorBooleanOption(96 /* EditorOption.roundedSelection */, 'roundedSelection', true, {
			description: nls.localize(
				'roundedSelection',
	...
	scrollBeyondLastColumn: register(
		new EditorIntOption(
			99 /* EditorOption.scrollBeyondLastColumn */,
	...
	scrollBeyondLastLine: register(
		new EditorBooleanOption(
			100 /* EditorOption.scrollBeyondLastLine */,
	...
	selectionClipboard: register(
		new EditorBooleanOption(102 /* EditorOption.selectionClipboard */, 'selectionClipboard', true, {
			description: nls.localize(
				'selectionClipboard',
	...
	selectionHighlight: register(
		new EditorBooleanOption(103 /* EditorOption.selectionHighlight */, 'selectionHighlight', true, {
			description: nls.localize(
				'selectionHighlight',
	...
	selectOnLineNumbers: register(
		new EditorBooleanOption(104 /* EditorOption.selectOnLineNumbers */, 'selectOnLineNumbers', true)
	),
	showFoldingControls: register(
		new EditorStringEnumOption(
			105 /* EditorOption.showFoldingControls */,
			'showFoldingControls',
			'mouseover',
	...
	showUnused: register(
		new EditorBooleanOption(106 /* EditorOption.showUnused */, 'showUnused', true, {
			description: nls.localize('showUnused', 'Controls fading out of unused code.')
		})
	),
	showDeprecated: register(
		new EditorBooleanOption(134 /* EditorOption.showDeprecated */, 'showDeprecated', true, {
	...
	snippetSuggestions: register(
		new EditorStringEnumOption(
			107 /* EditorOption.snippetSuggestions */,
			'snippetSuggestions',
			'inline',
	...
	smoothScrolling: register(
		new EditorBooleanOption(109 /* EditorOption.smoothScrolling */, 'smoothScrolling', false, {
			description: nls.localize(
				'smoothScrolling',
	...
	stopRenderingLineAfter: register(
		new EditorIntOption(
			112 /* EditorOption.stopRenderingLineAfter */,
	...
	suggestFontSize: register(
		new EditorIntOption(114 /* EditorOption.suggestFontSize */, 'suggestFontSize', 0, 0, 1000, {
			markdownDescription: nls.localize(
				'suggestFontSize',
	...
	suggestLineHeight: register(
		new EditorIntOption(115 /* EditorOption.suggestLineHeight */, 'suggestLineHeight', 0, 0, 1000, {
			markdownDescription: nls.localize(
				'suggestLineHeight',
	...
	suggestOnTriggerCharacters: register(
		new EditorBooleanOption(
			116 /* EditorOption.suggestOnTriggerCharacters */,
	...
	suggestSelection: register(
		new EditorStringEnumOption(
			117 /* EditorOption.suggestSelection */,
			'suggestSelection',
			'first',
	...
	tabCompletion: register(
		new EditorStringEnumOption(
			118 /* EditorOption.tabCompletion */,
			'tabCompletion',
			'off',
			['on', 'off', 'onlySnippets'],
			{
	...
	unusualLineTerminators: register(
		new EditorStringEnumOption(
			121 /* EditorOption.unusualLineTerminators */,
	...
	useShadowDOM: register(
		new EditorBooleanOption(122 /* EditorOption.useShadowDOM */, 'useShadowDOM', true)
	),
	useTabStops: register(
		new EditorBooleanOption(123 /* EditorOption.useTabStops */, 'useTabStops', true, {
			description: nls.localize(
				'useTabStops',
	...
	wordSeparators: register(
		new EditorStringOption(
			125 /* EditorOption.wordSeparators */,
			'wordSeparators',
	...
	wordWrapBreakAfterCharacters: register(
		new EditorStringOption(
			127 /* EditorOption.wordWrapBreakAfterCharacters */,
	...
	wordWrapBreakBeforeCharacters: register(
		new EditorStringOption(
			128 /* EditorOption.wordWrapBreakBeforeCharacters */,
	...
	wordWrapColumn: register(
		new EditorIntOption(
			129 /* EditorOption.wordWrapColumn */,
			'wordWrapColumn',
			80,
			1,
			1073741824 /* Constants.MAX_SAFE_SMALL_INTEGER */,
	...
	wordWrapOverride1: register(
		new EditorStringEnumOption(
			130 /* EditorOption.wordWrapOverride1 */,
			'wordWrapOverride1',
			'inherit',
			['off', 'on', 'inherit']
		)
	...
	wordWrapOverride2: register(
		new EditorStringEnumOption(
			131 /* EditorOption.wordWrapOverride2 */,
			'wordWrapOverride2',
			'inherit',
			['off', 'on', 'inherit']
		)
	...
	defaultColorDecorators: register(
		new EditorBooleanOption(
			141 /* EditorOption.defaultColorDecorators */,
	...
	tabFocusMode: register(
		new EditorBooleanOption(138 /* EditorOption.tabFocusMode */, 'tabFocusMode', false, {
			markdownDescription: nls.localize(
				'tabFocusMode',
