...
export class WordOperations {
	...
	static _doFindPreviousWordOnLine(lineContent, wordSeparators, position) {
		...
		if (wordType !== 0 /* WordType.None */) {
			return this._createWord(
				lineContent,
				wordType,
				1 /* WordCharacterClass.Whitespace */,
				0,
	...
	static _findEndOfWord(lineContent, wordSeparators, wordType, startIndex) {
		...
		for (let chIndex = startIndex; chIndex < len; chIndex++) {
			...
			if (
				wordType === 1 /* WordType.Regular */ &&
				chClass === 2 /* WordCharacterClass.WordSeparator */
			) {
				return chIndex;
			}
			if (
				wordType === 2 /* WordType.Separator */ &&
				chClass === 0 /* WordCharacterClass.Regular */
			) {
				return chIndex;
			}
		}
	...
	static moveWordPartLeft(wordSeparators, model, position) {
		const candidates = enforceDefined([
			WordOperations.moveWordLeft(
				...
				model,
				position,
				0 /* WordNavigationType.WordStart */
			),
			WordOperations.moveWordLeft(
				wordSeparators,
				model,
				position,
				2 /* WordNavigationType.WordEnd */
			),
