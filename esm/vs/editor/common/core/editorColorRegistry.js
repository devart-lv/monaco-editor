...
export const editorBracketHighlightingForeground4 = registerColor(
	...
	{ dark: '#00000000', light: '#00000000', hcDark: '#00000000', hcLight: '#00000000' },
	nls.localize(
...
export const editorUnicodeHighlightBorder = registerColor(
	...
	{ dark: '#BD9B03', light: '#CEA33D', hcDark: '#ff0000', hcLight: '#CEA33D' },
	nls.localize(
		'editorUnicodeHighlight.border',
...
export const editorUnicodeHighlightBackground = registerColor(
	...
	{ dark: '#bd9b0326', light: '#cea33d14', hcDark: '#00000000', hcLight: '#cea33d14' },
	nls.localize(
		'editorUnicodeHighlight.background',
...
registerThemingParticipant((theme, collector) => {
	...
	const imeBackground =
		lineHighlight && !lineHighlight.isTransparent() ? lineHighlight : background;
	if (imeBackground) {
		collector.addRule(
