...
(function (AccessibilityHelpNLS) {
	...
	AccessibilityHelpNLS.editableDiffEditor = nls.localize(
		'editableDiffEditor',
		' in a pane of a diff editor.'
	);
	AccessibilityHelpNLS.readonlyEditor = nls.localize(
		'readonlyEditor',
	...
	AccessibilityHelpNLS.accessibilityHelpTitle = nls.localize(
