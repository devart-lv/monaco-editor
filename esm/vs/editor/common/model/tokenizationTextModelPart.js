...
export class TokenizationTextModelPart extends TextModelPart {
	constructor(
		...
		this.grammarTokens = this._register(
			new GrammarTokens(
		...
		if (e.isFlush) {
			...
			for (const c of e.changes) {
				...
				this._semanticTokens.acceptEdit(
					...
					firstLineLength,
					lastLineLength,
					c.text.length > 0 ? c.text.charCodeAt(0) : 0 /* CharCode.Null */
				);
			}
		}
...
class GrammarTokens extends Disposable {
	...
	resetTokenization(fireTokenChangeEvent = true) {
		...
		if (this._tokenizer) {
			const b = {
				...
				setEndState: (lineNumber, state) => {
					...
					const firstInvalidEndStateLineNumber =
						(_b =
							(_a = this._tokenizer) === null || _a === void 0
								? void 0
								: _a.store.getFirstInvalidEndStateLineNumber()) !== null && _b !== void 0
							? _b
							: undefined;
					if (
						firstInvalidEndStateLineNumber !== undefined &&
						lineNumber >= firstInvalidEndStateLineNumber
					) {
						// Don't accept states for definitely valid states
						(_c = this._tokenizer) === null || _c === void 0
							? void 0
							: _c.store.setEndState(lineNumber, state);
					}
				}
			};
			if (
			...
			if (
				(tokenizationSupport === null || tokenizationSupport === void 0
					? void 0
					: tokenizationSupport.backgroundTokenizerShouldOnlyVerifyTokens) &&
				tokenizationSupport.createBackgroundTokenizer
			) {
				...
				this._debugBackgroundTokenizer.value = tokenizationSupport.createBackgroundTokenizer(
					this._textModel,
					{
						setTokens: (tokens) => {
							var _a;
							(_a = this._debugBackgroundTokens) === null || _a === void 0
								? void 0
								: _a.setMultilineTokens(tokens, this._textModel);
						},
						backgroundTokenizationFinished() {
							// NO OP
						},
						setEndState: (lineNumber, state) => {
							var _a;
							(_a = this._debugBackgroundStates) === null || _a === void 0
								? void 0
								: _a.setEndState(lineNumber, state);
						}
					}
				);
			} else {
	...
	handleDidChangeContent(e) {
		...
		if (e.isFlush) {
			...
			for (const c of e.changes) {
				...
				(_a = this._debugBackgroundTokens) === null || _a === void 0
					? void 0
					: _a.acceptEdit(c.range, eolCount, firstLineLength);
			}
			(_b = this._debugBackgroundStates) === null || _b === void 0
				? void 0
				: _b.acceptChanges(e.changes);
			if (this._tokenizer) {
				this._tokenizer.store.acceptChanges(e.changes);
			}
			(_c = this._defaultBackgroundTokenizer) === null || _c === void 0
				? void 0
				: _c.handleChanges();
		}
	}
	...
	refreshRange(startLineNumber, endLineNumber) {
		...
		if (heuristicTokens) {
			...
			for (const c of changedTokens.changes) {
				(_a = this._backgroundTokenizer.value) === null || _a === void 0
					? void 0
					: _a.requestTokens(c.fromLineNumber, c.toLineNumber + 1);
			}
		}
	...
	forceTokenization(lineNumber) {
		...
		(_a = this._tokenizer) === null || _a === void 0
			? void 0
			: _a.updateTokensUntilLine(builder, lineNumber);
		...
		if (this._debugBackgroundTokens && this._debugBackgroundStates && this._tokenizer) {
			if (
				...
				if (
					...
					((_a = this._debugBackgroundTokenizer.value) === null || _a === void 0
						? void 0
						: _a.reportMismatchingTokens)
				) {
