...
export class BracketPairsTree extends Disposable {
	...
	parseDocumentFromTextBuffer(edits, previousAst, immutable) {
		...
		const previousAstClone = isPure
			? previousAst === null || previousAst === void 0
				? void 0
	...
	whileLoop: while (true) {
		switch (node.kind) {
			...
			case 2 /* AstNodeKind.Pair */: {
				...
				levelPerBracketType === null || levelPerBracketType === void 0
					? void 0
			...
			new BracketPairWithMinIndentationInfo(
				...
				node.closingBracket
					? lengthsToRange(
							lengthAdd(
								openingBracketEnd,
								((_a = node.child) === null || _a === void 0 ? void 0 : _a.length) || lengthZero
							),
							nodeOffsetEnd
					  )
					: undefined,
