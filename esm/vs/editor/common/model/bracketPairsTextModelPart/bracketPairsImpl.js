...
export class BracketPairsTextModelPart extends Disposable {
	...
	constructor(textModel, languageConfigurationService) {
		...
		this._register(
			this.languageConfigurationService.onDidChange((e) => {
				...
				if (
					!e.languageId ||
					((_a = this.bracketPairsTree.value) === null || _a === void 0
						? void 0
						: _a.object.didLanguageChange(e.languageId))
				) {
	...
	handleDidChangeContent(change) {
		...
		(_a = this.bracketPairsTree.value) === null || _a === void 0
			? void 0
			: _a.object.handleContentChanged(change);
	}
	handleDidChangeBackgroundTokenizationState() {
		var _a;
		(_a = this.bracketPairsTree.value) === null || _a === void 0
			? void 0
			: _a.object.handleDidChangeBackgroundTokenizationState();
	}
	handleDidChangeTokens(e) {
		var _a;
		(_a = this.bracketPairsTree.value) === null || _a === void 0
			? void 0
			: _a.object.handleDidChangeTokens(e);
	}
	//#endregion
	updateBracketPairsTree() {
		if (this.bracketsRequested && this.canBuildAST) {
			if (!this.bracketPairsTree.value) {
				...
				store.add(
					this.bracketPairsTree.value.object.onDidChange((e) => this.onDidChangeEmitter.fire(e))
				);
	...
	getBracketPairsInRange(range) {
		...
		return (
			((_a = this.bracketPairsTree.value) === null || _a === void 0
				? void 0
				: _a.object.getBracketPairsInRange(range, false)) || CallbackIterable.empty
		);
	}
	getBracketPairsInRangeWithMinIndentation(range) {
		...
		return (
			((_a = this.bracketPairsTree.value) === null || _a === void 0
				? void 0
				: _a.object.getBracketPairsInRange(range, true)) || CallbackIterable.empty
		);
	}
	getBracketsInRange(range, onlyColorizedBrackets = false) {
		...
		return (
			((_a = this.bracketPairsTree.value) === null || _a === void 0
				? void 0
				: _a.object.getBracketsInRange(range, onlyColorizedBrackets)) || CallbackIterable.empty
		);
	}
	...
	findPrevBracket(_position) {
		...
		if (this.canBuildAST) {
			...
			return (
				((_a = this.bracketPairsTree.value) === null || _a === void 0
					? void 0
					: _a.object.getFirstBracketBefore(position)) || null
			);
		}
		let languageId = null;
		...
		for (let lineNumber = position.lineNumber; lineNumber >= 1; lineNumber--) {
			...
			for (; tokenIndex >= 0; tokenIndex--) {
				...
				const searchInToken =
					!!modeBrackets && !ignoreBracketsInToken(lineTokens.getStandardTokenType(tokenIndex));
				if (searchInToken) {
					// this token should be searched
					if (prevSearchInToken) {
						// the previous token should be searched, simply extend searchStartOffset
	...
	findNextBracket(_position) {
		...
		if (this.canBuildAST) {
			...
			return (
				((_a = this.bracketPairsTree.value) === null || _a === void 0
					? void 0
					: _a.object.getFirstBracketAfter(position)) || null
			);
		}
		const lineCount = this.textModel.getLineCount();
		let languageId = null;
