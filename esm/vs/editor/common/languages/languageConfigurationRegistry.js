...
LanguageConfigurationService = __decorate(
	[__param(0, IConfigurationService), __param(1, ILanguageService)],
...
export function getScopedLineTokens(model, lineNumber, columnNumber) {
	...
	const column =
		typeof columnNumber === 'undefined' ? model.getLineMaxColumn(lineNumber) - 1 : columnNumber - 1;
	...
	for (const entry of configs) {
		result = {
			...
			__electricCharacterSupport:
				entry.__electricCharacterSupport || result.__electricCharacterSupport
		};
	}
	return result;
}
...
export class LanguageConfigurationRegistry extends Disposable {
	...
	getLanguageConfiguration(languageId) {
		...
		return (
			(entries === null || entries === void 0 ? void 0 : entries.getResolvedConfiguration()) || null
		);
	}
}
/**
