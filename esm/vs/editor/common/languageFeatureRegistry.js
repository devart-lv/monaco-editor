...
class MatchCandidate {
	...
	equals(other) {
		...
		return (
			...
			((_a = this.notebookUri) === null || _a === void 0 ? void 0 : _a.toString()) ===
				((_b = other.notebookUri) === null || _b === void 0 ? void 0 : _b.toString())
		);
	}
}
export class LanguageFeatureRegistry {
	...
	_updateScores(model) {
		var _a, _b;
		const notebookInfo =
			(_a = this._notebookInfoResolver) === null || _a === void 0
				? void 0
				: _a.call(this, model.uri);
