...
export class SuggestWidgetAdaptor extends Disposable {
	...
	constructor(editor, suggestControllerPreselector, checkModelVersion) {
		...
		this._selectedItem = observableValue(
			'suggestWidgetInlineCompletionProvider.selectedItem',
			undefined
		);
				...
				suggestController.registerSelector({
					...
					select: (model, pos, suggestItems) => {
						...
						const itemToPreselect =
							(_a = this.suggestControllerPreselector()) === null || _a === void 0
								? void 0
								: _a.removeCommonPrefix(textModel);
						if (!itemToPreselect) {
							return -1;
						}
	...
	stopForceRenderingAbove() {
		const suggestController = SuggestController.get(this.editor);
		suggestController === null || suggestController === void 0
			? void 0
