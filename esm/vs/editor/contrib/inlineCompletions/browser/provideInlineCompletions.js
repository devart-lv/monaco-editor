...
export function provideInlineCompletions(
	...
	return __awaiter(this, void 0, void 0, function* () {
		...
		const providerResults = yield Promise.all(
			providers.map((provider) =>
				__awaiter(this, void 0, void 0, function* () {
					try {
						const completions = yield provider.provideInlineCompletions(
							model,
							position,
							context,
							token
...
function closeBrackets(text, position, model, languageConfigurationService) {
	...
	const slicedTokens =
		newTokens === null || newTokens === void 0
			? void 0
			: newTokens.sliceAndInflate(position.column - 1, newLine.length, 0);
	if (!slicedTokens) {
		return text;
	}
