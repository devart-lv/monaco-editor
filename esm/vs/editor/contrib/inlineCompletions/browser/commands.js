...
export class ShowNextInlineSuggestionAction extends EditorAction {
	...
	run(accessor, editor) {
		...
		return __awaiter(this, void 0, void 0, function* () {
			...
			(_a = controller === null || controller === void 0 ? void 0 : controller.model.get()) ===
				null || _a === void 0
				? void 0
				: _a.next();
		});
	...
	run(accessor, editor) {
		...
		return __awaiter(this, void 0, void 0, function* () {
			...
			(_a = controller === null || controller === void 0 ? void 0 : controller.model.get()) ===
				null || _a === void 0
				? void 0
				: _a.acceptNextWord(controller.editor);
		});
	}
}
	...
	run(accessor, editor) {
		...
		return __awaiter(this, void 0, void 0, function* () {
			...
			(_a = controller === null || controller === void 0 ? void 0 : controller.model.get()) ===
				null || _a === void 0
				? void 0
				: _a.acceptNextLine(controller.editor);
		});
	}
}
export class AcceptInlineCompletion extends EditorAction {
	...
	run(accessor, editor) {
		...
		return __awaiter(this, void 0, void 0, function* () {
			const controller = InlineCompletionsController.get(editor);
			if (controller) {
				(_a = controller.model.get()) === null || _a === void 0
					? void 0
					: _a.accept(controller.editor);
