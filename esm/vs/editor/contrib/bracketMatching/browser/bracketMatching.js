...
const overviewRulerBracketMatchForeground = registerColor(
	...
	{ dark: '#A0A0A0', light: '#A0A0A0', hcDark: '#A0A0A0', hcLight: '#A0A0A0' },
	nls.localize(
...
class JumpToBracketAction extends EditorAction {
	...
	run(accessor, editor) {
		var _a;
		(_a = BracketMatchingController.get(editor)) === null || _a === void 0
			? void 0
			: _a.jumpToBracket();
	}
}
class SelectToBracketAction extends EditorAction {
	...
	run(accessor, editor, args) {
		...
		(_a = BracketMatchingController.get(editor)) === null || _a === void 0
			? void 0
			: _a.selectToBracket(selectBrackets);
	}
}
