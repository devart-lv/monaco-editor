...
export let CopyPasteController = class CopyPasteController extends Disposable {
	...
	arePasteActionsEnabled(model) {
		if (
			this._configurationService.getValue('editor.experimental.pasteActions.enabled', {
				resource: model.uri
			})
		) {
			return true;
	...
	handleCopy(e) {
		...
		if (wasFromEmptySelection) {
			...
			ranges[0] = new Range(
				...
				0,
				primarySelection.startLineNumber,
				model.getLineLength(primarySelection.startLineNumber)
			);
		}
		...
		(_a = this._currentClipboardItem) === null || _a === void 0
			? void 0
			: _a.dataTransferPromise.cancel();
	...
	handlePaste(e) {
		...
		return __awaiter(this, void 0, void 0, function* () {
			...
			let metadata;
			const rawMetadata =
				(_b = e.clipboardData) === null || _b === void 0 ? void 0 : _b.getData(vscodeClipboardMime);
			...
			const p = createCancelablePromise((token) =>
				__awaiter(this, void 0, void 0, function* () {
					...
					const tokenSource = new EditorStateCancellationTokenSource(
						editor,
						1 /* CodeEditorStateFlag.Value */ | 2 /* CodeEditorStateFlag.Selection */,
						undefined,
						token
					);
					try {
						this._pasteProgressManager.setAtPosition(
							selections[0].getEndPosition(),
							localize('pasteIntoEditorProgress', 'Running paste handlers. Click to cancel'),
							{
						...
						const dataTransfer = toVSDataTransfer(e.clipboardData);
						if (
							(metadata === null || metadata === void 0 ? void 0 : metadata.id) &&
							((_c = this._currentClipboardItem) === null || _c === void 0 ? void 0 : _c.handle) ===
								metadata.id
						) {
						...
						const providerEdit = yield this.getProviderPasteEdit(
							providers,
							dataTransfer,
							model,
							selections,
						...
						if (providerEdit) {
							const snippet =
								typeof providerEdit.insertText === 'string'
									? SnippetParser.escape(providerEdit.insertText)
									: providerEdit.insertText.snippet;
							const combinedWorkspaceEdit = {
								edits: [
									...
									...((_e =
										(_d = providerEdit.additionalEdit) === null || _d === void 0
											? void 0
											: _d.edits) !== null && _e !== void 0
										? _e
										: [])
								]
							};
						...
						tokenSource.dispose();
						if (
							((_f = this._currentOperation) === null || _f === void 0 ? void 0 : _f.id) ===
							operationId
						) {
							this._pasteProgressManager.clear();
			...
			(() =>
				__awaiter(this, void 0, void 0, function* () {
					for (const provider of providers) {
						...
						const edit = yield provider.provideDocumentPasteEdits(
							model,
							selections,
							dataTransfer,
							token
	...
	applyDefaultPasteHandler(dataTransfer, metadata, token) {
		...
		return __awaiter(this, void 0, void 0, function* () {
			const textDataTransfer =
				(_a = dataTransfer.get(Mimes.text)) !== null && _a !== void 0
					? _a
			...
			this._editor.trigger('keyboard', 'paste' /* Handler.Paste */, {
				text: text,
				pasteOnNewLine:
					metadata === null || metadata === void 0 ? void 0 : metadata.wasFromEmptySelection,
