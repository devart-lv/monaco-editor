...
export let InlayHintsHover = class InlayHintsHover extends MarkdownHoverParticipant {
	...
	suggestHoverAnchor(mouseEvent) {
		...
		const options =
			(_a = mouseEvent.target.detail.injectedText) === null || _a === void 0 ? void 0 : _a.options;
		if (
			!(
	...
	computeAsync(anchor, _lineDecorations, token) {
		...
		return new AsyncIterableObject((executor) =>
			__awaiter(this, void 0, void 0, function* () {
				...
				if (part.part.location || part.part.command) {
					let linkHint;
					const useMetaKey =
						this._editor.getOption(75 /* EditorOption.multiCursorModifier */) === 'altKey';
					const kb = useMetaKey
					...
					if (part.part.location && part.part.command) {
						...
						linkHint = new MarkdownString(
							`[${localize('hint.cmd', 'Execute Command')}](${asCommandLink(part.part.command)} "${
				...
				try {
					for (
						var _d = true, iterable_1 = __asyncValues(iterable), iterable_1_1;
						(iterable_1_1 = yield iterable_1.next()), (_a = iterable_1_1.done), !_a;
