...
export let InlayHintsController = class InlayHintsController {
	static get(editor) {
		var _a;
		return (_a = editor.getContribution(InlayHintsController.ID)) !== null && _a !== void 0
			? _a
			: undefined;
	}
	constructor(
		...
		this._disposables.add(
			_languageFeaturesService.inlayHintsProvider.onDidChange(() => this._update())
		);
	...
	_update() {
			...
			() =>
				__awaiter(this, void 0, void 0, function* () {
					...
					try {
						...
						const inlayHints = yield InlayHintsFragments.create(
		...
		this._sessionDisposables.add(
			toDisposable(() => (cts === null || cts === void 0 ? void 0 : cts.dispose(true)))
		);
		...
		if (options.enabled === 'on') {
			...
			this._sessionDisposables.add(
				ModifierKeyEmitter.getInstance().event((e) => {
					...
					const newRenderMode =
						e.altKey && e.ctrlKey && !(e.shiftKey || e.metaKey) ? altMode : defaultMode;
	...
	_installDblClickGesture(updateInlayHints) {
		return this._editor.onMouseUp((e) =>
			__awaiter(this, void 0, void 0, function* () {
				if (e.event.detail !== 2) {
					return;
				}
	...
	_installContextMenu() {
		return this._editor.onContextMenu((e) =>
			__awaiter(this, void 0, void 0, function* () {
				...
				const part = this._getInlayHintLabelPart(e);
				if (part) {
					yield this._instaService.invokeFunction(
						showGoToContextMenu,
						this._editor,
						e.event.target,
						part
	...
	_getInlayHintLabelPart(e) {
		...
		const options =
			(_a = e.target.detail.injectedText) === null || _a === void 0 ? void 0 : _a.options;
		if (
			options instanceof ModelDecorationInjectedTextOptions &&
			(options === null || options === void 0 ? void 0 : options.attachedData) instanceof
	...
	_invokeCommand(command, item) {
		...
		return __awaiter(this, void 0, void 0, function* () {
			try {
				yield this._commandService.executeCommand(
					command.id,
					...((_a = command.arguments) !== null && _a !== void 0 ? _a : [])
				);
			} catch (err) {
	...
	_updateHintsDecorators(ranges, items) {
				...
				decoration: {
					...
					options: {
						...
						[item.anchor.direction]:
							this._activeRenderMode === 0 /* RenderMode.Normal */ ? opts : undefined
					}
				}
			});
		};
		...
		for (const item of items) {
			...
			for (let i = 0; i < parts.length; i++) {
				...
				if (
					...
					((_a = this._activeInlayHintPart) === null || _a === void 0 ? void 0 : _a.part.item) ===
						item &&
		...
		for (const range of ranges) {
			for (const { id } of (_b = this._editor.getDecorationsInRange(range)) !== null &&
			_b !== void 0
				? _b
				: []) {
...
CommandsRegistry.registerCommand('_executeInlayHintProvider', (accessor, ...args) =>
	__awaiter(void 0, void 0, void 0, function* () {
		...
		try {
			const model = yield InlayHintsFragments.create(
				inlayHintsProvider,
