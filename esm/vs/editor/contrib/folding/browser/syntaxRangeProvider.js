...
export class SyntaxRangeProvider {
	constructor(
		...
		foldingRangesLimit,
		fallbackRangeProvider // used when all providers return null
	) {
	...
	compute(cancellationToken) {
		return collectSyntaxRanges(this.providers, this.editorModel, cancellationToken).then(
			(ranges) => {
				var _a, _b;
				if (ranges) {
				...
				return (_b =
					(_a = this.fallbackRangeProvider) === null || _a === void 0
						? void 0
						: _a.compute(cancellationToken)) !== null && _b !== void 0
					? _b
					: null;
			}
		);
