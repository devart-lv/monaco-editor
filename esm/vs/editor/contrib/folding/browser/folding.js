...
export let FoldingController = class FoldingController extends Disposable {
	...
	static getFoldingRangeProviders(languageFeaturesService, model) {
		...
		return (_b =
			(_a = FoldingController._foldingRangeSelector) === null || _a === void 0
				? void 0
				: _a.call(FoldingController, foldingRangeProviders, model)) !== null && _b !== void 0
			? _b
	...
	constructor(
		...
		this._useFoldingProviders =
			options.get(42 /* EditorOption.foldingStrategy */) !== 'indentation';
		...
		this.foldingDecorationProvider.showFoldingHighlights = options.get(
			43 /* EditorOption.foldingHighlight */
		);
		...
		this._register(
			this.editor.onDidChangeConfiguration((e) => {
				...
				if (
					e.hasChanged(105 /* EditorOption.showFoldingControls */) ||
					e.hasChanged(43 /* EditorOption.foldingHighlight */)
				) {
					const options = this.editor.getOptions();
					this.foldingDecorationProvider.showFoldingControls = options.get(
						105 /* EditorOption.showFoldingControls */
	...
	onDidChangeModelContent(e) {
		var _a;
		(_a = this.hiddenRangeModel) === null || _a === void 0
			? void 0
			: _a.notifyChangeModelContent(e);
		this.triggerFoldingModelChanged();
	}
				...
				.trigger(() => {
					...
					return foldingRegionPromise.then((foldingRanges) => {
						if (foldingRanges && foldingRegionPromise === this.foldingRegionPromise) {
							...
							const selectionLineNumbers = selections
								? selections.map((s) => s.startLineNumber)
								: [];
							foldingModel.update(foldingRanges, selectionLineNumbers);
							scrollState === null || scrollState === void 0
								? void 0
	...
	constructor() {
		super({
			...
			kbOpts: {
				...
				primary:
					2048 /* KeyMod.CtrlCmd */ | 1024 /* KeyMod.Shift */ | 94 /* KeyCode.BracketRight */,
				mac: {
	...
	constructor() {
		super({
			...
			kbOpts: {
				kbExpr: EditorContextKeys.editorTextFocus,
				primary: KeyChord(
					2048 /* KeyMod.CtrlCmd */ | 41 /* KeyCode.KeyK */,
					2048 /* KeyMod.CtrlCmd */ | 94 /* KeyCode.BracketRight */
				),
				weight: 100 /* KeybindingWeight.EditorContrib */
			}
		});
	...
	constructor() {
		super({
			...
			kbOpts: {
				...
				primary: KeyChord(
					2048 /* KeyMod.CtrlCmd */ | 41 /* KeyCode.KeyK */,
					2048 /* KeyMod.CtrlCmd */ | 42 /* KeyCode.KeyL */
				),
				weight: 100 /* KeybindingWeight.EditorContrib */
			}
		});
	...
	constructor() {
		super({
			...
			kbOpts: {
				...
				primary: KeyChord(
					2048 /* KeyMod.CtrlCmd */ | 41 /* KeyCode.KeyK */,
					2048 /* KeyMod.CtrlCmd */ | 92 /* KeyCode.BracketLeft */
				),
				weight: 100 /* KeybindingWeight.EditorContrib */
			}
		});
	...
	constructor() {
		super({
			...
			kbOpts: {
				...
				primary: KeyChord(
					2048 /* KeyMod.CtrlCmd */ | 41 /* KeyCode.KeyK */,
					2048 /* KeyMod.CtrlCmd */ | 90 /* KeyCode.Slash */
				),
				weight: 100 /* KeybindingWeight.EditorContrib */
			}
		});
	...
	constructor() {
		super({
			...
			kbOpts: {
				...
				primary: KeyChord(
					2048 /* KeyMod.CtrlCmd */ | 41 /* KeyCode.KeyK */,
					2048 /* KeyMod.CtrlCmd */ | 29 /* KeyCode.Digit8 */
				),
				weight: 100 /* KeybindingWeight.EditorContrib */
			}
		});
	...
	constructor() {
		super({
			...
			kbOpts: {
				...
				primary: KeyChord(
					2048 /* KeyMod.CtrlCmd */ | 41 /* KeyCode.KeyK */,
					2048 /* KeyMod.CtrlCmd */ | 30 /* KeyCode.Digit9 */
				),
				weight: 100 /* KeybindingWeight.EditorContrib */
			}
		});
	...
	constructor() {
		super({
			...
			kbOpts: {
				...
				primary: KeyChord(
					2048 /* KeyMod.CtrlCmd */ | 41 /* KeyCode.KeyK */,
					2048 /* KeyMod.CtrlCmd */ | 88 /* KeyCode.Minus */
				),
				weight: 100 /* KeybindingWeight.EditorContrib */
			}
		});
	...
	constructor() {
		super({
			...
			kbOpts: {
				...
				primary: KeyChord(
					2048 /* KeyMod.CtrlCmd */ | 41 /* KeyCode.KeyK */,
					2048 /* KeyMod.CtrlCmd */ | 86 /* KeyCode.Equal */
				),
				weight: 100 /* KeybindingWeight.EditorContrib */
			}
		});
	...
	constructor() {
		super({
			...
			kbOpts: {
				...
				primary: KeyChord(
					2048 /* KeyMod.CtrlCmd */ | 41 /* KeyCode.KeyK */,
					2048 /* KeyMod.CtrlCmd */ | 21 /* KeyCode.Digit0 */
				),
				weight: 100 /* KeybindingWeight.EditorContrib */
			}
		});
	...
	constructor() {
		super({
			...
			kbOpts: {
				...
				primary: KeyChord(
					2048 /* KeyMod.CtrlCmd */ | 41 /* KeyCode.KeyK */,
					2048 /* KeyMod.CtrlCmd */ | 40 /* KeyCode.KeyJ */
				),
				weight: 100 /* KeybindingWeight.EditorContrib */
			}
		});
	...
	constructor() {
		super({
			...
			kbOpts: {
				...
				primary: KeyChord(
					2048 /* KeyMod.CtrlCmd */ | 41 /* KeyCode.KeyK */,
					2048 /* KeyMod.CtrlCmd */ | 87 /* KeyCode.Comma */
				),
				weight: 100 /* KeybindingWeight.EditorContrib */
			}
		});
		...
		if (selections) {
			...
			if (collapseRanges.length > 0) {
				...
				const newRanges = FoldingRegions.sanitizeAndMerge(
					...
					collapseRanges,
					(_a = editor.getModel()) === null || _a === void 0 ? void 0 : _a.getLineCount()
				);
	...
	registerInstantiatedEditorAction(
		new FoldLevelAction({
			...
			kbOpts: {
				...
				primary: KeyChord(
					2048 /* KeyMod.CtrlCmd */ | 41 /* KeyCode.KeyK */,
					2048 /* KeyMod.CtrlCmd */ | (21 /* KeyCode.Digit0 */ + i)
				),
				weight: 100 /* KeybindingWeight.EditorContrib */
			}
		})
