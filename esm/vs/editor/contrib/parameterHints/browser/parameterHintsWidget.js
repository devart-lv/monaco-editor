...
export let ParameterHintsWidget = class ParameterHintsWidget extends Disposable {
	...
	hide() {
		...
		this.visible = false;
		this.announcedLabel = null;
		(_a = this.domNodes) === null || _a === void 0
			? void 0
			: _a.element.classList.remove('visible');
		this.editor.layoutContentWidget(this);
	}
	getPosition() {
		if (this.visible) {
	...
	render(hints) {
		...
		if (
			activeParameter === null || activeParameter === void 0
				? void 0
...
ParameterHintsWidget = __decorate(
	[__param(2, IContextKeyService), __param(3, IOpenerService), __param(4, ILanguageService)],
