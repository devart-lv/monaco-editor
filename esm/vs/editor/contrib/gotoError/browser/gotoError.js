		...
		return __awaiter(this, void 0, void 0, function* () {
			if (this._editor.hasModel()) {
				...
				if (model.selected.marker.resource.toString() !== this._editor.getModel().uri.toString()) {
					...
					if (otherEditor) {
						(_a = MarkerController.get(otherEditor)) === null || _a === void 0
							? void 0
							: _a.close();
						(_b = MarkerController.get(otherEditor)) === null || _b === void 0
							? void 0
							: _b.nagivate(next, multiFile);
					}
				} else {
					// show in this editor
					this._widget.showAtMarker(
...
class MarkerNavigationAction extends EditorAction {
	...
	run(_accessor, editor) {
		...
		return __awaiter(this, void 0, void 0, function* () {
			if (editor.hasModel()) {
				(_a = MarkerController.get(editor)) === null || _a === void 0
					? void 0
					: _a.nagivate(this._next, this._multiFile);
			}
		});
	}
}
...
NextMarkerAction.LABEL = nls.localize(
...
PrevMarkerAction.LABEL = nls.localize(
