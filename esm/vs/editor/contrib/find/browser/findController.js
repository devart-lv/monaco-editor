...
export let CommonFindController = class CommonFindController extends Disposable {
	...
	getGlobalBufferTerm() {
		return __awaiter(this, void 0, void 0, function* () {
			if (
				this._editor.getOption(39 /* EditorOption.find */).globalFindClipboard &&
...
export let FindController = class FindController extends CommonFindController {
	...
	_createFindWidget() {
		...
		this._findOptionsWidget = this._register(
			new FindOptionsWidget(this._editor, this._state, this._keybindingService)
		);
	}
};
...
StartFindAction.addImplementation(0, (accessor, editor, args) => {
	...
	return controller.start({
		...
		seedSearchStringFromNonEmptySelection:
			editor.getOption(39 /* EditorOption.find */).seedSearchStringFromSelection === 'selection',
		seedSearchStringFromGlobalClipboard: editor.getOption(39 /* EditorOption.find */)
			.globalFindClipboard,
				...
				yield controller.start(
					{
						...
						seedSearchStringFromSelection:
							...
							editor.getOption(39 /* EditorOption.find */).seedSearchStringFromSelection !== 'never'
								...
								: 'none',
						seedSearchStringFromNonEmptySelection:
							editor.getOption(39 /* EditorOption.find */).seedSearchStringFromSelection ===
							'selection',
						seedSearchStringFromGlobalClipboard: true,
						shouldFocus: 1 /* FindStartFocusAction.FocusFindInput */,
						shouldAnimate: true,
						updateSearchScope:
							(args === null || args === void 0 ? void 0 : args.findInSelection) || false,
						loop: editor.getOption(39 /* EditorOption.find */).loop
					},
					newState
				);
