		...
		snippet.walk((marker) => {
			...
			if (adjustIndentation) {
				...
				if (offset === 0) {
					...
					snippetTextString =
						snippetTextString !== null && snippetTextString !== void 0
							? snippetTextString
							: snippet.toString();
					const prevChar = snippetTextString.charCodeAt(offset - 1);
					if (
						prevChar === 10 /* CharCode.LineFeed */ ||
						prevChar === 13 /* CharCode.CarriageReturn */
					) {
			...
			snippet.resolveVariables(
				new CompositeSnippetVariableResolver([
					...
					new ClipboardBasedVariableResolver(
						...
						editor.getOption(76 /* EditorOption.multiCursorPaste */) === 'spread'
					),
...
SnippetSession = __decorate([__param(3, ILanguageConfigurationService)], SnippetSession);
