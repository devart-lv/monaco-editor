		...
		try {
			this._doInsert(
				...
				typeof opts === 'undefined'
					? _defaultOptions
					: Object.assign(Object.assign({}, _defaultOptions), opts)
			);
		} catch (e) {
			this.cancel();
...
SnippetController2.InSnippetMode = new RawContextKey(
	'inSnippetMode',
	false,
	localize('inSnippetMode', 'Whether the editor in current in snippet mode')
);
SnippetController2.HasNextTabstop = new RawContextKey(
	'hasNextTabstop',
	false,
	localize('hasNextTabstop', 'Whether there is a next tab stop when in snippet mode')
);
SnippetController2.HasPrevTabstop = new RawContextKey(
	'hasPrevTabstop',
	false,
