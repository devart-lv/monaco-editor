...
export class SnippetParser {
	...
	parse(value, insertFinalTabstop, enforceFinalTabstop) {
		...
		this.ensureFinalTabstop(
			snippet,
			enforceFinalTabstop !== null && enforceFinalTabstop !== void 0 ? enforceFinalTabstop : false,
			insertFinalTabstop !== null && insertFinalTabstop !== void 0 ? insertFinalTabstop : false
		);
		return snippet;
	}
	...
	_until(type) {
		...
		while (this._token.type !== type) {
			if (this._token.type === 14 /* TokenType.EOF */) {
				...
				if (
					nextToken.type !== 0 /* TokenType.Dollar */ &&
	...
	_parseTabstopOrVariableName(parent) {
		...
		const match =
			this._accept(0 /* TokenType.Dollar */) &&
			(value =
				this._accept(9 /* TokenType.VariableName */, true) ||
				this._accept(8 /* TokenType.Int */, true));
		if (!match) {
	...
	_parseChoiceElement(parent) {
		...
		while (true) {
			if (
				this._token.type === 2 /* TokenType.Comma */ ||
				this._token.type === 7 /* TokenType.Pipe */
			) {
				break;
			}
			let value;
