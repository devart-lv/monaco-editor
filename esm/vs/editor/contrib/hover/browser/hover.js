...
export let ModesHoverController = class ModesHoverController {
	...
	_onEditorMouseMove(mouseEvent) {
		...
		if (
			this._isHoverSticky &&
			((_a = this._contentWidget) === null || _a === void 0
				? void 0
				: _a.containsNode(
						(_b = mouseEvent.event.browserEvent.view) === null || _b === void 0
							? void 0
							: _b.document.activeElement
				  )) &&
			!((_d =
				(_c = mouseEvent.event.browserEvent.view) === null || _c === void 0
					? void 0
					: _c.getSelection()) === null || _d === void 0
				? void 0
				: _d.isCollapsed)
		) {
		...
		if (
			this._isHoverSticky &&
			((_f = this._contentWidget) === null || _f === void 0 ? void 0 : _f.isVisibleFromKeyboard())
		) {
	...
	_onKeyDown(e) {
		...
		const mightTriggerFocus =
			(resolvedKeyboardEvent === null || resolvedKeyboardEvent === void 0
				? void 0
				: resolvedKeyboardEvent.kind) === 1 /* ResultKind.MoreChordsNeeded */ ||
			(resolvedKeyboardEvent &&
...
class ShowOrFocusHoverAction extends EditorAction {
	...
	run(accessor, editor, args) {
		...
		const focus =
			editor.getOption(2 /* EditorOption.accessibilitySupport */) ===
