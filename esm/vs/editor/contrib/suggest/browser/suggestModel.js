...
export let SuggestModel = class SuggestModel {
	...
	_updateTriggerCharacters() {
		...
		if (
			this._editor.getOption(87 /* EditorOption.readOnly */) ||
		...
		const checkTriggerCharacter = (text) => {
			...
			if (supports) {
				...
				this.trigger({
					...
					clipboardText:
						(_a = this._completionModel) === null || _a === void 0 ? void 0 : _a.clipboardText,
	...
	_doTriggerQuickSuggest() {
		if (
			QuickSuggestionsOptions.isAllOff(
				this._editor.getOption(85 /* EditorOption.quickSuggestions */)
			)
		) {
			// not enabled
			return;
	...
	_refilterCompletionItems() {
		...
		const ctx = new LineContext(
			model,
			position,
			Object.assign(Object.assign({}, this._triggerState), { refilter: true })
		);
	...
	trigger(options) {
		...
		let suggestCtx = {
			triggerKind:
				(_b = options.triggerKind) !== null && _b !== void 0
					? _b
					: 0 /* CompletionTriggerKind.Invoke */
		};
		...
		const { itemKind: itemKindFilter, showDeprecated } = SuggestModel._createSuggestFilter(
			this._editor
		);
		const completionOptions = new CompletionOptions(
			snippetSortOrder,
			(_d = (_c = options.completionOptions) === null || _c === void 0 ? void 0 : _c.kindFilter) !==
				null && _d !== void 0
				? _d
				: itemKindFilter,
			(_e = options.completionOptions) === null || _e === void 0 ? void 0 : _e.providerFilter,
			(_f = options.completionOptions) === null || _f === void 0 ? void 0 : _f.providerItemsToReuse,
			showDeprecated
		);
		...
		Promise.all([completions, wordDistance])
			.then(([completions, wordDistance]) =>
				__awaiter(this, void 0, void 0, function* () {
					...
					let clipboardText =
						options === null || options === void 0 ? void 0 : options.clipboardText;
					...
					// }
					const ctx = new LineContext(model, this._editor.getPosition(), options);
					const fuzzySearchOptions = Object.assign(Object.assign({}, FuzzyScoreOptions.default), {
						firstMatchCanBeWeak: !this._editor.getOption(113 /* EditorOption.suggest */)
					...
					this._completionModel = new CompletionModel(
						...
						wordDistance,
						this._editor.getOption(113 /* EditorOption.suggest */),
						this._editor.getOption(107 /* EditorOption.snippetSuggestions */),
						fuzzySearchOptions,
						clipboardText
					);
