		...
		for (const item of Iterable.concat(first, second)) {
			...
			result.push(
				new SuggestInlineCompletion(
					range,
					insertText,
					(_a = item.filterTextLow) !== null && _a !== void 0 ? _a : item.labelLow,
...
export let SuggestInlineCompletions = class SuggestInlineCompletions {
	...
	provideInlineCompletions(model, position, context, token) {
		...
		return __awaiter(this, void 0, void 0, function* () {
			...
			if (
				!(wordInfo === null || wordInfo === void 0 ? void 0 : wordInfo.word) &&
			...
			if (
				!triggerCharacterInfo &&
				((_a = this._lastResult) === null || _a === void 0
					? void 0
					: _a.canBeReused(model, position.lineNumber, wordInfo))
			) {
				...
				const completions = yield provideSuggestionItems(
					...
					new CompletionOptions(
						undefined,
						undefined,
						triggerCharacterInfo === null || triggerCharacterInfo === void 0
							? void 0
				...
				const completionModel = new CompletionModel(
					...
					WordDistance.None,
					this._getEditorOption(113 /* EditorOption.suggest */, model),
					this._getEditorOption(107 /* EditorOption.snippetSuggestions */, model),
	...
	constructor(_editor, languageFeatureService, editorService, instaService) {
		...
		if (++EditorContribution._counter === 1) {
			const provider = instaService.createInstance(SuggestInlineCompletions, (id, model) => {
				...
				const editor =
					(_a = editorService.listCodeEditors().find((editor) => editor.getModel() === model)) !==
						null && _a !== void 0
						? _a
						: _editor;
				return editor.getOption(id);
			});
			EditorContribution._disposable = languageFeatureService.inlineCompletionsProvider.register(
				'*',
				provider
			);
		}
...
); // eager because the contribution is used as a way to ONCE access a service to which a provider is registered
