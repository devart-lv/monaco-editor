	...
	constructor(position, completion, container, provider) {
		...
		this.textLabel =
			typeof completion.label === 'string'
				? completion.label
				: (_a = completion.label) === null || _a === void 0
				? void 0
				: _a.label;
...
export function provideSuggestionItems(
	...
	context = { triggerKind: 0 /* languages.CompletionTriggerKind.Invoke */ },
	...
	return __awaiter(this, void 0, void 0, function* () {
		...
		const onCompletionList = (provider, container, sw) => {
			...
			for (const suggestion of container.suggestions) {
				if (!options.kindFilter.has(suggestion.kind)) {
					...
					if (
						...
						((_a = suggestion === null || suggestion === void 0 ? void 0 : suggestion.tags) ===
							null || _a === void 0
							? void 0
							: _a.includes(1 /* languages.CompletionItemTag.Deprecated */))
					) {
						continue;
					}
			...
			durations.push({
				providerName:
					(_b = provider._debugDisplayName) !== null && _b !== void 0 ? _b : 'unknown_provider',
		...
		const snippetCompletions = (() =>
			__awaiter(this, void 0, void 0, function* () {
				...
				const sw = new StopWatch(true);
				const list = yield _snippetSuggestSupport.provideCompletionItems(
					model,
					position,
					context,
					token
...
CommandsRegistry.registerCommand('_executeCompletionItemProvider', (accessor, ...args) =>
	__awaiter(void 0, void 0, void 0, function* () {
		...
		try {
			...
			const completions = yield provideSuggestionItems(
				completionProvider,
				...
				{
					triggerCharacter:
						triggerCharacter !== null && triggerCharacter !== void 0 ? triggerCharacter : undefined,
			...
			for (const item of completions.items) {
				if (
					resolving.length <
					(maxItemsToResolve !== null && maxItemsToResolve !== void 0 ? maxItemsToResolve : 0)
				) {
...
export function showSimpleSuggestions(editor, provider) {
	var _a;
	(_a = editor.getContribution('editor.contrib.suggestController')) === null || _a === void 0
		? void 0
		: _a.triggerSuggest(new Set().add(provider), undefined, true);
}
