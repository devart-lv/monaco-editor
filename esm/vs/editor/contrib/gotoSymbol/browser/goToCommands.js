					...
					__awaiter(this, void 0, void 0, function* () {
						...
						if (referenceCount === 0) {
							...
							if (!this.configuration.muteMessage) {
								...
								(_a = MessageController.get(editor)) === null || _a === void 0
									? void 0
									: _a.showMessage(this._getNoResultFoundMessage(info), position);
							}
	...
	_openInPeek(target, model, range) {
		...
		if (controller && target.hasModel()) {
			controller.toggleWidget(
				range !== null && range !== void 0 ? range : target.getSelection(),
	...
	_getLocationModel(languageFeaturesService, model, position, token) {
		return __awaiter(this, void 0, void 0, function* () {
			return new ReferencesModel(
				yield getDefinitionsAtPosition(
...
class DeclarationAction extends SymbolNavigationAction {
	_getLocationModel(languageFeaturesService, model, position, token) {
		return __awaiter(this, void 0, void 0, function* () {
			return new ReferencesModel(
				yield getDeclarationsAtPosition(
...
class TypeDefinitionAction extends SymbolNavigationAction {
	_getLocationModel(languageFeaturesService, model, position, token) {
		return __awaiter(this, void 0, void 0, function* () {
			return new ReferencesModel(
				yield getTypeDefinitionsAtPosition(
...
class ImplementationAction extends SymbolNavigationAction {
	_getLocationModel(languageFeaturesService, model, position, token) {
		return __awaiter(this, void 0, void 0, function* () {
			return new ReferencesModel(
				yield getImplementationsAtPosition(
...
class GenericGoToLocationAction extends SymbolNavigationAction {
	...
	_getGoToPreference(editor) {
		...
		return (_a = this._gotoMultipleBehaviour) !== null && _a !== void 0
			? _a
			: editor.getOption(56 /* EditorOption.gotoLocation */).multipleReferences;
	}
