...
export const dropWidgetVisibleCtx = new RawContextKey(
	'dropWidgetVisible',
	false,
...
let PostDropWidget = class PostDropWidget extends Disposable {
	...
	_updateButtonTitle() {
		var _a;
		const binding =
			(_a = this._keybindingService.lookupKeybinding(changeDropTypeCommandId)) === null ||
			_a === void 0
				? void 0
				: _a.getLabel();
	...
	create() {
		...
		this._register(
			dom.addDisposableListener(this.domNode, dom.EventType.CLICK, () => this.showDropSelector())
		);
	}
	getId() {
...
PostDropWidget = __decorate(
	[__param(4, IContextMenuService), __param(5, IContextKeyService), __param(6, IKeybindingService)],
	PostDropWidget
);
...
PostDropWidgetManager = __decorate([__param(1, IInstantiationService)], PostDropWidgetManager);
