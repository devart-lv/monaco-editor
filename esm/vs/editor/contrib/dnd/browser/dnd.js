...
export class DragAndDropController extends Disposable {
	...
	onEditorKeyDown(e) {
		if (
			!this._editor.getOption(33 /* EditorOption.dragAndDrop */) ||
			this._editor.getOption(20 /* EditorOption.columnSelection */)
		) {
			return;
		}
	...
	_hitMargin(target) {
		return (
			target.type === 2 /* MouseTargetType.GUTTER_GLYPH_MARGIN */ ||
