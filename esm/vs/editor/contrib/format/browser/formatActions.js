...
FormatOnType = __decorate(
	[__param(1, ILanguageFeaturesService), __param(2, IEditorWorkerService)],
	FormatOnType
);
...
FormatOnPaste = __decorate(
	[__param(1, ILanguageFeaturesService), __param(2, IInstantiationService)],
	FormatOnPaste
);
		...
		super({
			...
			kbOpts: {
				...
				primary: KeyChord(
					...
					2048 /* KeyMod.CtrlCmd */ | 36 /* KeyCode.KeyF */
				),
				weight: 100 /* KeybindingWeight.EditorContrib */
			},
			contextMenuOpts: {
