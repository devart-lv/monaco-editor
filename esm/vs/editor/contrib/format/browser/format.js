...
export function formatDocumentRangesWithProvider(
	accessor,
	provider,
	editorOrModel,
	rangeOrRanges,
	...
	return __awaiter(this, void 0, void 0, function* () {
		...
		if (isCodeEditor(editorOrModel)) {
			...
			cts = new EditorStateCancellationTokenSource(
				editorOrModel,
				1 /* CodeEditorStateFlag.Value */ | 4 /* CodeEditorStateFlag.Position */,
				undefined,
				token
			);
		} else {
		...
		const computeEdits = (range) =>
			__awaiter(this, void 0, void 0, function* () {
				var _c, _d;
				logService.trace(
					`[format][provideDocumentRangeFormattingEdits] (request)`,
					(_c = provider.extensionId) === null || _c === void 0 ? void 0 : _c.value,
					range
				);
				const result =
					(yield provider.provideDocumentRangeFormattingEdits(
						model,
						range,
				...
				logService.trace(
					...
					(_d = provider.extensionId) === null || _d === void 0 ? void 0 : _d.value,
					result
				);
				return result;
			});
		...
		try {
			if (typeof provider.provideDocumentRangesFormattingEdits === 'function') {
				logService.trace(
					`[format][provideDocumentRangeFormattingEdits] (request)`,
					(_a = provider.extensionId) === null || _a === void 0 ? void 0 : _a.value,
					ranges
				);
				const result =
					(yield provider.provideDocumentRangesFormattingEdits(
						model,
						ranges,
						model.getFormattingOptions(),
						cts.token
				...
				logService.trace(
					`[format][provideDocumentRangeFormattingEdits] (response)`,
					(_b = provider.extensionId) === null || _b === void 0 ? void 0 : _b.value,
					result
				);
...
export function formatDocumentWithProvider(accessor, provider, editorOrModel, mode, token) {
	return __awaiter(this, void 0, void 0, function* () {
		...
		let edits;
		try {
			const rawEdits = yield provider.provideDocumentFormattingEdits(
				model,
				model.getFormattingOptions(),
				cts.token
			);
...
export function getDocumentRangeFormattingEditsUntilResult(
	workerService,
	...
	return __awaiter(this, void 0, void 0, function* () {
		...
		for (const provider of providers) {
			const rawEdits = yield Promise.resolve(
...
export function getDocumentFormattingEditsUntilResult(
	workerService,
	languageFeaturesService,
	model,
	options,
...
export function getOnTypeFormattingEdits(
	...
	return Promise.resolve(
		providers[0].provideOnTypeFormattingEdits(model, position, ch, options, token)
	)
		.catch(onUnexpectedExternalError)
		.then((edits) => {
