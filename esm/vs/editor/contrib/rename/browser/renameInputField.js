...
export const CONTEXT_RENAME_INPUT_VISIBLE = new RawContextKey(
	'renameInputVisible',
	false,
...
export let RenameInputField = class RenameInputField {
	...
	_updateStyles(theme) {
		...
		this._input.style.borderColor =
			(_d = border === null || border === void 0 ? void 0 : border.toString()) !== null &&
			_d !== void 0
				? _d
				: 'none';
	}
	...
	beforeRender() {
		...
		this._label.innerText = localize(
			...
			(_a = this._keybindingService.lookupKeybinding(accept)) === null || _a === void 0
				? void 0
				: _a.getLabel(),
			(_b = this._keybindingService.lookupKeybinding(preview)) === null || _b === void 0
				? void 0
				: _b.getLabel()
		);
		return null;
	...
	acceptInput(wantsPreview) {
		var _a;
		(_a = this._currentAcceptInput) === null || _a === void 0
			? void 0
			: _a.call(this, wantsPreview);
	}
	...
	getInput(where, value, selectionStart, selectionEnd, supportPreview, token) {
		...
		return new Promise((resolve) => {
			...
			disposeOnDone.add(
				this._editor.onDidBlurEditorWidget(() => this.cancelInput(!document.hasFocus()))
			);
			this._show();
		}).finally(() => {
