...
export let AbstractGotoSymbolQuickAccessProvider = class AbstractGotoSymbolQuickAccessProvider extends AbstractEditorNavigationQuickAccessProvider {
	...
	doProvideWithEditorSymbols(context, model, picker, token) {
		...
		const updatePickerItems = (positionToEnclose) =>
			__awaiter(this, void 0, void 0, function* () {
				...
				try {
					const query = prepareQuery(
						picker.value.substr(AbstractGotoSymbolQuickAccessProvider.PREFIX.length).trim()
					);
					const items = yield this.doGetSymbolPicks(
						symbolsPromise,
						query,
						undefined,
						picksCts.token
					...
					if (items.length > 0) {
						...
						if (query.original.length > 0) {
							this.provideLabelPick(
								picker,
								localize('noMatchingSymbolResults', 'No matching editor symbols')
							);
						} else {
		...
		updatePickerItems(
			(_a = editor.getSelection()) === null || _a === void 0 ? void 0 : _a.getPosition()
		);
	...
	doGetSymbolPicks(symbolsPromise, query, options, token) {
		...
		return __awaiter(this, void 0, void 0, function* () {
			...
			const filterBySymbolKind =
				query.original.indexOf(AbstractGotoSymbolQuickAccessProvider.SCOPE_PREFIX) === 0;
				...
				if (query.original.length > filterPos) {
					...
					if (symbolQuery !== query) {
						[symbolScore, symbolMatches] = scoreFuzzy2(
							symbolLabelWithIcon,
							Object.assign(Object.assign({}, query), {
...
AbstractGotoSymbolQuickAccessProvider = __decorate(
	[__param(0, ILanguageFeaturesService), __param(1, IOutlineModelService)],
