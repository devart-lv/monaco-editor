...
function resolveOptions(trusted, options) {
	return {
		nonBasicASCII:
			options.nonBasicASCII === inUntrustedWorkspace ? !trusted : options.nonBasicASCII,
		ambiguousCharacters: options.ambiguousCharacters,
		invisibleCharacters: options.invisibleCharacters,
		includeComments:
			options.includeComments === inUntrustedWorkspace ? !trusted : options.includeComments,
		includeStrings:
			options.includeStrings === inUntrustedWorkspace ? !trusted : options.includeStrings,
...
export let UnicodeHighlighterHoverParticipant = class UnicodeHighlighterHoverParticipant {
	...
	computeSync(anchor, lineDecorations) {
		...
		for (const d of lineDecorations) {
			...
			const uri = `command:${ShowExcludeOptions.ID}?${encodeURIComponent(
				JSON.stringify(adjustSettingsArgs)
			)}`;
...
UnicodeHighlighterHoverParticipant = __decorate(
	[__param(1, ILanguageService), __param(2, IOpenerService)],
	...
	run(accessor, editor, args) {
		return __awaiter(this, void 0, void 0, function* () {
			const configurationService =
				accessor === null || accessor === void 0 ? void 0 : accessor.get(IConfigurationService);
...
DisableHighlightingOfAmbiguousCharactersAction.ID =
...
DisableHighlightingOfInvisibleCharactersAction.ID =
...
DisableHighlightingOfNonBasicAsciiCharactersAction.ID =
...
function excludeLocaleFromBeingHighlighted(configurationService, locales) {
	...
	return __awaiter(this, void 0, void 0, function* () {
		const existingValue =
			(_a = configurationService.inspect(unicodeHighlightConfigKeys.allowedLocales).user) ===
				null || _a === void 0
				? void 0
				: _a.value;
		let value;
...
registerEditorContribution(
	...
	UnicodeHighlighter,
	1 /* EditorContributionInstantiation.AfterFirstRender */
);
