...
export const CONTEXT_ONTYPE_RENAME_INPUT_VISIBLE = new RawContextKey(
...
export let LinkedEditingContribution = class LinkedEditingContribution extends Disposable {
	...
	constructor(
		...
		this._register(
			this._editor.onDidChangeConfiguration((e) => {
				if (
					e.hasChanged(67 /* EditorOption.linkedEditing */) ||
					e.hasChanged(88 /* EditorOption.renameOnType */)
				) {
	...
	reinitialize(forceRefresh) {
		...
		const isEnabled =
			model !== null &&
			(this._editor.getOption(67 /* EditorOption.linkedEditing */) ||
				this._editor.getOption(88 /* EditorOption.renameOnType */)) &&
		...
		const triggerRangeUpdate = () => {
			...
			this._rangeUpdateTriggerPromise = rangeUpdateScheduler.trigger(
				() => this.updateRanges(),
				(_a = this._debounceDuration) !== null && _a !== void 0
					? _a
				...
				__awaiter(this, void 0, void 0, function* () {
					try {
						...
						this._currentWordPattern =
							(response === null || response === void 0 ? void 0 : response.wordPattern) ||
...
function getLinkedEditingRanges(providers, model, position, token) {
	...
	return first(
		...
		(result) =>
			!!result &&
			arrays.isNonEmptyArray(result === null || result === void 0 ? void 0 : result.ranges)
	);
}
