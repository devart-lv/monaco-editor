...
class SetSelectionAnchor extends EditorAction {
		...
		super({
			...
			kbOpts: {
				...
				primary: KeyChord(
					...
					2048 /* KeyMod.CtrlCmd */ | 32 /* KeyCode.KeyB */
				),
	...
	run(_accessor, editor) {
		...
		return __awaiter(this, void 0, void 0, function* () {
			(_a = SelectionAnchorController.get(editor)) === null || _a === void 0
				? void 0
				: _a.setSelectionAnchor();
		});
	}
}
