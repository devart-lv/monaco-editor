...
export let CodeActionController = class CodeActionController extends Disposable {
	...
	constructor(
		...
		this._ui = new Lazy(() =>
			this._register(
				_instantiationService.createInstance(CodeActionUi, editor, {
					applyCodeAction: (action, retrigger, preview) =>
	...
	showCodeActions(_trigger, actions, at) {
		return this._ui.value.showCodeActionList(actions, at, {
	...
	manualTriggerAtCurrentPosition(notAvailableMessage, triggerAction, filter, autoApply) {
		...
		(_a = MessageController.get(this._editor)) === null || _a === void 0
			? void 0
			: _a.closeMessage();
