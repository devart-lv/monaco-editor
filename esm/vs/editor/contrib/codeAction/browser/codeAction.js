...
class ManagedCodeActionSet extends Disposable {
	...
	get hasAutoFix() {
		return this.validActions.some(
			({ action: fix }) =>
				!!fix.kind &&
				CodeActionKind.QuickFix.contains(new CodeActionKind(fix.kind)) &&
				!!fix.isPreferred
		);
	}
}
			...
			__awaiter(this, void 0, void 0, function* () {
				try {
					...
					const filteredActions = (
						(providedCodeActions === null || providedCodeActions === void 0
							? void 0
							: providedCodeActions.actions) || []
	...
	if (model && actionsToShow.length) {
		for (const provider of registry.all(model)) {
			if (provider._getAdditionalMenuItems) {
				yield* (_a = provider._getAdditionalMenuItems) === null || _a === void 0
					? void 0
					: _a.call(
							provider,
							{
								trigger: trigger.type,
								only:
									(_c = (_b = trigger.filter) === null || _b === void 0 ? void 0 : _b.include) ===
										null || _c === void 0
										? void 0
										: _c.value
							},
...
export function applyCodeAction(
	...
	return __awaiter(this, void 0, void 0, function* () {
		...
		if (item.action.command) {
			try {
				yield commandService.executeCommand(
...
CommandsRegistry.registerCommand(
	...
	function (accessor, resource, rangeOrSelection, kind, itemResolveCount) {
		return __awaiter(this, void 0, void 0, function* () {
