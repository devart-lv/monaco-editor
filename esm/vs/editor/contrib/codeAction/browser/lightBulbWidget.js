...
export let LightBulbWidget = class LightBulbWidget extends Disposable {
	constructor(_editor, keybindingService) {
		...
		this._register(
			this._editor.onDidChangeModelContent((_) => {
				...
				if (
					this.state.type !== 1 /* LightBulbState.Type.Showing */ ||
					!editorModel ||
		...
		this._register(
			this._editor.onDidChangeConfiguration((e) => {
				...
				if (
					e.hasChanged(62 /* EditorOption.lightbulb */) &&
					!this._editor.getOption(62 /* EditorOption.lightbulb */).enabled
				) {
					this.hide();
				}
			})
		...
		this._register(
			Event.runAndSubscribe(keybindingService.onDidUpdateKeybindings, () => {
				var _a, _b;
				this._preferredKbLabel = withNullAsUndefined(
					(_a = keybindingService.lookupKeybinding(autoFixCommandId)) === null || _a === void 0
						? void 0
						: _a.getLabel()
				);
				this._quickFixKbLabel = withNullAsUndefined(
					(_b = keybindingService.lookupKeybinding(quickFixCommandId)) === null || _b === void 0
						? void 0
						: _b.getLabel()
				);
	...
	getPosition() {
		return this._state.type === 1 /* LightBulbState.Type.Showing */
...
LightBulbWidget = __decorate([__param(1, IKeybindingService)], LightBulbWidget);
