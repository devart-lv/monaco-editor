...
export let CodeActionUi = class CodeActionUi extends Disposable {
	constructor(
		...
		this._lightBulbWidget = new Lazy(() => {
			...
			if (widget) {
				this._register(
					widget.onClick((e) =>
						this.showCodeActionList(e.actions, e, {
	...
	update(newState) {
		...
		return __awaiter(this, void 0, void 0, function* () {
			...
			(_b = this._lightBulbWidget.value) === null || _b === void 0
				? void 0
				: _b.update(actions, newState.trigger, newState.position);
				...
				if ((_c = newState.trigger.filter) === null || _c === void 0 ? void 0 : _c.include) {
					...
					if (newState.trigger.context) {
						...
						if (invalidAction && invalidAction.action.disabled) {
							(_e = MessageController.get(this._editor)) === null || _e === void 0
								? void 0
								: _e.showMessage(invalidAction.action.disabled, newState.trigger.context.position);
							actions.dispose();
							return;
						}
					}
				}
				const includeDisabledActions = !!((_f = newState.trigger.filter) === null || _f === void 0
					? void 0
					: _f.include);
				if (newState.trigger.context) {
					if (
						...
						(_g = MessageController.get(this._editor)) === null || _g === void 0
							? void 0
							: _g.showMessage(
	...
	getInvalidActionThatWouldHaveBeenApplied(trigger, actions) {
		...
		if (
			(trigger.autoApply === 'first' /* CodeActionAutoApply.First */ &&
				actions.validActions.length === 0) ||
			(trigger.autoApply === 'ifSingle' /* CodeActionAutoApply.IfSingle */ &&
