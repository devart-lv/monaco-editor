...
export class ColorHover {
	...
	isValidForHoverAnchor(anchor) {
		return (
			anchor.type === 1 /* HoverAnchorType.Range */ &&
	...
	_computeAsync(_anchor, lineDecorations, _token) {
		return __awaiter(this, void 0, void 0, function* () {
			...
			for (const d of lineDecorations) {
				...
				if (colorData) {
					const colorHover = yield _createColorHover(
						this,
...
export let StandaloneColorPickerParticipant = class StandaloneColorPickerParticipant {
	...
	createColorHover(defaultColorInfo, defaultColorProvider, colorProviderRegistry) {
		return __awaiter(this, void 0, void 0, function* () {
			...
			const colorInfo =
				foundColorInfo !== null && foundColorInfo !== void 0 ? foundColorInfo : defaultColorInfo;
			const colorProvider =
				foundColorProvider !== null && foundColorProvider !== void 0
					? foundColorProvider
					: defaultColorProvider;
			const foundInEditor = !!foundColorInfo;
			return {
				colorHover: yield _createColorHover(
					this,
					this._editor.getModel(),
					colorInfo,
					colorProvider
	...
	updateEditorModel(colorHoverData) {
		return __awaiter(this, void 0, void 0, function* () {
			...
			if (this._color) {
				yield _updateColorPresentations(
					this._editor.getModel(),
					colorPickerModel,
					this._color,
					range,
...
function _createColorHover(participant, editorModel, colorInfo, provider) {
	return __awaiter(this, void 0, void 0, function* () {
		...
		const colorPresentations = yield getColorPresentations(
			editorModel,
			colorInfo,
			provider,
			CancellationToken.None
...
function renderHoverParts(participant, editor, themeService, hoverParts, context) {
	...
	const widget = disposables.add(
		new ColorPickerWidget(
			context.fragment,
			model,
			editor.getOption(137 /* EditorOption.pixelRatio */),
			themeService,
...
function _updateEditorModel(editor, range, model, context) {
	...
	if (model.presentation.textEdit) {
		...
		const trackedRange = editor
			.getModel()
			._setTrackedRange(null, newRange, 3 /* TrackedRangeStickiness.GrowsOnlyWhenTypingAfter */);
		editor.pushUndoStop();
