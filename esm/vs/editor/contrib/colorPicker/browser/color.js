...
class ColorPresentationsCollector {
	...
	compute(provider, model, _token, colors) {
		return __awaiter(this, void 0, void 0, function* () {
			const documentColors = yield provider.provideColorPresentations(
				model,
				this.colorInfo,
	...
	return __awaiter(this, void 0, void 0, function* () {
		...
		for (let i = documentColorProviders.length - 1; i >= 0; i--) {
			...
			if (provider instanceof DefaultDocumentColorProvider) {
				...
				try {
					validDocumentColorProviderFound ||
						(validDocumentColorProviderFound = yield collector.compute(
							provider,
							model,
							token,
							colorData
...
CommandsRegistry.registerCommand('_executeDocumentColorProvider', function (accessor, ...args) {
	...
	const { model, colorProviderRegistry, isDefaultColorDecoratorsEnabled } = _setupColorCommand(
		accessor,
		resource
	);
	return _findColorData(
