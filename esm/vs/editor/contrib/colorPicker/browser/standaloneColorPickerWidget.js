...
export let StandaloneColorPickerWidget = class StandaloneColorPickerWidget extends Disposable {
	constructor(
		...
		this._position =
			(_a = this._editor._getViewModel()) === null || _a === void 0
				? void 0
				: _a.getPrimaryCursorState().viewState.position;
	...
	_start(selection) {
		return __awaiter(this, void 0, void 0, function* () {
			...
			this._onResult.fire(
				new StandaloneColorPickerResult(computeAsyncResult.result, computeAsyncResult.foundInEditor)
			);
		});
	}
	_computeAsync(range) {
		return __awaiter(this, void 0, void 0, function* () {
			...
			const colorHoverResult = yield this._standaloneColorPickerParticipant.createColorHover(
				colorInfo,
	...
	_render(colorHover, foundInEditor) {
		...
		enterButton === null || enterButton === void 0
			? void 0
