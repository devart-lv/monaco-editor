...
} from '../../../browser/controller/textAreaInput.js';
import {
	EditorAction,
	MultiCommand,
...
MenuRegistry.appendMenuItem(MenuId.EditorContext, {
	...
	title: { value: nls.localize('share', 'Share'), original: 'Share' },
	group: '11_share',
	order: -1,
	...
	target.addImplementation(10000, 'code-editor', (accessor, args) => {
		...
		if (focusedEditor && focusedEditor.hasTextFocus()) {
			...
			const emptySelectionClipboard = focusedEditor.getOption(
				35 /* EditorOption.emptySelectionClipboard */
			);
				...
				return (() =>
					__awaiter(void 0, void 0, void 0, function* () {
						...
						if (clipboardText !== '') {
							...
							if (metadata) {
								pasteOnNewLine =
									focusedEditor.getOption(35 /* EditorOption.emptySelectionClipboard */) &&
