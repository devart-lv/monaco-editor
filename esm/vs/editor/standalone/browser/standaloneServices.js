	...
	prompt(prompt) {
		...
		return __awaiter(this, void 0, void 0, function* () {
			...
			if (confirmed) {
				...
				result = yield (_b = promptButtons[0]) === null || _b === void 0
					? void 0
					: _b.run({ checkboxChecked: false });
			}
			return { result };
		});
	}
...
StandaloneResourceConfigurationService = __decorate(
	[__param(0, IConfigurationService), __param(1, IModelService), __param(2, ILanguageService)],
...
StandaloneContextViewService = __decorate(
	[__param(0, ILayoutService), __param(1, ICodeEditorService)],
