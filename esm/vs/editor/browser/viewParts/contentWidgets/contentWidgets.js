...
export class ViewContentWidgets extends ViewPart {
	constructor(context, viewDomNode) {
		...
		PartFingerprints.write(
			...
			2 /* PartFingerprint.OverflowingContentWidgets */
		);
...
class Widget {
		...
		function getValidPositionPair(position, viewModel, affinity) {
			...
			if (viewModel.coordinatesConverter.modelPositionIsVisible(validModelPosition)) {
				const viewPosition = viewModel.coordinatesConverter.convertModelPositionToViewPosition(
					validModelPosition,
					affinity !== null && affinity !== void 0 ? affinity : undefined
				);
	...
	_getAnchorsCoordinates(ctx) {
		...
		const secondaryViewPosition =
			((_a = this._secondaryAnchor.viewPosition) === null || _a === void 0
				? void 0
				: _a.lineNumber) ===
			((_b = this._primaryAnchor.viewPosition) === null || _b === void 0 ? void 0 : _b.lineNumber)
		...
		function getCoordinates(position, affinity, lineHeight) {
			...
			const left =
				position.column === 1 && affinity === 3 /* PositionAffinity.LeftOfInjectedText */
					? 0
