...
export class ViewLines extends ViewPart {
	...
	onRevealRangeRequest(e) {
		...
		const scrollType =
			scrollTopDelta <= this._lineHeight ? 1 /* ScrollType.Immediate */ : e.scrollType;
	...
	renderText(viewportData) {
		...
		const adjustedScrollTop =
			this._context.viewLayout.getCurrentScrollTop() - viewportData.bigNumbersDelta;
	...
	_computeScrollTopToRevealRange(viewport, source, minimalReveal, range, selections, verticalType) {
		...
		if (!minimalReveal) {
			if (
				verticalType === 0 /* viewEvents.VerticalRevealType.Simple */ ||
		...
		if (boxEndY - boxStartY > viewportHeight) {
			...
			verticalType === 5 /* viewEvents.VerticalRevealType.NearTop */ ||
			...
			verticalType === 1 /* viewEvents.VerticalRevealType.Center */ ||
			...
			newScrollTop = this._computeMinimumScrolling(
				...
				boxStartY,
				boxEndY,
				verticalType === 3 /* viewEvents.VerticalRevealType.Top */,
				verticalType === 4 /* viewEvents.VerticalRevealType.Bottom */
			);
		}
		return newScrollTop;
