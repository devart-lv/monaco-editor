...
const ttPolicy =
	(_a = window.trustedTypes) === null || _a === void 0
		? void 0
		: _a.createPolicy('domLineBreaksComputer', { createHTML: (value) => value });
...
function createLineBreaks(
		...
		if (wrappingIndent !== 0 /* WrappingIndent.None */) {
			...
			if (firstNonWhitespaceIndex === -1) {
				...
				for (let i = 0; i < firstNonWhitespaceIndex; i++) {
					const charWidth =
						lineContent.charCodeAt(i) === 9 /* CharCode.Tab */
	...
	const html = sb.build();
	const trustedhtml =
		(_a = ttPolicy === null || ttPolicy === void 0 ? void 0 : ttPolicy.createHTML(html)) !== null &&
		_a !== void 0
			? _a
			: html;
...
function readClientRect(range, spans, startOffset, endOffset) {
	range.setStart(
		spans[(startOffset / 16384) /* Constants.SPAN_MODULO_LIMIT */ | 0].firstChild,
		startOffset % 16384 /* Constants.SPAN_MODULO_LIMIT */
	);
	range.setEnd(
		spans[(endOffset / 16384) /* Constants.SPAN_MODULO_LIMIT */ | 0].firstChild,
		endOffset % 16384 /* Constants.SPAN_MODULO_LIMIT */
	);
