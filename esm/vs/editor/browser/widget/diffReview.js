...
export let DiffReview = class DiffReview extends Disposable {
			...
			this._configurationService.onDidChangeConfiguration((e) => {
				if (e.affectsConfiguration('accessibility.verbosity.diff-editor')) {
					this._diffEditor.updateOptions({
						accessibilityVerbose: this._configurationService.getValue(
	...
	_goToRow(row, type) {
		...
		if (
			element === null || element === void 0
				? void 0
				: element.classList.contains('line-insert' /* DiffEditorLineClasses.Insert */)
		) {
			this._audioCueService.playAudioCue(AudioCue.diffLineInserted, true);
		} else if (
			element === null || element === void 0
				? void 0
				: element.classList.contains('line-delete' /* DiffEditorLineClasses.Delete */)
		) {
	...
	static _mergeAdjacent(lineChanges, originalLineCount, modifiedLineCount) {
		...
		for (let i = 1, len = diffs.length; i < len; i++) {
			...
			if (
				currLast.getType() === 0 /* DiffEntryType.Equal */ &&
	...
	static _renderLine(model, options, tabSize, lineNumber, languageIdCodec) {
		...
		const r = renderViewLine(
			new RenderLineInput(
				fontInfo.isMonospace && !options.get(31 /* EditorOption.disableMonospaceOptimizations */),
				...
				options.get(112 /* EditorOption.stopRenderingLineAfter */),
				options.get(94 /* EditorOption.renderWhitespace */),
				options.get(89 /* EditorOption.renderControlCharacters */),
				options.get(49 /* EditorOption.fontLigatures */) !== EditorFontLigatures.OFF,
				null
			)
		);
		return r.html;
...
DiffReview._ttPolicy =
	(_a = window.trustedTypes) === null || _a === void 0
		? void 0
		: _a.createPolicy('diffReview', { createHTML: (value) => value });
DiffReview = __decorate(
	[__param(1, ILanguageService), __param(2, IAudioCueService), __param(3, IConfigurationService)],
	DiffReview
);
// theming
