...
export let WorkerBasedDocumentDiffProvider = class WorkerBasedDocumentDiffProvider {
	...
	dispose() {
		var _a;
		(_a = this.diffAlgorithmOnDidChangeSubscription) === null || _a === void 0
			? void 0
			: _a.dispose();
	}
	computeDiff(original, modified, options) {
		...
		return __awaiter(this, void 0, void 0, function* () {
			...
			const result = yield this.editorWorkerService.computeDiff(
				original.uri,
				modified.uri,
				options,
				this.diffAlgorithm
			...
			this.telemetryService.publicLog2('diffEditor.computeDiff', {
				timeMs,
				timedOut:
					(_a = result === null || result === void 0 ? void 0 : result.quitEarly) !== null &&
					_a !== void 0
						? _a
						: true
			});
...
WorkerBasedDocumentDiffProvider = __decorate(
	[__param(1, IEditorWorkerService), __param(2, ITelemetryService)],
