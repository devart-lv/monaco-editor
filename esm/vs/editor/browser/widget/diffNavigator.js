...
export let DiffNavigator = class DiffNavigator extends Disposable {
	...
	_updateAccessibilityState(lineNumber, jumpToChange) {
		...
		const modifiedEditor =
			(_a = this._editor.getModel()) === null || _a === void 0 ? void 0 : _a.modified;
		if (!modifiedEditor) {
			return;
		}
		const insertedOrModified = modifiedEditor
			.getLineDecorations(lineNumber)
			.find((l) => l.options.className === 'line-insert');
...
DiffNavigator = __decorate(
	[__param(2, IAudioCueService), __param(3, ICodeEditorService), __param(4, IAccessibilityService)],
	DiffNavigator
);
