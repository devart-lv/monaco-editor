...
(function (Position2) {
	...
	function is(value) {
		var candidate = value;
		return (
			Is.objectLiteral(candidate) && Is.uinteger(candidate.line) && Is.uinteger(candidate.character)
		);
	}
	Position2.is = is;
})(Position || (Position = {}));
...
(function (FormattingOptions2) {
	...
	function is(value) {
		var candidate = value;
		return (
			Is.defined(candidate) && Is.uinteger(candidate.tabSize) && Is.boolean(candidate.insertSpaces)
		);
	}
		...
		if (Array.isArray(schema.defaultSnippets)) {
			schema.defaultSnippets.forEach(function (s) {
				...
				if (isDefined(value2)) {
					...
					insertText =
						prefix + indent + s.bodyText.split('\n').join('\n' + indent) + suffix + separatorAfter;
				...
				var n = {
					...
					extname: function (t3) {
						...
						for (var r3 = -1, n2 = 0, o = -1, i = true, a2 = 0, h = t3.length - 1; h >= 0; --h) {
							...
							if (47 !== s)
								-1 === o && ((i = false), (o = h + 1)),
									46 === s ? (-1 === r3 ? (r3 = h) : 1 !== a2 && (a2 = 1)) : -1 !== r3 && (a2 = -1);
							else if (!i) {
								n2 = h + 1;
								break;
							}
						}
						return -1 === r3 || -1 === o || 0 === a2 || (1 === a2 && r3 === o - 1 && r3 === n2 + 1)
							? ''
							: t3.slice(r3, o);
					},
					format: function (t3) {
					...
					parse: function (t3) {
						...
						for (var a2 = -1, h = 0, s = -1, c = true, f2 = t3.length - 1, u = 0; f2 >= n2; --f2)
							if (47 !== (o = t3.charCodeAt(f2)))
								-1 === s && ((c = false), (s = f2 + 1)),
									46 === o ? (-1 === a2 ? (a2 = f2) : 1 !== u && (u = 1)) : -1 !== a2 && (u = -1);
							else if (!c) {
								h = f2 + 1;
								break;
							}
						return (
							-1 === a2 || -1 === s || 0 === u || (1 === u && a2 === s - 1 && a2 === h + 1)
								? -1 !== s && (r3.base = r3.name = 0 === h && i ? t3.slice(1, s) : t3.slice(h, s))
								: (0 === h && i
			...
			447: (t2, e2, r2) => {
				...
				function w(t3, e3) {
					var r3 = e3 ? C : b,
						...
						s2 = t3.fragment;
					if (
						(o2 && ((n2 += o2), (n2 += ':')), (i2 || 'file' === o2) && ((n2 += p), (n2 += p)), i2)
					) {
						var c2 = i2.indexOf('@');
						if (-1 !== c2) {
