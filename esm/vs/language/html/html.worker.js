...
var HTMLCompletion = (function () {
			...
			dataProviders.forEach(function (provider) {
				provider.provideAttributes(currentTag).forEach(function (attr) {
					...
					result.items.push({
						label: attr.name,
						kind:
							attr.valueSet === 'handler' ? CompletionItemKind.Function : CompletionItemKind.Value,
	...
	HTMLCompletion2.prototype.doQuoteComplete = function (
		...
		var defaultValue =
			(_a2 = settings === null || settings === void 0 ? void 0 : settings.attributeDefaultValue) !==
				null && _a2 !== void 0
				? _a2
				: 'doublequotes';
		if (defaultValue === 'empty') {
				...
				var n = {
					...
					extname: function (t3) {
						...
						for (var r3 = -1, n2 = 0, o = -1, i = true, a = 0, h = t3.length - 1; h >= 0; --h) {
							...
							if (47 !== s)
								-1 === o && ((i = false), (o = h + 1)),
									46 === s ? (-1 === r3 ? (r3 = h) : 1 !== a && (a = 1)) : -1 !== r3 && (a = -1);
							else if (!i) {
								n2 = h + 1;
								break;
							}
						}
						return -1 === r3 || -1 === o || 0 === a || (1 === a && r3 === o - 1 && r3 === n2 + 1)
							? ''
							: t3.slice(r3, o);
					},
					format: function (t3) {
