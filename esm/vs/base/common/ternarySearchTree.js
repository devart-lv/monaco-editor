...
export class PathIterator {
	...
	next() {
		...
		for (; this._to < this._valueLen; this._to++) {
			...
			if (
				ch === 47 /* CharCode.Slash */ ||
				(this._splitOnBackslash && ch === 92) /* CharCode.Backslash */
			) {
				if (justSeps) {
					this._from++;
				} else {
...
export class UriIterator {
	...
	next() {
		if (
			this._states[this._stateIdx] === 3 /* UriIteratorState.Path */ &&
...
class TernarySearchTreeNode {
	...
	get heightLeft() {
		var _a, _b;
		return (_b = (_a = this.left) === null || _a === void 0 ? void 0 : _a.height) !== null &&
			_b !== void 0
			? _b
			: 0;
	}
	get heightRight() {
		var _a, _b;
		return (_b = (_a = this.right) === null || _a === void 0 ? void 0 : _a.height) !== null &&
			_b !== void 0
			? _b
			: 0;
	}
...
export class TernarySearchTree {
	...
	has(key) {
		...
		return !(
			(node === null || node === void 0 ? void 0 : node.value) === undefined &&
			(node === null || node === void 0 ? void 0 : node.mid) === undefined
		);
	}
	delete(key) {
