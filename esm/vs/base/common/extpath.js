...
export function isWindowsDriveLetter(char0) {
	return (
		(char0 >= 65 /* CharCode.A */ && char0 <= 90) /* CharCode.Z */ ||
		(char0 >= 97 /* CharCode.a */ && char0 <= 122) /* CharCode.z */
	);
}
export function hasDriveLetter(path, isWindowsOS = isWindows) {
	if (isWindowsOS) {
		return (
			isWindowsDriveLetter(path.charCodeAt(0)) && path.charCodeAt(1) === 58 /* CharCode.Colon */
		);
	}
	return false;
}
