...
export class Delayer {
	...
	cancel() {
		...
		this.cancelTimeout();
		if (this.completionPromise) {
			(_a = this.doReject) === null || _a === void 0
				? void 0
				: _a.call(this, new CancellationError());
			this.completionPromise = null;
		}
	}
	cancelTimeout() {
...
export class AsyncIterableObject {
						...
						return __awaiter(this, void 0, void 0, function* () {
							...
							try {
								for (
									...
									(iterable_1_1 = yield iterable_1.next()), (_b = iterable_1_1.done), !_b;
	...
	static map(iterable, mapFn) {
		return new AsyncIterableObject((emitter) =>
			__awaiter(this, void 0, void 0, function* () {
				...
				try {
					for (
						var _d = true, iterable_2 = __asyncValues(iterable), iterable_2_1;
						(iterable_2_1 = yield iterable_2.next()), (_a = iterable_2_1.done), !_a;
	...
	static filter(iterable, filterFn) {
		return new AsyncIterableObject((emitter) =>
			__awaiter(this, void 0, void 0, function* () {
				...
				try {
					for (
						var _d = true, iterable_3 = __asyncValues(iterable), iterable_3_1;
						(iterable_3_1 = yield iterable_3.next()), (_a = iterable_3_1.done), !_a;
	...
	static toPromise(iterable) {
		...
		return __awaiter(this, void 0, void 0, function* () {
			...
			try {
				for (
					_a = true, iterable_4 = __asyncValues(iterable);
					(iterable_4_1 = yield iterable_4.next()), (_b = iterable_4_1.done), !_b;
...
export function createCancelableAsyncIterable(callback) {
	...
	return new CancelableAsyncIterableObject(source, (emitter) =>
		__awaiter(this, void 0, void 0, function* () {
			var _a, e_5, _b, _c;
			const subscription = source.token.onCancellationRequested(() => {
				subscription.dispose();
			...
			try {
				try {
					for (
						var _d = true, innerIterable_1 = __asyncValues(innerIterable), innerIterable_1_1;
						(innerIterable_1_1 = yield innerIterable_1.next()), (_a = innerIterable_1_1.done), !_a;
