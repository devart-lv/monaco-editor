...
export class Emitter {
	constructor(options) {
		...
		this._leakageMon =
			...
			((_a = this._options) === null || _a === void 0 ? void 0 : _a.leakWarningThreshold)
				? new LeakageMonitor(
						(_c =
							(_b = this._options) === null || _b === void 0 ? void 0 : _b.leakWarningThreshold) !==
							null && _c !== void 0
							? _c
	...
	dispose() {
		...
		if (!this._disposed) {
			...
			(_c =
				(_b = this._options) === null || _b === void 0 ? void 0 : _b.onDidRemoveLastListener) ===
				null || _c === void 0
				? void 0
				: _c.call(_b);
	...
	get event() {
		if (!this._event) {
			this._event = (callback, thisArgs, disposables) => {
				...
				if (
					firstListener &&
					((_a = this._options) === null || _a === void 0 ? void 0 : _a.onWillAddFirstListener)
				) {
				...
				const result = listener.subscription.set(() => {
					...
					if (!this._disposed) {
						(_b =
							(_a = this._options) === null || _a === void 0 ? void 0 : _a.onWillRemoveListener) ===
							null || _b === void 0
							? void 0
							: _b.call(_a, this);
						removeListener();
