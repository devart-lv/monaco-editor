...
export class IconLabel extends Disposable {
	constructor(container, options) {
		...
		if (
			(options === null || options === void 0 ? void 0 : options.supportHighlights) ||
			(options === null || options === void 0 ? void 0 : options.supportIcons)
		) {
	...
	setLabel(label, description, options) {
		...
		this.setupHover(
			(options === null || options === void 0 ? void 0 : options.descriptionTitle)
				? this.labelContainer
				: this.element,
	...
	getOrCreateDescriptionNode() {
		...
		if (!this.descriptionNode) {
			const descriptionContainer = this._register(
				new FastLabelNode(
					dom.append(this.labelContainer, dom.$('span.monaco-icon-description-container'))
				)
			);
			if (
				(_a = this.creationOptions) === null || _a === void 0
					? void 0
					: _a.supportDescriptionHighlights
			) {
				this.descriptionNode = new HighlightedLabel(
					dom.append(descriptionContainer.element, dom.$('span.label-description')),
