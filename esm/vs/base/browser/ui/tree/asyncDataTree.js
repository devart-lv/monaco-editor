...
class AsyncDataTreeRenderer {
	...
	disposeElement(node, index, templateData, height) {
		...
		(_b = (_a = this.renderer).disposeElement) === null || _b === void 0
			? void 0
			: _b.call(_a, this.nodeMapper.map(node), index, templateData.templateData, height);
	}
...
class AsyncDataTreeNodeListDragAndDrop {
	...
	onDragStart(data, originalEvent) {
		...
		(_b = (_a = this.dnd).onDragStart) === null || _b === void 0
			? void 0
			: _b.call(_a, asAsyncDataTreeDragAndDropData(data), originalEvent);
	}
...
class CompressibleAsyncDataTreeRenderer {
	...
	disposeCompressedElements(node, index, templateData, height) {
		var _a, _b;
		(_b = (_a = this.renderer).disposeCompressedElements) === null || _b === void 0
			? void 0
			: _b.call(
					_a,
					this.compressibleNodeMapperProvider().map(node),
...
export class CompressibleAsyncDataTree extends AsyncDataTree {
	constructor(
		...
		this.compressibleNodeMapper = new WeakMapper(
