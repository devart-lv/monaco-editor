...
class TreeNodeListDragAndDrop {
	...
	onDragStart(data, originalEvent) {
		...
		(_b = (_a = this.dnd).onDragStart) === null || _b === void 0
			? void 0
			: _b.call(_a, asTreeDragAndDropData(data), originalEvent);
	}
...
export class ComposedTreeDelegate {
	...
	setDynamicHeight(element, height) {
		var _a, _b;
		(_b = (_a = this.delegate).setDynamicHeight) === null || _b === void 0
			? void 0
			: _b.call(_a, element.element, height);
	}
}
...
class TreeRenderer {
	constructor(
		...
		(_a = renderer.onDidChangeTwistieState) === null || _a === void 0
			? void 0
			: _a.call(renderer, this.onDidChangeTwistieState, this, this.disposables);
	}
	...
	disposeElement(node, index, templateData, height) {
		...
		(_b = (_a = this.renderer).disposeElement) === null || _b === void 0
			? void 0
			: _b.call(_a, node, index, templateData.templateData, height);
...
class FindWidget extends Disposable {
	...
	constructor(container, tree, contextViewProvider, mode, matchType, options) {
		...
		const styles =
			(_a = options === null || options === void 0 ? void 0 : options.styles) !== null &&
			_a !== void 0
				? _a
				: unthemedFindWidgetStyles;
		...
		this.modeToggle = this._register(
			new ModeToggle(
				Object.assign(Object.assign({}, styles.toggleStyles), {
		...
		const onKeyDown = this._register(Event.chain(emitter.event)).map(
		...
		const onGrabKeyDown = this._register(
			Event.chain(this._register(new DomEmitter(this.elements.grab, 'keydown')).event)
		).map((e) => new StandardKeyboardEvent(e)).event;
		this._register(
			onGrabKeyDown((e) => {
				let right;
				let top;
...
class FindController {
	...
	constructor(tree, model, view, filter, contextViewProvider, options = {}) {
		...
		this.disposables = new DisposableStore();
		this._mode =
			(_a = tree.options.defaultFindMode) !== null && _a !== void 0 ? _a : TreeFindMode.Highlight;
		this._matchType =
			(_b = tree.options.defaultFindMatchType) !== null && _b !== void 0
				? _b
	...
	render() {
		...
		if (this.pattern && noMatches) {
			if ((_a = this.tree.options.showNotFoundMessage) !== null && _a !== void 0 ? _a : true) {
				...
				(_c = this.widget) === null || _c === void 0
					? void 0
					: _c.showMessage({ type: 2 /* MessageType.WARNING */ });
			}
		} else {
...
function asTreeMouseEvent(event) {
	...
	if (hasParentWithClass(event.browserEvent.target, 'monaco-tl-twistie', 'monaco-tl-row')) {
		...
		hasParentWithClass(event.browserEvent.target, 'monaco-tree-type-filter', 'monaco-list')
	) {
...
class Trait {
	...
	set(nodes, browserEvent) {
		if (
			!(browserEvent === null || browserEvent === void 0 ? void 0 : browserEvent.__forceEvent) &&
			equals(this.nodes, nodes)
		) {
			return;
		}
	...
	onDidModelSplice({ insertedNodes, deletedNodes }) {
		...
		const deletedNodesVisitor = (node) =>
...
class TreeNodeListMouseController extends MouseController {
	...
	onViewPointer(e) {
		if (
			isButton(e.browserEvent.target) ||
...
export class AbstractTree {
	...
	get findMode() {
		var _a, _b;
		return (_b = (_a = this.findController) === null || _a === void 0 ? void 0 : _a.mode) !==
			null && _b !== void 0
			? _b
	...
	get findMatchType() {
		var _a, _b;
		return (_b = (_a = this.findController) === null || _a === void 0 ? void 0 : _a.matchType) !==
			null && _b !== void 0
			? _b
			: TreeFindMatchType.Fuzzy;
	}
	...
	constructor(_user, container, delegate, renderers, _options = {}) {
		...
		if (_options.keyboardSupport !== false) {
			...
			onKeyDown
				.filter((e) => e.keyCode === 15 /* KeyCode.LeftArrow */)
				.on(this.onLeftArrow, this, this.disposables);
			onKeyDown
				.filter((e) => e.keyCode === 17 /* KeyCode.RightArrow */)
				.on(this.onRightArrow, this, this.disposables);
			onKeyDown
				.filter((e) => e.keyCode === 10 /* KeyCode.Space */)
				.on(this.onSpace, this, this.disposables);
		}
		if (
			((_a = _options.findWidgetEnabled) !== null && _a !== void 0 ? _a : true) &&
