...
export class InputBox extends Widget {
	constructor(container, contextViewProvider, options) {
		...
		this.tooltip =
			(_a = this.options.tooltip) !== null && _a !== void 0 ? _a : this.placeholder || '';
		...
		if (this.options.flexibleHeight) {
			...
			const onAnchoredSelectionChange = Event.filter(onSelectionChange.event, () => {
				...
				return (
					(selection === null || selection === void 0 ? void 0 : selection.anchorNode) === wrapper
				);
			});
		...
		this.contextViewProvider.showContextView({
			...
			render: (container) => {
				...
				spanElement.style.backgroundColor =
					(_a = styles.background) !== null && _a !== void 0 ? _a : '';
	...
	constructor(container, contextViewProvider, options) {
		...
		const addSuffix = () => {
			if (
				...
				options.showHistoryHint() &&
				!this.placeholder.endsWith(NLS_PLACEHOLDER_HISTORY_HINT_SUFFIX) &&
				...
				const suffix = this.placeholder.endsWith(')')
					? NLS_PLACEHOLDER_HISTORY_HINT_SUFFIX
