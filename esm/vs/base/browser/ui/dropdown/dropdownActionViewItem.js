...
export class DropdownMenuActionViewItem extends BaseActionViewItem {
	...
	render(container) {
		...
		this._register(
			this.dropdownMenu.onDidChangeVisibility((visible) => {
				...
				(_a = this.element) === null || _a === void 0
					? void 0
					: _a.setAttribute('aria-expanded', `${visible}`);
		...
		if (this.options.anchorAlignmentProvider) {
			...
			this.dropdownMenu.menuOptions = Object.assign(
				Object.assign({}, this.dropdownMenu.menuOptions),
				{
					get anchorAlignment() {
	...
	updateEnabled() {
		...
		(_a = this.actionItem) === null || _a === void 0
			? void 0
			: _a.classList.toggle('disabled', disabled);
		(_b = this.element) === null || _b === void 0
			? void 0
			: _b.classList.toggle('disabled', disabled);
	}
}
