...
export class SelectBoxList extends Disposable {
	...
	registerListeners() {
		...
		this._register(
			dom.addDisposableListener(this.selectElement, dom.EventType.KEY_DOWN, (e) => {
				...
				if (isMacintosh) {
					...
					if (
						(event.keyCode === 18 /* KeyCode.DownArrow */ && event.altKey) ||
	...
	layoutSelectDropDown(preLayoutPosition) {
		...
		if (this.selectList) {
			...
			const selectOptimalWidth =
				Math.max(selectMinWidth, Math.round(selectWidth)).toString() + 'px';
	...
	createSelectList(parent) {
		...
		this._register(
			onSelectDropDownKeyDown
				.filter((e) => e.keyCode === 2 /* KeyCode.Tab */)
				.on((e) => this.onEnter(e), this)
		...
		this._register(
			onSelectDropDownKeyDown
				.filter((e) => e.keyCode === 14 /* KeyCode.Home */)
				.on(this.onHome, this)
		);
		this._register(
			onSelectDropDownKeyDown.filter((e) => e.keyCode === 13 /* KeyCode.End */).on(this.onEnd, this)
		);
		this._register(
			onSelectDropDownKeyDown
				.filter(
					(e) =>
						(e.keyCode >= 21 /* KeyCode.Digit0 */ && e.keyCode <= 56) /* KeyCode.KeyZ */ ||
						(e.keyCode >= 85 /* KeyCode.Semicolon */ && e.keyCode <= 113) /* KeyCode.NumpadDivide */
				)
				.on(this.onCharacter, this)
		);
		// SetUp list mouse controller - control navigation, disabled items, focus
		this._register(
			dom.addDisposableListener(this.selectList.getHTMLElement(), dom.EventType.POINTER_UP, (e) =>
				this.onPointerUp(e)
			)
		);
		this._register(
	...
	updateDetail(selectedIndex) {
		...
		const description =
			(_a = option === null || option === void 0 ? void 0 : option.description) !== null &&
			_a !== void 0
				? _a
				: '';
		const descriptionIsMarkdown =
			(_b = option === null || option === void 0 ? void 0 : option.descriptionIsMarkdown) !==
				null && _b !== void 0
				? _b
				: false;
		if (description) {
