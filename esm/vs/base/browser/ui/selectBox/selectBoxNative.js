		...
		this._register(
			dom.addStandardDisposableListener(this.selectElement, 'keydown', (e) => {
				...
				if (isMacintosh) {
					...
					if (
						(e.keyCode === 18 /* KeyCode.DownArrow */ && e.altKey) ||
						e.keyCode === 10 /* KeyCode.Space */ ||
	...
	applyStyles() {
		...
		if (this.selectElement) {
			this.selectElement.style.backgroundColor =
				(_a = this.styles.selectBackground) !== null && _a !== void 0 ? _a : '';
			this.selectElement.style.color =
				(_b = this.styles.selectForeground) !== null && _b !== void 0 ? _b : '';
			this.selectElement.style.borderColor =
				(_c = this.styles.selectBorder) !== null && _c !== void 0 ? _c : '';
		}
	}
