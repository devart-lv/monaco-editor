...
class ListViewAccessibilityProvider {
	constructor(accessibilityProvider) {
		if (
			accessibilityProvider === null || accessibilityProvider === void 0
				? void 0
		...
		if (
			accessibilityProvider === null || accessibilityProvider === void 0
				? void 0
				: accessibilityProvider.getPosInSet
		) {
		...
		if (
			accessibilityProvider === null || accessibilityProvider === void 0
				? void 0
				: accessibilityProvider.isChecked
		) {
...
export class ListView {
	...
	constructor(container, virtualDelegate, renderers, options = DefaultOptions) {
		...
		this._horizontalScrolling =
			(_a = options.horizontalScrolling) !== null && _a !== void 0
				? _a
		...
		const transformOptimization =
			(_b = options.transformOptimization) !== null && _b !== void 0
				? _b
		...
		this.scrollable = new Scrollable({
			...
			smoothScrollDuration: ((_c = options.smoothScrolling) !== null && _c !== void 0 ? _c : false)
				? 125
				: 0,
			...
			new SmoothScrollableElement(
				this.rowsContainer,
				{
					alwaysConsumeMouseWheel:
						(_d = options.alwaysConsumeMouseWheel) !== null && _d !== void 0
							? _d
							: DefaultOptions.alwaysConsumeMouseWheel,
					horizontal: 1 /* ScrollbarVisibility.Auto */,
					vertical:
						(_e = options.verticalScrollMode) !== null && _e !== void 0
							? _e
							: DefaultOptions.verticalScrollMode,
					useShadows:
						(_f = options.useShadows) !== null && _f !== void 0 ? _f : DefaultOptions.useShadows,
		...
		this.disposables.add(
			addDisposableListener(this.rowsContainer, TouchEventType.Change, (e) => this.onTouchChange(e))
		);
		...
		this.setRowLineHeight =
			(_g = options.setRowLineHeight) !== null && _g !== void 0
				? _g
				: DefaultOptions.setRowLineHeight;
		this.setRowHeight =
			(_h = options.setRowHeight) !== null && _h !== void 0 ? _h : DefaultOptions.setRowHeight;
		this.supportDynamicHeights =
			(_j = options.supportDynamicHeights) !== null && _j !== void 0
				? _j
				: DefaultOptions.supportDynamicHeights;
		this.dnd = (_k = options.dnd) !== null && _k !== void 0 ? _k : DefaultOptions.dnd;
		this.layout(
			(_l = options.initialSize) === null || _l === void 0 ? void 0 : _l.height,
			(_m = options.initialSize) === null || _m === void 0 ? void 0 : _m.width
		);
	}
	updateOptions(options) {
		...
		if (options.scrollByPage !== undefined) {
			scrollableOptions = Object.assign(
				Object.assign(
					{},
	...
	onDragStart(element, uri, event) {
		...
		(_b = (_a = this.dnd).onDragStart) === null || _b === void 0
			? void 0
			: _b.call(_a, this.currentDragData, event);
	}
	onDragOver(event) {
		var _a;
		...
		event.browserEvent.dataTransfer.dropEffect =
			typeof result !== 'boolean' && result.effect === 0 /* ListDragOverEffect.Copy */
				? 'copy'
				: 'move';
		let feedback;
		...
		if (feedback[0] === -1) {
			...
			for (const index of feedback) {
				...
				(_a = item.row) === null || _a === void 0
					? void 0
					: _a.domNode.classList.add('drop-target');
			}
			this.currentDragFeedbackDisposable = toDisposable(() => {
				var _a;
				for (const index of feedback) {
					...
					(_a = item.row) === null || _a === void 0
						? void 0
						: _a.domNode.classList.remove('drop-target');
				}
			});
		}
		return true;
	...
	onDragLeave(event) {
		...
		if (this.currentDragData) {
			(_b = (_a = this.dnd).onDragLeave) === null || _b === void 0
				? void 0
				: _b.call(_a, this.currentDragData, event.element, event.index, event.browserEvent);
		}
	}
	onDrop(event) {
		if (!this.canDrop) {
	...
	probeDynamicHeight(index) {
		...
		(_a = renderer.disposeElement) === null || _a === void 0
			? void 0
			: _a.call(renderer, item.element, index, row.templateData, undefined);
		(_c = (_b = this.virtualDelegate).setDynamicHeight) === null || _c === void 0
			? void 0
			: _c.call(_b, item.element, item.size);
		item.lastDynamicHeightWidth = this.renderWidth;
			...
			for (const item of this.items) {
				if (item.row) {
					...
					if (renderer) {
						(_a = renderer.disposeElement) === null || _a === void 0
							? void 0
							: _a.call(renderer, item.element, -1, item.row.templateData, undefined);
