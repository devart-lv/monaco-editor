...
export class ListService {
	...
	setLastFocusedList(widget) {
		...
		(_a = this._lastFocusedWidget) === null || _a === void 0
			? void 0
			: _a.getHTMLElement().classList.remove('last-focused');
		this._lastFocusedWidget = widget;
		(_b = this._lastFocusedWidget) === null || _b === void 0
			? void 0
			: _b.getHTMLElement().classList.add('last-focused');
	}
...
export const WorkbenchListSupportsMultiSelectContextKey = new RawContextKey(
...
function toWorkbenchListOptions(accessor, options) {
	...
	const result = Object.assign(Object.assign({}, options), {
		...
		multipleSelectionController:
			(_a = options.multipleSelectionController) !== null && _a !== void 0
				? _a
...
export let WorkbenchList = class WorkbenchList extends List {
	constructor(
		...
		super(
			...
			delegate,
			renderers,
			Object.assign(Object.assign({ keyboardSupport: false }, workbenchListOptions), {
				horizontalScrolling
			})
		);
		...
		this.navigator = new ListResourceNavigator(
			this,
			Object.assign({ configurationService }, options)
		);
...
export let WorkbenchTable = class WorkbenchTable extends Table {
	constructor(
		...
		this.navigator = new TableResourceNavigator(
			this,
			Object.assign({ configurationService }, options)
		);
		this.disposables.add(this.navigator);
...
class ResourceNavigator extends Disposable {
	constructor(widget, options) {
		...
		if (
			typeof (options === null || options === void 0 ? void 0 : options.openOnSingleClick) !==
				'boolean' &&
			...
			this.openOnSingleClick =
				(_a = options === null || options === void 0 ? void 0 : options.openOnSingleClick) !==
					null && _a !== void 0
					? _a
					: true;
		}
...
function createKeyboardNavigationEventFilter(keybindingService) {
	...
	return (event) => {
		...
		if (
			(result === null || result === void 0 ? void 0 : result.kind) ===
			1 /* ResultKind.MoreChordsNeeded */
		) {
			inMultiChord = true;
			return false;
		}
...
function workbenchTreeDataPreamble(accessor, options) {
	...
	const horizontalScrolling =
		options.horizontalScrolling !== undefined
			? options.horizontalScrolling
			: Boolean(configurationService.getValue(horizontalScrollingKey));
	const [workbenchListOptions, disposable] = instantiationService.invokeFunction(
		...
		options: Object.assign(
			...
			),
			{
				...
				expandOnlyOnTwistieClick:
					(_a = options.expandOnlyOnTwistieClick) !== null && _a !== void 0
						? _a
						: configurationService.getValue(treeExpandMode) === 'doubleClick',
...
let WorkbenchTreeInternals = class WorkbenchTreeInternals {
	...
	constructor(
		...
		this.listSupportFindWidget.set(
			(_a = options.findWidgetEnabled) !== null && _a !== void 0 ? _a : true
		);
		...
		this.navigator = new TreeResourceNavigator(
			tree,
			Object.assign({ configurationService }, options)
		);
...
WorkbenchTreeInternals = __decorate(
	[__param(4, IContextKeyService), __param(5, IListService), __param(6, IConfigurationService)],
