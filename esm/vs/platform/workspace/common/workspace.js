...
export function isSingleFolderWorkspaceIdentifier(obj) {
	...
	return (
		typeof (singleFolderIdentifier === null || singleFolderIdentifier === void 0
			? void 0
			: singleFolderIdentifier.id) === 'string' && URI.isUri(singleFolderIdentifier.uri)
	);
}
export function isEmptyWorkspaceIdentifier(obj) {
	const emptyWorkspaceIdentifier = obj;
	return (
		typeof (emptyWorkspaceIdentifier === null || emptyWorkspaceIdentifier === void 0
			? void 0
			: emptyWorkspaceIdentifier.id) === 'string' &&
...
export function isWorkspaceIdentifier(obj) {
	...
	return (
		typeof (workspaceIdentifier === null || workspaceIdentifier === void 0
			? void 0
			: workspaceIdentifier.id) === 'string' && URI.isUri(workspaceIdentifier.configPath)
	);
}
