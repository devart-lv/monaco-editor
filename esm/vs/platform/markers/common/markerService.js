...
class DoubleResourceMap {
	...
	values(key) {
		...
		if (typeof key === 'string') {
			return (_b =
				(_a = this._byOwner.get(key)) === null || _a === void 0 ? void 0 : _a.values()) !== null &&
				_b !== void 0
				? _b
				: Iterable.empty();
		}
		if (URI.isUri(key)) {
			return (_d =
				(_c = this._byResource.get(key)) === null || _c === void 0 ? void 0 : _c.values()) !==
				null && _d !== void 0
				? _d
				: Iterable.empty();
		}
...
export class MarkerService {
	...
	read(filter = Object.create(null)) {
		...
		if (owner && resource) {
			...
			const iterable = this._data.values(
				resource !== null && resource !== void 0 ? resource : owner
			);
			const result = [];
