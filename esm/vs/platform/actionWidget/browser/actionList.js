...
class HeaderRenderer {
	...
	renderElement(element, _index, templateData) {
		...
		templateData.text.textContent =
			(_b = (_a = element.group) === null || _a === void 0 ? void 0 : _a.title) !== null &&
			_b !== void 0
				? _b
				: '';
	}
...
let ActionItemRenderer = class ActionItemRenderer {
	...
	renderElement(element, _index, data) {
		...
		const actionTitle =
			(_b = this._keybindingService.lookupKeybinding(acceptSelectedActionCommand)) === null ||
			_b === void 0
				? void 0
				: _b.getLabel();
		const previewTitle =
			(_c = this._keybindingService.lookupKeybinding(previewSelectedActionCommand)) === null ||
			_c === void 0
				? void 0
				: _c.getLabel();
...
export let ActionList = class ActionList extends Disposable {
	constructor(user, preview, items, _delegate, _contextViewService, _keybindingService) {
		...
		const virtualDelegate = {
			getHeight: (element) =>
				element.kind === 'header' /* ActionListItemKind.Header */
			...
			new List(
				...
				[new ActionItemRenderer(preview, this._keybindingService), new HeaderRenderer()],
				{
					...
					accessibilityProvider: {
						getAriaLabel: (element) => {
							if (element.kind === 'action' /* ActionListItemKind.Action */) {
								let label = element.label
									? stripNewlines(element === null || element === void 0 ? void 0 : element.label)
									: '';
								if (element.disabled) {
									label = localize(
										{
						...
						getRole: (e) =>
							e.kind === 'action' /* ActionListItemKind.Action */ ? 'option' : 'separator',
...
ActionList = __decorate(
	[__param(4, IContextViewService), __param(5, IKeybindingService)],
	ActionList
);
