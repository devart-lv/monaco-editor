...
export class AbstractStorageService extends Disposable {
	...
	get(key, scope, fallbackValue) {
		var _a;
		return (_a = this.getStorage(scope)) === null || _a === void 0
			? void 0
			: _a.get(key, fallbackValue);
	}
	getBoolean(key, scope, fallbackValue) {
		var _a;
		return (_a = this.getStorage(scope)) === null || _a === void 0
			? void 0
			: _a.getBoolean(key, fallbackValue);
	}
	getNumber(key, scope, fallbackValue) {
		var _a;
		return (_a = this.getStorage(scope)) === null || _a === void 0
			? void 0
			: _a.getNumber(key, fallbackValue);
	}
	...
	updateKeyTarget(key, scope, target) {
		...
		if (typeof target === 'number') {
			if (keyTargets[key] !== target) {
				...
				(_a = this.getStorage(scope)) === null || _a === void 0
					? void 0
					: _a.set(TARGET_KEY, JSON.stringify(keyTargets));
			}
		}
		// Remove
		else {
			if (typeof keyTargets[key] === 'number') {
				...
				(_b = this.getStorage(scope)) === null || _b === void 0
					? void 0
					: _b.set(TARGET_KEY, JSON.stringify(keyTargets));
			}
		}
	}
	...
	constructor() {
		...
		this._register(
			this.workspaceStorage.onDidChangeStorage((key) =>
				this.emitDidChangeValue(1 /* StorageScope.WORKSPACE */, key)
			)
		);
		this._register(
			this.profileStorage.onDidChangeStorage((key) =>
				this.emitDidChangeValue(0 /* StorageScope.PROFILE */, key)
			)
		);
		this._register(
