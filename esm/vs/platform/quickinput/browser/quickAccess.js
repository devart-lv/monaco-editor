...
export let QuickAccessController = class QuickAccessController extends Disposable {
	...
	doShowOrPick(value, pick, options) {
		...
		const visibleDescriptor =
			visibleQuickAccess === null || visibleQuickAccess === void 0
				? void 0
				: visibleQuickAccess.descriptor;
		...
		if (descriptor && !(options === null || options === void 0 ? void 0 : options.preserveValue)) {
			...
			if (!newValue) {
				const defaultFilterValue =
					provider === null || provider === void 0 ? void 0 : provider.defaultFilterValue;
		...
		picker.placeholder =
			descriptor === null || descriptor === void 0 ? void 0 : descriptor.placeholder;
		picker.quickNavigate =
			options === null || options === void 0 ? void 0 : options.quickNavigateConfiguration;
		picker.hideInput = !!picker.quickNavigate && !visibleQuickAccess; // only hide input if there was no picker opened already
		if (
			typeof (options === null || options === void 0 ? void 0 : options.itemActivation) ===
				'number' ||
			(options === null || options === void 0 ? void 0 : options.quickNavigateConfiguration)
		) {
			picker.itemActivation =
				(_a = options === null || options === void 0 ? void 0 : options.itemActivation) !== null &&
				_a !== void 0
					? _a
					: ItemActivation.SECOND /* quick nav is always second */;
		}
		picker.contextKey =
			descriptor === null || descriptor === void 0 ? void 0 : descriptor.contextKey;
		...
		disposables.add(
			this.registerPickerListeners(
				...
				descriptor,
				value,
				options === null || options === void 0 ? void 0 : options.providerOptions
			)
		);
		...
		once(picker.onDidHide)(() => {
			...
			pickPromise === null || pickPromise === void 0
				? void 0
	...
	adjustValueSelection(picker, descriptor, options) {
		...
		// Otherwise: select the value up until the prefix
			...
			valueSelection = [
				(_a = descriptor === null || descriptor === void 0 ? void 0 : descriptor.prefix.length) !==
					null && _a !== void 0
					? _a
					: 0,
				picker.value.length
