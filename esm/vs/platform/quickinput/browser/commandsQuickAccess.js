		...
		return __awaiter(this, void 0, void 0, function* () {
			...
			for (let i = 0; i < filteredCommandPicks.length; i++) {
				...
				if (
					...
					((_a = this.options.suggestedCommandIds) === null || _a === void 0
						? void 0
						: _a.has(commandPick.commandId))
				) {
					commandPicks.push({
						type: 'separator',
				...
				if (
					addOtherSeparator &&
					!this.commandsHistory.peek(commandPick.commandId) &&
					!((_b = this.options.suggestedCommandIds) === null || _b === void 0
						? void 0
						: _b.has(commandPick.commandId))
				) {
					commandPicks.push({
						type: 'separator',
			...
			return {
				...
				additionalPicks: (() =>
					__awaiter(this, void 0, void 0, function* () {
						const additionalCommandPicks = yield this.getAdditionalCommandPicks(
							allCommandPicks,
						...
						return additionalCommandPicks.map((commandPick) =>
			...
			accept: () =>
				__awaiter(this, void 0, void 0, function* () {
					...
					this.telemetryService.publicLog2('workbenchActionExecuted', {
						...
						from:
							(_a = runOptions === null || runOptions === void 0 ? void 0 : runOptions.from) !==
								null && _a !== void 0
								? _a
								: 'quick open'
					});
...
AbstractCommandsQuickAccessProvider.WORD_FILTER = or(
	matchesPrefix,
	matchesWords,
	matchesContiguousSubString
);
...
export let CommandsHistory = class CommandsHistory extends Disposable {
	...
	registerListeners() {
		this._register(
			this.configurationService.onDidChangeConfiguration((e) => this.updateConfiguration(e))
		);
	}
	...
	static getConfiguredCommandHistoryLength(configurationService) {
		...
		const configuredCommandHistoryLength =
			(_b = (_a = config.workbench) === null || _a === void 0 ? void 0 : _a.commandPalette) ===
				null || _b === void 0
				? void 0
				: _b.history;
...
CommandsHistory = __decorate(
	[__param(0, IStorageService), __param(1, IConfigurationService)],
	CommandsHistory
);
