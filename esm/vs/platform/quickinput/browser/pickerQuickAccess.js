	...
	provide(picker, token, runOptions) {
		...
		const updatePickerItems = () =>
			__awaiter(this, void 0, void 0, function* () {
				...
				const applyPicks = (picks, skipEmpty) => {
					...
					if (items.length === 0) {
						...
						if (
							...
							((_a = this.options) === null || _a === void 0 ? void 0 : _a.noResultsPick)
						) {
				...
				const applyFastAndSlowPicks = (fastAndSlowPicks) =>
					__awaiter(this, void 0, void 0, function* () {
			...
			picker.onDidTriggerItemButton(({ button, item }) =>
				__awaiter(this, void 0, void 0, function* () {
					...
					if (typeof item.trigger === 'function') {
						const buttonIndex =
							(_c = (_b = item.buttons) === null || _b === void 0 ? void 0 : _b.indexOf(button)) !==
								null && _c !== void 0
								? _c
								: -1;
						if (buttonIndex >= 0) {
