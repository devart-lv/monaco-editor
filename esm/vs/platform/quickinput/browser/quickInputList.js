		...
		if (buttons && buttons.length) {
			data.actionBar.push(
				buttons.map((button, index) => {
					let cssClasses =
						button.iconClass || (button.iconPath ? getIconClass(button.iconPath) : undefined);
...
export class QuickInputList {
				...
				__awaiter(this, void 0, void 0, function* () {
					...
					if (
						...
						dom.isAncestor(
							...
							(_a = e.element) === null || _a === void 0 ? void 0 : _a.element
						)
					) {
						return;
					}
					try {
						yield delayer.trigger(() =>
							__awaiter(this, void 0, void 0, function* () {
								if (e.element) {
	...
	setElements(inputElements) {
		...
		this.elements = inputElements.reduce((result, item, index) => {
			...
			if (item.type !== 'separator') {
				...
				descriptionHighlights =
					(_b = item.highlights) === null || _b === void 0 ? void 0 : _b.description;
	...
	focus(what) {
		...
		switch (what) {
			...
			case QuickInputListFocus.Next: {
				...
				if (
					index !== 0 &&
					!this.elements[index - 1].item &&
					this.list.firstVisibleIndex > index - 1
				) {
	...
	showHover(element) {
		...
		if (this._lastHover && !this._lastHover.isDisposed) {
			(_b = (_a = this.options.hoverDelegate).onDidHideHover) === null || _b === void 0
				? void 0
				: _b.call(_a);
			...
			this.elements.forEach((element) => {
				...
				if (this.matchOnLabelMode === 'fuzzy') {
					labelHighlights = this.matchOnLabel
						? withNullAsUndefined(
								matchesFuzzyIconAware(query, parseLabelWithIcons(element.saneLabel))
						  )
						: undefined;
				} else {
					labelHighlights = this.matchOnLabel
				...
				const metaHighlights = this.matchOnMeta
					? withNullAsUndefined(
							matchesFuzzyIconAware(query, parseLabelWithIcons(element.saneMeta || ''))
					  )
					: undefined;
				...
				if (!this.sortByLabel) {
					const previous = element.index && this.inputElements[element.index - 1];
					currentSeparator =
						previous && previous.type === 'separator' ? previous : currentSeparator;
