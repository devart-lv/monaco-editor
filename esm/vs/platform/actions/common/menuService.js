...
export let MenuService = class MenuService {
	...
	createMenu(id, contextKeyService, options) {
		return new MenuImpl(
			id,
			this._hiddenStates,
			Object.assign({ emitEventsForSubmenuChanges: false, eventDebounceDelay: 50 }, options),
...
let PersistedMenuHideState = class PersistedMenuHideState {
	constructor(_storageService) {
		...
		this._disposables.add(
			_storageService.onDidChangeValue((e) => {
	...
	_isHiddenByDefault(menu, commandId) {
		var _a;
		return (_a = this._hiddenByDefaultCache.get(`${menu.id}/${commandId}`)) !== null &&
			_a !== void 0
			? _a
			: false;
	}
	...
	isHidden(menu, commandId) {
		...
		const state =
			(_b =
				(_a = this._data[menu.id]) === null || _a === void 0 ? void 0 : _a.includes(commandId)) !==
				null && _b !== void 0
				? _b
				: false;
...
MenuInfo = __decorate([__param(3, ICommandService), __param(4, IContextKeyService)], MenuInfo);
