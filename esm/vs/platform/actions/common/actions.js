...
export let MenuItemAction = class MenuItemAction {
	static label(action, options) {
		return (options === null || options === void 0 ? void 0 : options.renderShortTitle) &&
			action.shortTitle
	...
	constructor(item, alt, options, hideActions, contextKeyService, _commandService) {
		...
		this.tooltip =
			(_b =
				typeof item.tooltip === 'string'
					? item.tooltip
					: (_a = item.tooltip) === null || _a === void 0
					? void 0
		...
		if (item.toggled) {
			...
			if (this.checked && toggled.tooltip) {
				this.tooltip =
					typeof toggled.tooltip === 'string' ? toggled.tooltip : toggled.tooltip.value;
			}
		...
		this.item = item;
		this.alt = alt
			? new MenuItemAction(alt, undefined, options, hideActions, contextKeyService, _commandService)
			: undefined;
...
MenuItemAction = __decorate(
	[__param(4, IContextKeyService), __param(5, ICommandService)],
	MenuItemAction
);
...
export function registerAction2(ctor) {
	...
	const _a = action.desc,
		{ f1, menu, keybinding, description } = _a,
		command = __rest(_a, ['f1', 'menu', 'keybinding', 'description']);
	// command
	disposables.add(
	...
	if (f1) {
		disposables.add(
			MenuRegistry.appendMenuItem(MenuId.CommandPalette, { command, when: command.precondition })
		);
	...
	if (Array.isArray(keybinding)) {
		...
		disposables.add(
			KeybindingsRegistry.registerKeybindingRule(
				Object.assign(Object.assign({}, keybinding), {
					id: command.id,
					when: command.precondition
