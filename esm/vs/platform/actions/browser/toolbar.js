...
export let WorkbenchToolBar = class WorkbenchToolBar extends ToolBar {
				...
				Object.assign(
					{
						...
						getKeyBinding: (action) => {
							var _a;
							return (_a = keybindingService.lookupKeybinding(action.id)) !== null && _a !== void 0
								? _a
								: undefined;
						}
					},
	...
	setActions(_primary, _secondary = [], menuIds) {
		...
		if (
			((_a = this._options) === null || _a === void 0 ? void 0 : _a.hiddenItemStrategy) !==
			-1 /* HiddenItemStrategy.NoHide */
		) {
			for (let i = 0; i < primary.length; i++) {
				...
				if (action.hideActions.isHidden) {
					...
					primary[i] = undefined;
					if (
						((_b = this._options) === null || _b === void 0 ? void 0 : _b.hiddenItemStrategy) !==
						0 /* HiddenItemStrategy.Ignore */
					) {
		...
		// count for max
		if (
			((_c = this._options) === null || _c === void 0 ? void 0 : _c.maxNumberOfItems) !== undefined
		) {
			let count = 0;
			for (let i = 0; i < primary.length; i++) {
				const action = primary[i];
		...
		if (toggleActions.length > 0) {
			this._sessionDisposables.add(
				addDisposableListener(this.getElement(), 'contextmenu', (e) => {
					...
					if (
						((_b = this._options) === null || _b === void 0 ? void 0 : _b.resetMenu) &&
						!menuIds
					) {
