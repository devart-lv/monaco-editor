 ...
 *-----------------------------------------------------------*/ define(
 ...
 - I valori maggiori o uguali a 8 verranno usati come valori effettivi.`,
			...
			'Controlla se \xE8 possibile trascinare un file in un editor di testo tenendo premuto MAIUSC (invece di aprire il file in un editor).',
			...
			'Contenuto editor',
			"Controlla se i suggerimenti inline vengono annunciati da un'utilit\xE0 per la lettura dello schermo. Si noti che questo non funziona in macOS con VoiceOver.",
