			...
			Qr = (t, r, i, e) => {
				if ((r && typeof r == 'object') || typeof r == 'function')
					for (let n of Gr(r))
						!Xr.call(t, n) &&
							n !== i &&
							lt(t, n, { get: () => r[n], enumerable: !(e = Hr(r, n)) || e.enumerable });
				return t;
			};
...
`)),
					...
					case 47:
						...
						if (t.charCodeAt(e + 1) === 42) {
							...
							for (var E = i - 1, j = !1; e < E; ) {
								...
								e++, Le(A) && (A === 13 && t.charCodeAt(e) === 10 && e++, o++, (l = e));
							}
							return j || (e++, (c = 1)), (n = t.substring(O, e)), (s = 13);
						}
						return (n += String.fromCharCode(v)), e++, (s = 16);
					case 45:
						if (((n += String.fromCharCode(v)), e++, e === i || !Ce(t.charCodeAt(e))))
							return (s = 16);
					case 48:
					case 49:
					case 50:
		...
		function pt(t, r, i) {
			var e, n, a, s, o;
			if (r) {
				for (s = r.offset, o = s + r.length, a = s; a > 0 && !gt(t, a - 1); ) a--;
			...
			for (; v !== 17; ) {
				for (
					var j = g.getTokenOffset() + g.getTokenLength() + a, A = d(), P = '', w = !1;
					!u && (A === 12 || A === 13);
...
`.indexOf(t.charAt(r)) !== -1
		...
		function nn(t, r, i) {
			return (
				i === void 0 && (i = !1),
				(r >= t.offset && r < t.offset + t.length) || (i && r === t.offset + t.length)
			);
		}
		function vt(t, r, i) {
		...
		function Zt(t, r, i) {
			...
			function y(w, C, L) {
				if ((C === void 0 && (C = []), L === void 0 && (L = []), m(w), C.length + L.length > 0))
			...
			function E() {
				return e.getToken() !== 10
					? (y(3, [], [2, 5]), !1)
					: (v(!1),
					  e.getToken() === 6 ? (h(':'), b(), P() || y(4, [], [2, 5])) : y(5, [], [2, 5]),
					  !0);
			}
			function j() {
				s(), b();
		...
		(function (t) {
			function r(e, n, a, s) {
				...
				throw new Error(
					'Range#create called with invalid arguments[' + e + ', ' + n + ', ' + a + ', ' + s + ']'
				);
			}
			t.create = r;
			function i(e) {
		...
		(function (t) {
			...
			function i(e) {
				...
				return (
					...
					(x.undefined(a.relatedInformation) || x.typedArray(a.relatedInformation, At.is))
				);
			}
			t.is = i;
		})(ae || (ae = {}));
				...
				return (
					...
					(e.documentChanges === void 0 ||
						e.documentChanges.every(function (n) {
							return x.string(n.kind) ? Fe.is(n) || $e.is(n) || De.is(n) : Ve.is(n);
						}))
				);
			}
			t.is = r;
			...
			fr = (function () {
				...
				return (
					...
					(t.prototype.manage = function (r, i) {
						var e;
						if (
							(X.is(r) ? (e = r) : ((e = this.nextId()), (i = r)), this._annotations[e] !== void 0)
						)
				...
				return (
					...
					(t.prototype.createFile = function (r, i, e) {
						...
						if (
							(n === void 0
								? (a = Fe.create(r, e))
								: ((s = X.is(n) ? n : this._changeAnnotations.manage(n)), (a = Fe.create(r, e, s))),
							this._workspaceEdit.documentChanges.push(a),
							s !== void 0)
						)
							return s;
		...
		(function (t) {
			function r(i) {
				...
				return (
					!!e &&
					x.objectLiteral(e) &&
					(Ye.is(e.contents) || Ue.is(e.contents) || x.typedArray(e.contents, Ue.is)) &&
		...
		(function (t) {
			...
			function i(e) {
				var n = e;
				return x.defined(n) && U.is(n.range) && (x.undefined(n.command) || je.is(n.command));
			}
			t.is = i;
		})(mr || (mr = {}));
		var vr;
				...
				for (
					var o = a.getText(),
						f = n(s, function (m, p) {
							...
							return d === 0 ? m.range.start.character - p.range.start.character : d;
						}),
						l = o.length,
						u = f.length - 1;
					u >= 0;
					...
					if (g <= l) o = o.substring(0, h) + c.newText + o.substring(g, o.length);
...
` &&
					...
					for (let e of r)
						if (we.isIncremental(e)) {
							...
							let o = Math.max(n.start.line, 0),
								...
								l = this._lineOffsets,
								u = br(e.text, !1, a);
							if (f - o === u.length) for (let h = 0, g = u.length; h < g; h++) l[h + o + 1] = u[h];
							else
								u.length < 1e4
									? l.splice(o + 1, f - o, ...u)
									: (this._lineOffsets = l = l.slice(0, o + 1).concat(u, l.slice(f + 1)));
							let c = e.text.length - (s - a);
							if (c !== 0) for (let h = o + 1 + u.length, g = l.length; h < g; h++) l[h] = l[h] + c;
						} else if (we.isFull(e)) (this._content = e.text), (this._lineOffsets = void 0);
						else throw new Error('Unknown change event received');
					this._version = i;
				}
				getLineOffsets() {
					return (
						this._lineOffsets === void 0 && (this._lineOffsets = br(this._content, !0)),
						this._lineOffsets
					);
				}
				positionAt(r) {
		...
		var xn = (function () {
				...
				return (
					...
					(t.prototype.include = function (r) {
						return (this.focusOffset === -1 || Dt(r, this.focusOffset)) && r !== this.exclude;
					}),
		...
		function _(t, r, i, e) {
			...
			function a() {
				function u(V) {
					return n.type === V || (V === 'integer' && n.type === 'number' && n.isInteger);
				}
				if (
						...
						: r.type &&
						  (u(r.type) ||
								i.problems.push({
									...
									message:
										r.errorMessage ||
										M('typeMismatchWarning', 'Incorrect type. Expected "{0}".', r.type)
								})),
				...
				var O = function (V, R) {
					for (var H = [], q = void 0, T = 0, S = V; T < S.length; T++) {
						...
						else if (!R && !F.hasProblems() && !q.validationResult.hasProblems())
							q.matchingSchemas.merge(D),
								(q.validationResult.propertiesMatches += F.propertiesMatches),
								(q.validationResult.propertiesValueMatches += F.propertiesValueMatches);
						else {
							var J = F.compare(q.validationResult);
							J > 0
								? (q = { schema: I, validationResult: F, matchingSchemas: D })
								: J === 0 && (q.matchingSchemas.merge(D), q.validationResult.mergeEnumValues(F));
						}
					}
					return (
						H.length > 1 &&
				...
				if (se(r.const)) {
					...
					Ie(P, r.const)
						...
						: (i.problems.push({
								...
								code: W.EnumValueMismatch,
								message:
									r.errorMessage || M('constWarning', 'Value must be {0}.', JSON.stringify(r.const))
						  }),
						  (i.enumValueMatch = !1)),
			...
			function s(u, c, h, g) {
				...
				function p(C) {
					...
					return (
						N && {
							...
							multiplier:
								(((L = N[2]) === null || L === void 0 ? void 0 : L.length) || 0) -
								(parseInt(N[3]) || 0)
						}
					);
				}
				...
				ee(j) &&
					...
					h.problems.push({
						location: { offset: u.offset, length: u.length },
						message: M('exclusiveMinimumWarning', 'Value is below the exclusive minimum of {0}.', j)
					});
						...
						case 'uri-reference':
							{
								...
								if (!u.value) p = M('uriEmpty', 'URI expected.');
									...
									d
										? !d[2] &&
										  c.format === 'uri' &&
										  (p = M('uriSchemeMissing', 'URI with a scheme is expected.'))
				...
				if (P) {
					...
					w ||
						h.problems.push({
							...
							message:
								c.errorMessage ||
								M('requiredItemMissingWarning', 'Array does not contain required item.')
						});
				}
				if (
					(ee(c.minItems) &&
			...
			function l(u, c, h, g) {
				for (var m = Object.create(null), p = [], d = 0, b = u.properties; d < b.length; d++) {
					var y = b[d],
						v = y.keyNode.value;
				...
				if (Array.isArray(c.required))
					for (var O = 0, E = c.required; O < E.length; O++) {
						...
						if (!m[j]) {
							...
							h.problems.push({
								location: P,
								message: M('MissingRequiredPropWarning', 'Missing property "{0}".', j)
							});
						}
					}
				var w = function (Gt) {
					for (var ct = p.indexOf(Gt); ct >= 0; ) p.splice(ct, 1), (ct = p.indexOf(Gt));
				};
				if (c.properties)
							...
							if (ie(N))
								if (N) h.propertiesMatches++, h.propertiesValueMatches++;
									...
									h.problems.push({
										...
										message:
											c.errorMessage ||
											M('DisallowedExtraPropWarning', 'Property {0} is not allowed.', j)
									});
								}
							else {
								var R = new te();
				...
				if (c.patternProperties)
					for (var H = 0, q = Object.keys(c.patternProperties); H < q.length; H++)
						for (var T = q[H], S = xe(T), k = 0, I = p.slice(0); k < I.length; k++) {
							var j = I[k];
							if (S?.test(j)) {
								w(j);
								var V = m[j];
		...
		function Or(t, r) {
			...
			function u(A, P, w, C, L) {
				w === void 0 && (w = void 0), C === void 0 && (C = []), L === void 0 && (L = []);
			...
			function c() {
				switch (a.getTokenError()) {
					case 4:
						return (
							u(M('InvalidUnicode', 'Invalid unicode sequence in string.'), W.InvalidUnicode), !0
						);
					case 5:
						return (
							u(
								M('InvalidEscapeCharacter', 'Invalid escape character in string.'),
					...
					case 3:
						return (
							u(M('UnexpectedEndOfNumber', 'Unexpected end of number.'), W.UnexpectedEndOfNumber),
							!0
						);
					case 1:
						return (
					...
					case 2:
						return (
							u(M('UnexpectedEndOfString', 'Unexpected end of string.'), W.UnexpectedEndOfString),
							!0
						);
					case 6:
						return (
				...
				if (a.getToken() === 3) {
					...
					for (var w = 0, C = !1; a.getToken() !== 4 && a.getToken() !== 17; ) {
						if (a.getToken() === 5) {
							...
							if ((o(), a.getToken() === 4)) {
								C && l(M('TrailingComma', 'Trailing comma'), W.TrailingComma, L, L + 1);
								continue;
							}
						...
						N
							? P.items.push(N)
							: u(M('PropertyExpected', 'Value expected'), W.ValueExpected, void 0, [], [4, 5]),
							(C = !0);
					}
					return a.getToken() !== 4
						? u(
			...
			function p(A, P) {
				...
				if (
					...
					a.getToken() === 10 &&
						t.positionAt(C.offset + C.length).line < t.positionAt(a.getTokenOffset()).line)
				)
				...
				return (
					...
					(t.prototype.doComplete = function (r, i, e) {
						...
						if (f && o === f.offset + f.length && o > 0) {
							var l = s[o - 1];
							((f.type === 'object' && l === '}') || (f.type === 'array' && l === ']')) &&
								(f = f.parent);
						}
							...
							p = {
								add: function (d) {
									...
									if (y)
										...
										c && d.insertText !== void 0 && (d.textEdit = Y.replace(c, d.insertText)),
											g && (d.commitCharacters = d.kind === Q.Property ? An : Sn),
											(d.label = b),
											(m[b] = d),
											a.items.push(d);
									}
						...
						return this.schemaService.getSchemaForResource(r.uri, e).then(function (d) {
							var b = [],
								y = !0,
								v = '',
								O = void 0;
							...
							if (f && f.type === 'object') {
								...
								n.contributions.forEach(function (C) {
									var L = C.collectPropertyCompletions(r.uri, P, u, y, A === '', p);
									L && b.push(L);
								}),
									!d &&
										u.length > 0 &&
									...
									Object.keys(u).forEach(function (p) {
										...
										if (typeof d == 'object' && !d.deprecationMessage && !d.doNotSuggest) {
											var b = {
												...
												documentation: o.fromMarkup(d.markdownDescription) || d.description || ''
											};
											d.suggestSortText !== void 0 && (b.sortText = d.suggestSortText),
												b.insertText &&
								...
								if (typeof c == 'object' && !c.deprecationMessage && !c.doNotSuggest) {
									var h = function (p, d) {
										...
										var b = {
											...
											insertTextFormat: z.Snippet,
											filterText: o.getFilterTextForValue(p),
											documentation: d || o.fromMarkup(c.markdownDescription) || c.description || ''
										};
									...
									if (c.enum)
										for (var g = 0; g < c.enum.length; g++) {
											var m = void 0;
											c.markdownEnumDescriptions && g < c.markdownEnumDescriptions.length
						...
						var f = this.evaluateSeparatorAfter(n, o),
							l = function (g) {
								g.parent &&
									...
									g.type === 'boolean' && s.addBooleanValueCompletion(!g.value, f, a);
							};
						if (i.type === 'property' && e > (i.colonOffset || 0)) {
							var u = i.valueNode;
							if (u && (e > u.offset + u.length || u.type === 'object' || u.type === 'array'))
								return;
							var c = i.keyNode.value;
							r.visit(function (g) {
								return (
									g.type === 'property' && g.keyNode.value === c && g.valueNode && l(g.valueNode),
									!0
								);
							}),
								c === '$schema' &&
									...
									if (e.type === 'array' && d.schema.items)
										if (Array.isArray(d.schema.items)) {
											...
											b < d.schema.items.length &&
												this.addSchemaValueCompletions(d.schema.items[b], h, s, o);
										} else this.addSchemaValueCompletions(d.schema.items, h, s, o);
									if (l !== void 0) {
										var y = !1;
					...
					(t.prototype.addDefaultValueCompletions = function (r, i, e, n) {
						...
						Array.isArray(r.examples) &&
							r.examples.forEach(function (u) {
								for (var c = r.type, h = u, g = n; g > 0; g--) (h = [h]), (c = 'array');
								e.add({
							...
							Array.isArray(r.defaultSnippets) &&
								r.defaultSnippets.forEach(function (u) {
									var c = r.type,
										...
										p;
									if (se(h)) {
										for (var d = r.type, b = n; b > 0; b--) (h = [h]), (d = 'array');
						...
						if (i) {
							...
							if (
								...
								Array.isArray(i.examples) &&
									i.examples.length &&
									(o || (o = this.getInsertTextForGuessedValue(i.examples[0], '')),
									(f += i.examples.length)),
								f === 0)
							) {
...
\r\v":{[,]}`.indexOf(n.charAt(e)) === -1;
					...
					(t.prototype.isInComment = function (r, i, e) {
						...
						n.setPosition(i);
						for (var a = n.scan(); a !== 17 && n.getTokenOffset() + n.getTokenLength() < e; )
							a = n.scan();
					...
					(t.prototype.doesSupportsCommitCharacters = function () {
						if (!se(this.supportsCommitCharacters)) {
							...
							this.supportsCommitCharacters =
								r && r.completionItem && !!r.completionItem.commitCharactersSupport;
						}
						...
						if (m && a) {
							...
							p.every(function (E) {
								if (
									...
									E.schema &&
									((d = d || E.schema.title),
									(b = b || E.schema.markdownDescription || Ut(E.schema.description)),
									E.schema.enum)
								) {
									var j = E.schema.enum.indexOf(ge(a));
									E.schema.markdownEnumDescriptions
										? (y = E.schema.markdownEnumDescriptions[j])
										: E.schema.enumDescriptions && (y = Ut(E.schema.enumDescriptions[j])),
										y && ((v = E.schema.enum[j]), typeof v != 'string' && (v = JSON.stringify(v)));
								}
								return !0;
							});
							var O = '';
...
$3`
				...
				return (
					...
					(t.prototype.doValidation = function (r, i, e, n) {
						...
						var s = [],
							o = {},
							f = function (h) {
								var g = h.range.start.line + ' ' + h.range.start.character + ' ' + h.message;
								o[g] || ((o[g] = !0), s.push(h));
							},
							l = function (h) {
							...
							if (c.type === 'object')
								for (var h = 0, g = c.properties; h < g.length; h++) {
									...
									if (m.keyNode.value === 'key' && m.valueNode) {
										...
										if (
											(f.push({ name: ge(m.valueNode), kind: oe.Function, location: p }),
											s--,
											s <= 0)
										)
		...
		for (Vr in at.schemas) {
			...
			for (Me in nt.properties)
				(it = nt.properties[Me]),
					...
					Wt
						? (it.description = Wt)
						: console.log(''.concat(Me, ": localize('schema.json.").concat(Me, `', "")`));
		}
		var nt, it, Wt, Me, Vr;
		var Fr;
		Fr = (() => {
			...
			var t = {
					470: (e) => {
						...
						function a(o, f) {
							for (var l, u = '', c = 0, h = -1, g = 0, m = 0; m <= o.length; ++m) {
								...
								if (l === 47) {
									if (!(h === m - 1 || g === 1))
										if (h !== m - 1 && g === 2) {
											if (
												...
												if (u.length > 2) {
													...
													if (p !== u.length - 1) {
														p === -1
															? ((u = ''), (c = 0))
															: (c = (u = u.slice(0, p)).length - 1 - u.lastIndexOf('/')),
															(h = m),
															(g = 0);
														continue;
													}
											...
											u.length > 0 ? (u += '/' + o.slice(h + 1, m)) : (u = o.slice(h + 1, m)),
												(c = m - h - 1);
									(h = m), (g = 0);
								} else l === 46 && g !== -1 ? ++g : (g = -1);
							}
						...
						var s = {
							...
							relative: function (o, f) {
								...
								for (var g = f.length - h, m = c < g ? c : g, p = -1, d = 0; d <= m; ++d) {
									if (d === m) {
										if (g > m) {
											if (f.charCodeAt(h + d) === 47) return f.slice(h + d + 1);
											if (d === 0) return f.slice(h + d);
										} else c > m && (o.charCodeAt(l + d) === 47 ? (p = d) : d === 0 && (p = 0));
										break;
									}
							...
							dirname: function (o) {
								if ((n(o), o.length === 0)) return '.';
								for (
									var f = o.charCodeAt(0), l = f === 47, u = -1, c = !0, h = o.length - 1;
									h >= 1;
									--h
								)
								...
								if (f !== void 0 && f.length > 0 && f.length <= o.length) {
									...
									for (l = o.length - 1; l >= 0; --l) {
										...
										if (p === 47) {
											...
											m === -1 && ((h = !1), (m = l + 1)),
												g >= 0 &&
													(p === f.charCodeAt(g) ? --g == -1 && (c = l) : ((g = -1), (c = m)));
									}
							...
							extname: function (o) {
								n(o);
								for (var f = -1, l = 0, u = -1, c = !0, h = 0, g = o.length - 1; g >= 0; --g) {
									var m = o.charCodeAt(g);
									if (m !== 47)
										u === -1 && ((c = !1), (u = g + 1)),
											m === 46 ? (f === -1 ? (f = g) : h !== 1 && (h = 1)) : f !== -1 && (h = -1);
									else if (!c) {
										l = g + 1;
										break;
									}
								}
								return f === -1 || u === -1 || h === 0 || (h === 1 && f === u - 1 && f === l + 1)
									? ''
									: o.slice(f, u);
							},
							format: function (o) {
							...
							parse: function (o) {
								...
								var l,
									...
									c = u === 47;
								c ? ((f.root = '/'), (l = 1)) : (l = 0);
								for (var h = -1, g = 0, m = -1, p = !0, d = o.length - 1, b = 0; d >= l; --d)
									if ((u = o.charCodeAt(d)) !== 47)
										m === -1 && ((p = !1), (m = d + 1)),
											u === 46 ? (h === -1 ? (h = d) : b !== 1 && (b = 1)) : h !== -1 && (b = -1);
									else if (!p) {
										g = d + 1;
										break;
									}
								return (
									h === -1 || m === -1 || b === 0 || (b === 1 && h === m - 1 && h === g + 1)
										? m !== -1 && (f.base = f.name = g === 0 && c ? o.slice(1, m) : o.slice(g, m))
										: (g === 0 && c
					...
					447: (e, n, a) => {
						var s;
						if ((a.r(n), a.d(n, { URI: () => y, Utils: () => V }), typeof process == 'object'))
							...
							u =
								((f = function (T, S) {
									return (f =
										...
										function (k, I) {
											for (var F in I) Object.prototype.hasOwnProperty.call(I, F) && (k[F] = I[F]);
										})(T, S);
								}),
								function (T, S) {
									...
									f(T, S),
										(T.prototype =
											S === null ? Object.create(S) : ((k.prototype = S.prototype), new k()));
								}),
							c = /^\w[\w\d+.-]*$/,
							h = /^\//,
							g = /^\/\//;
								...
								return (
									...
									(T.prototype.with = function (S) {
										...
										return (
											...
											I === void 0 ? (I = this.authority) : I === null && (I = p),
									...
									(T.parse = function (S, k) {
										...
										var I = b.exec(S);
										return I
											? new O(I[2] || p, N(I[4] || p), N(I[5] || p), N(I[7] || p), N(I[9] || p), k)
											: new O(p, p, p, p, p);
									}),
									(T.file = function (S) {
										var k = p;
										if ((s && (S = S.replace(/\\/g, d)), S[0] === d && S[1] === d)) {
											var I = S.indexOf(d, 2);
											I === -1
												? ((k = S.substring(2)), (S = d))
									...
									(T.revive = function (S) {
										if (S) {
											...
											var k = new O(S);
											return (
												(k._formatted = S.external), (k._fsPath = S._sep === v ? S.fsPath : null), k
											);
										}
										return S;
									}),
						...
						function j(T, S) {
							for (var k = void 0, I = -1, F = 0; F < T.length; F++) {
								...
								if (
									...
									I !== -1 && ((k += encodeURIComponent(T.substring(I, F))), (I = -1)),
							...
							return I !== -1 && (k += encodeURIComponent(T.substring(I))), k !== void 0 ? k : T;
						}
						function A(T) {
						...
						function w(T, S) {
							...
							return (
								ue && ((I += '?'), (I += k(ue, !1))), G && ((I += '#'), (I += S ? G : j(G, !1))), I
							);
						}
						function C(T) {
							try {
							...
							H = function (T, S, k) {
								if (k || arguments.length === 2)
									for (var I, F = 0, D = S.length; F < D; F++)
										(!I && F in S) ||
											(I || (I = Array.prototype.slice.call(S, 0, F)), (I[F] = S[F]));
								return T.concat(I || Array.prototype.slice.call(S));
							},
							q = R.posix || R;
						(function (T) {
							(T.joinPath = function (S) {
								for (var k = [], I = 1; I < arguments.length; I++) k[I - 1] = arguments[I];
			...
			return (
				(i.d = (e, n) => {
					for (var a in n)
						i.o(n, a) && !i.o(e, a) && Object.defineProperty(e, a, { enumerable: !0, get: n[a] });
				}),
					...
					case '*':
						...
						if (!a) e += '.*';
							...
							m
								? (g === '/'
										? l++
										: c === '/' && e.endsWith('\\/') && (e = e.substr(0, e.length - 2)),
								  (e += '((?:[^/]*(?:/|$))*)'))
								: (e += '([^/]*)');
						}
						break;
			...
			Mn = (function () {
				function t(r, i, e) {
					(this.service = r),
						...
						(this.anchors = void 0),
						e && (this.unresolvedSchema = this.service.promise.resolve(new ze(e)));
				}
				return (
		...
		var Rr = (function () {
			...
			return (
					...
					return this.requestService(r).then(
						...
						function (e) {
							...
							return (
								...
								new ze({}, [
									de('json.schema.nocontent', "Unable to load schema from '{0}': {1}.", ot(r), n)
								])
							);
						}
					);
					...
					if (a.$schema) {
						...
						if (s === 'http://json-schema.org/draft-03/schema')
							return this.promise.resolve(
								new Dr({}, [
									de('json.schema.draft03.notsupported', 'Draft-03 schemas are not supported.')
								])
							);
							...
							return (
								e.traverseNodes(p, function (b) {
									...
									if (typeof y == 'string' && y.charAt(0) === '#') {
										var v = y.substring(1);
										d.has(v)
											? n.push(de('json.schema.duplicateid', "Duplicate id declaration: '{0}'", y))
											: d.set(v, b);
									}
								}),
								d
				...
				(t.prototype.getAssociatedSchemas = function (r) {
					for (
						var i = Object.create(null), e = [], n = Vn(r), a = 0, s = this.filePatternAssociations;
						a < s.length;
						a++
					) {
						var o = s[a];
				...
				switch (o) {
					...
					case 13: {
						...
						s.getTokenError() === 1 && l + 1 < t.lineCount
							...
							: l < g && (f({ startLine: l, endLine: g, kind: Ae.Comment }), (a = l));
						break;
					}
					case 12: {
						...
						if (p) {
							...
							if (p[1]) {
								...
								for (var d = n.length - 1; d >= 0 && n[d].kind !== Ae.Region; ) d--;
								if (d >= 0) {
									var u = n[d];
									(n.length = d),
										h > u.startLine &&
		...
		function Wr(t, r, i) {
			function e(o) {
				...
				for (var m = void 0, p = u.length - 1; p >= 0; p--) m = Ne.create(u[p], m);
...
`
					...
					return tr(o.getText(), u, g).map(function (m) {
						return Y.replace(
							U.create(o.positionAt(m.offset), o.positionAt(m.offset + m.length)),
							m.content
						);
					});
				}
