...
define('vs/language/html/htmlMode', ['require', 'require'], (require) => {
	var moduleExports = (() => {
		...
		var un = (n, t) => () => (t || n((t = { exports: {} }).exports, t), t.exports),
			dn = (n, t) => {
			...
			q = (n, t, i, r) => {
				if ((t && typeof t == 'object') || typeof t == 'function')
					for (let e of rn(t))
						!sn.call(n, e) &&
							e !== i &&
							Q(n, e, { get: () => t[e], enumerable: !(r = tn(t, e)) || r.enumerable });
				return n;
			},
		...
		(function (n) {
			function t(r, e, o, s) {
				...
				throw new Error(
					'Range#create called with invalid arguments[' + r + ', ' + e + ', ' + o + ', ' + s + ']'
				);
			}
			n.create = t;
			function i(r) {
						...
						let u = t.getWordUntilPosition(i),
							...
							f = s.items.map((g) => {
								...
								return (
									g.textEdit &&
										(vn(g.textEdit)
											? (m.range = { insert: y(g.textEdit.insert), replace: y(g.textEdit.replace) })
											: (m.range = y(g.textEdit.range)),
										(m.insertText = g.textEdit.newText)),
									g.additionalTextEdits && (m.additionalTextEdits = g.additionalTextEdits.map(L)),
		...
		var S = class {
			...
			provideDocumentHighlights(t, i, r) {
				...
				return this._worker(e)
					...
					.then((o) => {
						if (!!o) return o.map((s) => ({ range: y(s.range), kind: In(s.kind) }));
					});
			}
		};
		function In(n) {
							...
							if (!!o)
								return o.map((s) => {
									...
									return (
										...
										s.additionalTextEdits && (u.additionalTextEdits = s.additionalTextEdits.map(L)),
										u
									);
								});
						});
			...
			function o() {
				...
				en(i),
					...
					u.documentFormattingEdits &&
						i.push(d.languages.registerDocumentFormattingEditProvider(s, new H(e))),
					u.documentRangeFormattingEdits &&
						i.push(d.languages.registerDocumentRangeFormattingEditProvider(s, new K(e)));
			}
