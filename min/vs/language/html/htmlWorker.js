	...
	var moduleExports = (() => {
			...
			Ln = (t, i, o, n) => {
				if ((i && typeof i == 'object') || typeof i == 'function')
					for (let e of Dn(i))
						!En.call(t, e) &&
							e !== o &&
							Xe(t, e, { get: () => i[e], enumerable: !(n = xn(i, e)) || n.enumerable });
				return t;
			};
		...
		(function (t) {
			function i(n, e, a, c) {
				...
				throw new Error(
					'Range#create called with invalid arguments[' + n + ', ' + e + ', ' + a + ', ' + c + ']'
				);
			}
			t.create = i;
			function o(n) {
				...
				return (
					...
					(n.documentChanges === void 0 ||
						n.documentChanges.every(function (e) {
							return _.string(e.kind) ? De.is(e) || Ee.is(e) || Ce.is(e) : Be.is(e);
						}))
				);
			}
			t.is = i;
			...
			xt = (function () {
				...
				return (
					...
					(t.prototype.manage = function (i, o) {
						var n;
						if (
							(Z.is(i) ? (n = i) : ((n = this.nextId()), (o = i)), this._annotations[n] !== void 0)
						)
				...
				return (
					...
					(t.prototype.createFile = function (i, o, n) {
						...
						if (
							(e === void 0
								? (a = De.create(i, n))
								: ((c = Z.is(e) ? e : this._changeAnnotations.manage(e)), (a = De.create(i, n, c))),
							this._workspaceEdit.documentChanges.push(a),
							c !== void 0)
						)
							return c;
					...
					(t.prototype.deleteFile = function (i, o, n) {
						...
						if (
							(e === void 0
								? (a = Ce.create(i, n))
								: ((c = Z.is(e) ? e : this._changeAnnotations.manage(e)), (a = Ce.create(i, n, c))),
							this._workspaceEdit.documentChanges.push(a),
							c !== void 0)
						)
							return c;
		...
		(function (t) {
			function i(o) {
				...
				return (
					!!n &&
					_.objectLiteral(n) &&
					(Ne.is(n.contents) || Le.is(n.contents) || _.typedArray(n.contents, Le.is)) &&
		...
		(function (t) {
			...
			function o(n) {
				var e = n;
				return _.defined(e) && P.is(e.range) && (_.undefined(e.command) || ye.is(e.command));
			}
			t.is = o;
		})(Wt || (Wt = {}));
		var lt;
		...
		var pe = class {
				...
				update(i, o) {
					for (let n of i)
						...
						} else if (pe.isFull(n)) (this._content = n.text), (this._lineOffsets = void 0);
						else throw new Error('Unknown change event received');
					this._version = o;
				}
				getLineOffsets() {
					return (
						this._lineOffsets === void 0 && (this._lineOffsets = Ft(this._content, !0)),
						this._lineOffsets
					);
				}
				positionAt(i) {
				...
				return (
					...
					(t.prototype.advanceUntilChars = function (i) {
						for (; this.position + i.length <= this.source.length; ) {
							for (
								var o = 0;
								o < i.length && this.source.charCodeAt(this.position + o) === i[o];
								o++
							);
					...
					(t.prototype.advanceWhileChar = function (i) {
						for (
							var o = this.position;
							this.position < this.len && i(this.source.charCodeAt(this.position));
					...
					case W.AfterOpeningEndTag:
						...
						return B.length > 0
							...
							: ((a = W.WithinEndTag),
							  ...
							  w < e.pos()
									? m(w, S.Unknown, he('error.endTagNameExpected', 'End tag name expected.'))
									: E());
					case W.WithinEndTag:
						...
						return (
							...
							u.length > 0
								...
								: ((a = W.WithinTag),
								  e.advanceUntilChar(se),
								  w < e.pos()
										? m(w, S.Unknown, he('error.startTagNameExpected', 'Start tag name expected.'))
										: E())
						);
					case W.WithinTag:
						return e.skipWhitespace()
							...
							: (e.advance(1),
							  m(
									w,
									S.Unknown,
									he('error.unexpectedCharacterInTag', 'Unexpected character in tag.')
							  ));
									...
									case 2:
										for (r = m.sent(), s = 0, u = r; s < u.length; s++)
											(h = u[s]),
												(d = h[0]),
												(g = h[1]),
												d.charCodeAt(0) !== ti && l.push(oi(d, g === Oe.Directory, o));
										return [2, l];
									case 3:
										return (y = m.sent()), [3, 4];
									case 4:
...
\r`.indexOf(L) >= 0
						...
						function J(x, D) {
							...
							if (!$t(s, D, W.AfterAttributeName, S.DelimiterAssign)) {
								var K =
									(L = e?.attributeDefaultValue) !== null && L !== void 0 ? L : 'doublequotes';
						...
						function R() {
							for (var x = u - 1, D = o.character; x >= 0 && ge(s, x); ) x--, D--;
							if (x >= 0 && s[x] === '&') {
					...
					(t.prototype.doTagComplete = function (i, o, n) {
						...
						if (a === '>') {
							...
							if (c && c.tag && !me(c.tag) && c.start < e && (!c.endTagStart || c.endTagStart > e))
								for (
			...
			Zt = (function () {
				...
				return (
					(t.prototype.doHover = function (i, o, n, e) {
										...
										if (
											(C.provideTags().forEach(function (D) {
												if (D.name.toLowerCase() === U.toLowerCase()) {
													var L = le(D, e, c);
													L || (L = { kind: c ? 'markdown' : 'plaintext', value: '' }),
						...
						function A() {
							for (var U = l - 1, H = o.character; U >= 0 && ge(s, U); ) U--, H--;
					...
					(t.prototype.doesSupportMarkdown = function () {
						...
						if (!Ae(this.supportsMarkdown)) {
							...
							var e =
								(n =
									(o =
										(i = this.lsOptions.clientCapabilities) === null || i === void 0
											? void 0
...
`);
							...
							(a.prototype.pop = function () {
								...
								return (
									this.is_empty() ||
										((r = this.__items.pop()), (this.__character_count -= r.length)),
									r
								);
							}),
						...
						function c(r, s) {
							(this.__cache = ['']),
								...
								r.indent_with_tabs ||
									(this.__indent_string = new Array(r.indent_size + 1).join(r.indent_char)),
								(s = s || ''),
								r.indent_level > 0 &&
									(s = new Array(r.indent_level + 1).join(this.__indent_string)),
								...
								E.isEmpty() || ((g.comments_before = E), (E = new s())),
									...
									this._is_opening(g)
										...
										: m &&
										  ...
										  ((g.opened = m), (m.closed = g), (m = A.pop()), (g.parent = m)),
									(g.previous = y),
									(y.next = g),
									this.__tokens.add(g),
									(y = g);
					...
					function (e) {
						...
						(a.prototype.restart = function () {
							...
							(a.prototype.next = function () {
								var c = null;
								return (
									this.hasNext() && ((c = this.__tokens[this.__position]), (this.__position += 1)),
									c
								);
							}),
					...
					function (e, a, c) {
						...
						(s.prototype = new l()),
							...
							(s.prototype.read = function () {
								...
								return (
									this._until_after && (u += this._input.readUntilAfter(this._until_pattern)), u
								);
							}),
					...
					function (e, a, c) {
						...
						(g.prototype.current_line_has_match = function (f) {
							...
							(g.prototype.get_full_indent = function (f) {
								return (
									(f = this.indent_level + (f || 0)), f < 1 ? '' : this._output.get_indent_string(f)
								);
							});
						var y = function (f) {
								...
								if (
									...
									if (
										(p.type === u.ATTRIBUTE
											...
											: (p.type === u.EQUALS ||
													(p.type === u.VALUE && p.previous.type === u.EQUALS)) &&
						...
						(M.prototype._get_tag_open_token = function (f) {
							...
							return (
								...
								(p.is_content_unformatted =
									!p.is_empty_element && A(p.tag_check, this._options.content_unformatted)),
								(p.is_inline_element =
									A(p.tag_name, this._options.inline) || p.tag_start_char === '{'),
								p
							);
						}),
							...
							if (!(f.is_empty_element || !f.is_start_tag || !f.parent)) {
								if (f.tag_name === 'body') p = p || this._tag_stack.try_pop('head');
									...
									f.tag_name === 'rp' || f.tag_name === 'rt'
										...
										: f.tag_name === 'option'
										? (p =
												p || this._tag_stack.try_pop('option', ['select', 'datalist', 'optgroup']))
										: f.tag_name === 'colgroup'
										...
										? ((p = p || this._tag_stack.try_pop('caption', ['table'])),
										  (p = p || this._tag_stack.try_pop('colgroup', ['table'])),
										  (p =
												p || this._tag_stack.try_pop('tr', ['table', 'thead', 'tbody', 'tfoot'])))
									...
									M === '!' &&
										...
										E
											? ((w = g.get_directives(E)),
											  w && w.ignore === 'start' && (E += g.readIgnored(this._input)))
...
`.indexOf(t.charAt(i)) !== -1
		...
		ln = (() => {
					...
					470: (n) => {
								...
								if (s === 47) {
									if (!(d === y - 1 || g === 1))
										if (d !== y - 1 && g === 2) {
											if (
												...
												if (u.length > 2) {
													...
													if (m !== u.length - 1) {
														m === -1
															? ((u = ''), (h = 0))
															: (h = (u = u.slice(0, m)).length - 1 - u.lastIndexOf('/')),
															(d = y),
															(g = 0);
														continue;
													}
											...
											u.length > 0 ? (u += '/' + l.slice(d + 1, y)) : (u = l.slice(d + 1, y)),
												(h = y - d - 1);
									(d = y), (g = 0);
								} else s === 46 && g !== -1 ? ++g : (g = -1);
							}
						...
						var c = {
							...
							dirname: function (l) {
								if ((e(l), l.length === 0)) return '.';
								for (
									var r = l.charCodeAt(0), s = r === 47, u = -1, h = !0, d = l.length - 1;
									d >= 1;
									--d
								)
								...
								if (r !== void 0 && r.length > 0 && r.length <= l.length) {
									...
									for (s = l.length - 1; s >= 0; --s) {
										...
										if (m === 47) {
											...
											y === -1 && ((d = !1), (y = s + 1)),
												g >= 0 &&
													(m === r.charCodeAt(g) ? --g == -1 && (h = s) : ((g = -1), (h = y)));
									}
							...
							extname: function (l) {
								...
								return r === -1 || u === -1 || d === 0 || (d === 1 && r === u - 1 && r === s + 1)
									? ''
									: l.slice(r, u);
							},
							format: function (l) {
						...
						var r,
							...
							u =
								...
								function (T, v) {
									...
									r(T, v),
										(T.prototype =
											v === null ? Object.create(v) : ((k.prototype = v.prototype), new k()));
								}),
							h = /^\w[\w\d+.-]*$/,
							d = /^\//,
							g = /^\/\//;
								...
								return (
									...
									(T.revive = function (v) {
										if (v) {
											...
											var k = new B(v);
											return (
												(k._formatted = v.external), (k._fsPath = v._sep === M ? v.fsPath : null), k
											);
										}
										return v;
									}),
							...
							I = function (T, v, k) {
								if (k || arguments.length === 2)
									for (var C, x = 0, D = v.length; x < D; x++)
										(!C && x in v) ||
											(C || (C = Array.prototype.slice.call(v, 0, x)), (C[x] = v[x]));
			...
			return (
				(o.d = (n, e) => {
					for (var a in e)
						o.o(e, a) && !o.o(n, a) && Object.defineProperty(n, a, { enumerable: !0, get: e[a] });
				}),
		...
		function yi(t, i, o, n) {
			if (!(/^\s*javascript\:/i.test(i) || /[\n\r]/.test(i))) {
				if (((i = i.replace(/^\s*/g, '')), /^https?:\/\//i.test(i) || /^file:\/\//i.test(i)))
					return i;
		...
		function Ti(t, i, o, n, e, a) {
			...
			if (!!_i(c, t.languageId)) {
				...
				if (!(!l || !ki(l)))
					return { range: P.create(t.positionAt(n), t.positionAt(e)), target: l };
			}
		}
		function ki(t) {
			try {
		...
		function cn(t, i) {
			for (
				var o = [], n = $(t.getText(), 0), e = n.scan(), a = void 0, c = !1, l = void 0, r = {};
				e !== S.EOS;
				...
				switch (e) {
					...
					case S.AttributeValue:
						if (a === 'src' || a === 'href') {
							...
							c && typeof l > 'u' && ((l = ft(u)), l && i && (l = i.resolveReference(l, t.uri))),
								(c = !1),
								(a = void 0);
						} else if (a === 'id') {
		...
		function mn(t, i, o) {
			...
			return (
				((c && dn(c, i)) || (l && dn(l, i))) &&
					(c && a.push({ kind: Te.Read, range: c }), l && a.push({ kind: Te.Read, range: l })),
				a
			);
		}
		function hn(t, i) {
		...
		function pn(t, i, o) {
			...
			return e !== S.EOS
				? { start: i.positionAt(n.getTokenOffset()), end: i.positionAt(n.getTokenEnd()) }
				: null;
		}
		function fn(t, i) {
			var o = [];
		...
		function gn(t, i, o, n) {
			var e = Si(i),
				a = we.create(t.uri, P.create(t.positionAt(i.start), t.positionAt(i.end))),
						...
						if (A)
							if (A[1]) a.push({ startLine: u, tagName: '' });
								...
								if (h >= 0) {
									...
									var y = u;
									(u = d.startLine),
										y > u && l !== u && r({ startLine: u, endLine: y, kind: _e.Region });
								}
							}
						else {
		...
		function yn(t, i) {
			function o(n) {
				for (var e = Di(t, n), a = void 0, c = void 0, l = e.length - 1; l >= 0; l--) {
					var r = e[l];
					(!a || r[0] !== a[0] || r[1] !== a[1]) &&
						(c = ke.create(P.create(t.positionAt(e[l][0]), t.positionAt(e[l][1])), c)),
						(a = r);
				}
			...
			for (
				...
				switch (l) {
					case S.AttributeName: {
						...
						a <= c.getTokenEnd() && s.unshift([c.getTokenOffset(), c.getTokenEnd()]),
							(u = !0),
							(h = c.getTokenOffset());
						break;
					}
...
The resource should be downloaded after other higher-priority page resources.`
				...
				},
				{
					...
					attributes: [
						{
							name: 'src',
							description: { kind: 'markdown', value: 'The URL\xA0of the resource being embedded.' }
						},
						{
							name: 'type',
							description: {
...
*   a _positive value_ means that the element should be focusable and reachable via sequential keyboard navigation; the order in which the elements are focused is the increasing value of the [**tabindex**](#attr-tabindex). If several elements share the same tabindex, their relative order follows their relative positions in the document.`
		...
		var Tn = (function () {
			function t(i) {
				(this.dataProviders = []),
					this.setDataProviders(i.useDefaultDataProvider !== !1, i.customDataProviders || []);
			}
			return (
