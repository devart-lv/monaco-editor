...
define('vs/language/css/cssMode', ['require', 'require'], (require) => {
	var moduleExports = (() => {
		...
		var an = (n, t) => () => (t || n((t = { exports: {} }).exports, t), t.exports),
			un = (n, t) => {
			...
			J = (n, t, i, r) => {
				if ((t && typeof t == 'object') || typeof t == 'function')
					for (let e of tn(t))
						!on.call(n, e) &&
							e !== i &&
							Y(n, e, { get: () => t[e], enumerable: !(r = nn(t, e)) || r.enumerable });
				return n;
			},
			...
			be = (function () {
				...
				return (
					...
					(n.prototype.manage = function (t, i) {
						var r;
						if (
							(y.is(t) ? (r = t) : ((r = this.nextId()), (i = t)), this._annotations[r] !== void 0)
						)
...
` +
		...
		var j = class {
			...
			provideDocumentHighlights(t, i, r) {
				...
				return this._worker(e)
					...
					.then((o) => {
						if (!!o) return o.map((s) => ({ range: T(s.range), kind: kn(s.kind) }));
					});
			}
		};
		function kn(n) {
		...
		function wn(n) {
			...
			function o() {
				...
				Ze(i),
					u.completionItems &&
						i.push(d.languages.registerCompletionItemProvider(s, new H(e, ['/', '-', ':']))),
					...
					u.documentFormattingEdits &&
						i.push(d.languages.registerDocumentFormattingEditProvider(s, new X(e))),
					u.documentRangeFormattingEdits &&
						i.push(d.languages.registerDocumentRangeFormattingEditProvider(s, new B(e)));
			}
